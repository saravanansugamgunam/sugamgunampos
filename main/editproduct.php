...
<span>Short Code : </span><input type="text" style="width:265px; height:30px;" name="txtShortCode" value="<?php echo $row['shortcode']; ?>" /><br> 
<span>Category : </span><input type="text" style="width:265px; height:30px;"  name="gen" value="<?php echo $row['gen_name']; ?>" /><br>
<span>Product Name : </span>
<input type="text" style="width:265px; height:30px;" name="name"  value="<?php echo $row['product_name']; ?>"  /> <br>
