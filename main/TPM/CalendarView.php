                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Details - <?php echo $Status; ?> &nbsp;&nbsp;&nbsp;&nbsp;

                                <input type='hidden' name='txtStatus' id='txtStatus' value='<?php echo $Status; ?>' />

                                <select id='cmbTherapist' name='cmbTherapist' style='color:black'>
                                    <option selected value='0'>All Therapist</option>

                                    <?php
                                    $sqli = "SELECT userid,username FROM usermaster where designationid in('8','9')
                        and  activestatus ='Active'  and userid not in('25','33','','','')  order by username";
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <button type="button" style='float:right;' class="btn btn-warning btn-xs"
                                    data-dismiss="modal" onclick='ChangeURL()'>View</button>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <select style='float:right;color:black;' id='cmbStatus' name='cmbStatus'>
                        ...
                        <div class="panel-body">
                            ...
                            $(document).ready(function() {
                                ...
                                var Therapist = <?php echo $TherapistID; ?>;

                                var LoadURl = 'load.php?sts=';
                                var LoadURl1 = status;
                                var LoadURl2 = '&emp=';
                                var LoadURl3 = Therapist;
                                var FinalLoadURl = LoadURl.concat(LoadURl1, LoadURl2, LoadURl3);
                            ...
                            function ChangeURL() {
                                ...
                                var em = document.getElementById("cmbTherapist").value;


                                if (status == 'P') {
                                    let text1 = 'CalendarView.php?MID=62&sts=P&emp=';
                                    let text2 = em;
                                    ...
                                    let text1 = 'CalendarView.php?MID=62&sts=C&emp=';
                                    let text2 = em;
                                    let url = text1.concat("", text2);

                                    window.location.href = url;

                                    // window.location.href = concat('CalendarView.php?MID=62&sts=C&em=', em);
