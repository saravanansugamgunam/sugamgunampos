...
$Invoice=$_GET['invoice'];
 ...
 SELECT a.billid,DATE_FORMAT(a.billdate,'%d-%m-%Y'), b.paitentname, b.mobileno,c.username,
 round(a.totalamount-a.discountamount,0),a.remarks   
...
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
 ...
 SELECT b.consultationname,round(consultationtotal,0) FROM 
 `consultingdetails` AS a JOIN `consultationmaster` AS  b ON a.consultationid = b.consultationid  
 WHERE consultationuniquebill ='$Invoice'   
  UNION 
   SELECT consultationname,round(consultationtotal,0) FROM 
 ...
 "); 
	...
	<?php
	$result = mysqli_query($connection, "  SELECT b.`paymentmode`,round(a.`amount`,0) FROM salepaymentdetails AS a JOIN 
