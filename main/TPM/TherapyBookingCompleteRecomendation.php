...
<body onload="CheckTherapyStatus();" >
    <!-- begin #page-loader -->
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function SaveTherapyDetails() {
            ...
            if (PaitentName == "" || Therapist == "" || DoctorReferedby == "" || TherapyName == "" ||
                ...
                var datas = "&PaitentName=" + PaitentName + "&TherapyName=" + TherapyName + "&Remarks=" + Remarks +
        ...
        function LoadInvoiceNo() {
           ...
           var InvoiceNo = new Date().getTime(); 
            ...
            document.getElementById("txtInvoiceNo").value = <?php echo $INV;?>;  
            document.getElementById("txtTmpInvoice").value = <?php echo $INV;?>;  
            document.getElementById("cmbDoctorReferedby").value = <?php echo $DID;?>;
            document.getElementById("cmbPaitent").value = <?php echo $PID;?>;
            LoadPaitentDetails();
            // LoadBookingLiveTable();
            // GetTokenNumber();
            LoadProductList();

        }

        function  CheckTherapyStatus()
        {
            var Invoice =<?php echo $INV;?>;  
             

            var datas = "&Invoice=" + Invoice ;
            // alert(datas);
            $.ajax({
                url: "Load/CheckTherapyStatus.php",
                method: "POST",
                data: datas,
                dataType: "json",
                success: function(data) {
                    ...
                    { 
                        ...
                        swal("Alert!, This Therapy is already converted", {
                        buttons: {
                    ...
                    .then((value) => {
                        switch (value) {
                            ...
                            case "Ok":
                                ...
                                window.location.href = 'TherapyRecomendationRegister.php?MID=61';
                                // break;
        ...
        function  LoadBookingLiveTable()
        {
            var Invoice = document.getElementById("txtInvoiceNo").value ; 
            var TmpInvoice =  document.getElementById("txtTmpInvoice").value; 

            var datas = "&Invoice=" + Invoice + "&TmpInvoice=" + TmpInvoice;
            // alert(datas);
            $.ajax({
                url: "Save/UpdateBookingLiveTable.php",
                method: "POST",
                data: datas,
                success: function(data) {
                    // alert(data);
        ...
        function LoadProductList() {
            ...
            // alert(datas);
            $.ajax({
                url: "Load/LoadBookedTherapyListRecomendClosure.php",
                method: "POST",
                data: datas,
                success: function(data) {
        ...
        function SaveBillingDetails() {
            ...
            if (Invoice == "" || TotalSaleAmount == "" || PaitentCode == "" || SaleDate == "" ||
                ...
                EntryType == "" || DoctorReferedby == "" || TotalSaleAmount == "0") {
        ...
        function DeleteProductinBillingItem() {
            ...
            $.ajax({
                url: "Delete/DeleteItemsRecomendedClosure.php",
                method: "POST",
                data: datas,
                success: function(data) {
                    LoadProductList();
                                        ...
                                        <div class="v2">
                                            ...
                                            <div class="form-inline">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <button class="btn btn-sm btn-primary m-r-5">Clear Old Dues</button>
                ...
                <div class="panel panel-inverse">
                    <div class="panel-body">
                        <input type="hidden" name="txtInvoiceNo" id="txtInvoiceNo" placeholder=""
                            class="form-control" />
                            <input type="hidden" name="txtTmpInvoice" id="txtTmpInvoice" placeholder=""
                            class="form-control" />
                        ...
                        <div>
                                  ...
                                  echo "<input type='date' id='dtBookingDate' name='dtBookingDate' 
                                    ...
                                    <td><select class="form-control"
                                           ...
                                           readonly >
                                            ...
                                            <?php  
                            $sqli = "SELECT userid,username FROM usermaster where designationid in ('9','8') and  activestatus ='Active'";
                            $result = mysqli_query($connection, $sqli); 
                             while ($row = mysqli_fetch_array($result)) {
                            	# code...
                            ...
                            ?>
                                    ...
                                    <td>&nbsp;&nbsp;</td>
                                    <td>
                                        <select class="form-control"  id='cmbPaitent' name='cmbPaitent'
                                          readonly >
                                            <option selected></option>
                            ...
                            ?>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <input style="background-color:white;" type="text" name="txtDiscAmount" id="txtDiscAmount"
                                                placeholder="" class="form-control" onkeyup="CalculateTotal();"
                                                 />
                                        </div>
