...
$result = mysqli_query($connection, "
 ...
 SELECT consultingdetailid,a.consultationname,a.consultationcharge,discount,consultationtotal
 FROM  `consultingdetails` AS a WHERE consultationuniquebill ='$Invoice'
