...
ON a.paymentmode = b.paymentmodecode  WHERE invoiceno ='$InvoiceNo' GROUP BY b.paymentmode,paymentid
 ");
...
while($data = mysqli_fetch_row($result))
{
  ...
  <td  width='%' >$data[1]</td>       
  <td  width='%' >$data[2]</td>       
   <td align='center' width='%' style='color:red'  onclick='GetPointIDtoDelete(this)' ><i class='fa fa-2x fa-trash' style='cursor:pointer'></i></td>  
