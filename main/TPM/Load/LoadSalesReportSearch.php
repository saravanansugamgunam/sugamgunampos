...
// $result = mysqli_query($connection, " 
 ...
 $result = mysqli_query($connection, " 
  SELECT DATE_FORMAT(a.billdate,'%d-%m-%Y') ,a.consultationuniquebill,a.billid, CONCAT(b.paitentname,'(',b.mobileno,')') AS paitent,c.username,a.totalamount+a.extracharge,cancelledstatus,
