...
<body onload="LoadTherapyRegister(); LoadInvoiceNo();" onmousedown="CalculateBalance()">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function LoadDatewiseRegister() {
            ...
            $.ajax({
                url: "Load/LoadDatewiseTherapyListCallList.php",
                method: "POST",
                data: datas,
                success: function(data) {
                    // alert(data);
        ...
        function PrintReport() {
            ...
            docprint.document.write('<style type="text/css">body{ margin:0px;padding:10px');
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Therapy Call List</h4>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Therapy Call List
