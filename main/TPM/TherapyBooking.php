...
<body onload="OnLoadFunctions();" onmousedown="CalculateCurrentTotal()">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
            ...
            if (PaitentName == "" || Doctor == "" || DoctorReferedby == "" || TherapyName == "" || BookingDate == "" ||
                ...
                if (TherapyName == 60) {
                    if (ModeofCollection == "" || CollectionTime == "") {
                        ...
                        $.ajax({
                            url: "Save/SaveTherapyBookingToday.php",
                            method: "POST",
                            data: datas,
        ...
        function Reset() {
            ...
            document.getElementById("dttherapytime").value = "";
        ...
        function LoadProductDetails() {
            ...
            $.ajax({
                url: "Load/LoadProductDetailsBillingToday.php",
                method: "POST",
                data: datas,
                dataType: "json",
                success: function(data) {
        ...
        function SaveSaleMaster() {
            ...
            if (Number(TotalBalance) > 0) {
                ...
                swal("Payment should be below total value");
            }
        ...
        function SaveBillingDetails() {
            ...
            if (Invoice == "" || TotalSaleAmount == "" || PaitentCode == "" || SaleDate == "" || BookingDate == "" ||
                TherapyTime == "" || DoctorCode == "" || DoctorReferedby == "") {
                swal("Alert!", "Kindly provide valid details!", "warning");
                ...
                var datas = "&Invoice=" + Invoice + "&TotalDiscountAmount=" + TotalDiscountAmount +
                    ...
                    "&Remarks=" + Remarks + "&ExtraCharge=" + ExtraCharge + "&BookingDate=" + BookingDate +
        ...
        <div id="content" class="content">
            <label><b><u>Therapy - Same Day </u></b></label>
            ...
            <div class="row">
                ...
                <div class="panel panel-inverse">
                    <div class="panel-body">
                        ...
                        <input class='form-control' type='hidden' id='cmbPaitent' name='cmbPaitent'
                            value='<?php echo $PaitentId; ?>' />
                        <input type="hidden" name="dtTherapyTime" id="dtTherapyTime" placeholder="" class="form-control"
                            onkeyup="CalculateTotal();" value='<?php echo date("H:i:s");  ?>' />

                        <input type="hidden" name="txtTotalSittings" id="txtTotalSittings" placeholder=""
                            class="form-control" value=1 onkeyup="CalculateTotal();" onblur="CalculateTotal();"
                            disabled />
                        ...
                        <div>
                            <table>
                                ...
                                <tr>
                                    <td><input type="date" class="form-control" id='dtTherapyDate' name='dtTherapyDate'
                                            value='<?php echo date("Y-m-d"); ?>' disabled> </td>

                                    <td>&nbsp;</td>

                                    <td>

                                        <input type="text" name="txtPaitentName" id="txtPaitentName" disabled
                                    ...
                                    <td><select class='form-control' id='cmbFreeTherapy' name='cmbFreeTherapy'>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id='cmbProductCode' name='cmbProductCode'
                                                ...
                                                <?php
                        $sqli = " SELECT consultationid,consultationname FROM  consultationmaster WHERE
                            activestatus ='Active' and consultingtype='Therapy' order by consultationname";
                        $result = mysqli_query($connection, $sqli);
                        while ($row = mysqli_fetch_array($result)) {
                            # code...
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control"
                                                style='border-radius: 4px; padding: 5px; text-align: left;'
                                                id='cmbDoctor' name='cmbDoctor' style="width: 150px;"
                                                onchange='GetTokenNumber();'>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div data-scrollbar="true" data-height="250px">
                                        ...
                                        <ul class="chats">
                                            ...
                                            <div id="DivTherapyList" class="email-content"></div>
