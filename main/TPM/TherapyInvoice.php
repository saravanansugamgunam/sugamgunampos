				 ...
				 ?>
                        ...
                        <table style="font-family: arial; font-size: 12px;	 padding: 8px; " width="30%">
                            ...
                            <tbody>
                                <?php 
				$result = mysqli_query($connection, " 
				SELECT b.paymentmode,a.amount FROM salepaymentdetails AS a JOIN 
				paymentmodemaster AS b ON a.paymentmode=b.paymentmodecode 
				WHERE invoiceno='$Invoice' GROUP BY b.paymentmode ; "); 
				...
				$Sno=$Sno+1;
					...
					echo "<tr> </tbody>
                                ...
                                <p style="width: 800px; float: left;">
                                    ...
                                    Visit clinic before 30 mins of Prescribed Time.
                                    <br><br>
            ...
            <center>
				...
				<input type='hidden' id ='txtInvoiceNo' name ='txtInvoiceNo' value='<?php echo $Invoice; ?>' />
                    <a href="javascript:;" onclick="window.print()" class="btn btn-sm btn-success m-b-10"><i
							...
							<a href="javascript:;" class="btn btn-sm btn-success m-b-10"  onclick="redirecttoReceiptPrint();"><i class="fa fa-download m-r-5"></i>
                        Receipt Print</a>
                </span>
            </center>
    </center>
