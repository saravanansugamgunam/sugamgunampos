...
<body onload="OnLoadFunctions();" onmousedown="CalculateCurrentTotal()">
    <!-- begin #page-loader -->
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function CalculateCurrentTotal() {
            // alert(1);
            var OldBalance = 0; //parseInt(document.getElementById("txtoldbalance").value);
            ...
            var CurrentBalance = parseInt(OldBalance) + parseInt(CurrentBillTotal) + parseInt(ExtraCharge) -
                parseInt(
                    TotalPayment);
...
function CalculateDiscount()
{
    ...
    var datas = "&DiscountPercent=" + DiscountPercent + "&InvoiceNo=" + InvoiceNo; 
   
                        $.ajax({
                            url: "Save/UpdateTherapyDiscount.php",
                            method: "POST",
                            data: datas,
                            success: function(data) {
                                ...
                                if (data == 1) {
                                    ...
                                    document.getElementById("txtMorningTimeSlotID").value = '';
                                    document.getElementById("txtEveningTimeSlotID").value = '';
                                    document.getElementById("dtTherapySittingTime").value = 'Schedule';
        ...
        function SaveTherapyDetails() {
            ...
            var TotalHours = document.getElementById("txtTotalHours").value;
            ...
            var WaitingList = document.getElementById("txtWaitinglistStatus").value;
            ...
            var ModeofCollection = document.getElementById("cmbModeofCollection").value;
            var CollectionTime = document.getElementById("dtCollectionTime").value;
            ...
            if (PaitentName == "" || Therapist == "" || DoctorReferedby == "" || TherapyName == "" ||
                InvoiceNo == "" || SittingDate == "" ||
                EveningTimeSlotID == "" && MorningTimeSlotID == "") {
                ...
                if (TherapyName == 60) {
                    if (ModeofCollection == "" || CollectionTime == "") {
                        swal("Alert!", "Please procide collection details for liver detox", "warning");
                    } else {


                        var datas = "&PaitentName=" + PaitentName + "&TherapyName=" + TherapyName + "&Remarks=" +
                            Remarks +
                            ...
                            "&EntryType=" + EntryType + "&TotalHours=" + TotalHours +
        ...
        function Reset() {
            ...
            document.getElementById("dtCollectionTime").value = "";
            document.getElementById("cmbModeofCollection").value = "";
        ...
        function LoadProductDetails() {
            ...
            var Invoice = document.getElementById("txtInvoiceNo").value;
            var FreeTherapy = document.getElementById("cmbFreeTherapy").value;


            var datas = "&ProductCode=" + ProductCode + "&Invoice=" + Invoice;
            // alert(datas);
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#txtTotalHours").val(data[1]);
                    $("#txtTotalSittings").val(data[1]);
        ...
        function LoadPaitentDetails() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data[2] < 0) {
                        $("#spnOldBalanceNegative").text(data[2]);
                        $("#spnOldBalancePlus").text('');
                    } else {
                        $("#spnOldBalancePlus").text(data[2]);
                        $("#spnOldBalanceNegative").text('');
                    }
        ...
        function SaveBillingDetails() {
            ...
            if (Invoice == "" || TotalSaleAmount == "" || PaitentCode == "" || SaleDate == "" ||
                EveningTimeSlotID == "" && MorningTimeSlotID == "" && WaitingList == "" ||
                EntryType == "" || DoctorReferedby == "") {
                ...
                var datas = "&Invoice=" + Invoice + "&TotalDiscountAmount=" + TotalDiscountAmount +
                    ...
                    "&NumberofTherapy=" + NumberofTherapy + "&OldBalance=" +
                    OldBalance + "&NewBalance=" + NewBalance + "&DoctorReferedby=" + DoctorReferedby +
                    "&EveningTimeSlotID=" + EveningTimeSlotID +
                    "&MorningTimeSlotID=" + MorningTimeSlotID +
                    "&TherapyType=" + TherapyType +
                    "&WaitingList=" + WaitingList +
                    "&BookingDate=" + BookingDate +
                    "&FreeTherapy=" + FreeTherapy +
                    "&EntryType=" + EntryType;
                //  swal(datas);
                $.ajax({
        ...
        function LoadPaymentDetails() {
            ...
            document.getElementById("txtTotalDueAmount").value = (OldDueAmount * 0) + (BillAmount * 1);
            LoadPaymentTotal();
        ...
        function DeleteProductinBillingItem() {
            ...
            var datas = "&ItemID=" + ItemID + "&Invoice=" + Invoice + "&TherapyID=" + TherapyID;
        ...
        function LoadPaymentTotal() {
            ...
            var OldBalance = 0; // document.getElementById("txtoldbalance").value;
        ...
        function DeleteBillingItem(x) {
            ...
            var TherapyID = document.getElementById("tblBillingItems").rows[SelectedRow].cells[2].innerHTML;
            document.getElementById("txtItemID").value = Id;
            document.getElementById("txtTherapyID").value = TherapyID;
        ...
        function GetTimeSlotMorning(x) {
            var SelectedColumn = x.cellIndex;
            var SelectedRow = x.parentNode.rowIndex;
            var MorningSlot = document.getElementById("tblTimeSlotDetails").rows[SelectedRow].cells[0].innerHTML;
            var MorningID = document.getElementById("tblTimeSlotDetails").rows[SelectedRow].cells[1].innerHTML;
            // document.getElementById("txtTimeSlotID").value = MorningID;
            document.getElementById("dtTherapyTime").value = MorningSlot;
            // document.getElementById("dtTherapySittingTime").value = MorningSlot;

            // $('#ModalSchedule').modal('hide');
        }

        function GetTimeSlotEvening(x) {
            var SelectedColumn = x.cellIndex;
            var SelectedRow = x.parentNode.rowIndex;
            var EveningSlot = document.getElementById("tblTimeSlotDetails").rows[SelectedRow].cells[4].innerHTML;
            var EveningID = document.getElementById("tblTimeSlotDetails").rows[SelectedRow].cells[5].innerHTML;

            // document.getElementById("txtTimeSlotID").value = EveningID;
            document.getElementById("dtTherapyTime").value = EveningSlot;

            // document.getElementById("dtTherapySittingTime").value = EveningSlot;
            // $('#ModalSchedule').modal('hide');

        }

        function SetWaitingList() {
            // document.getElementById("txtWaitinglistStatus").value = '1';
            // document.getElementById("dtTherapyTime").value = 'Waiting List';
            ...
            if (MorningSlot != '') {
                document.getElementById("dtTherapySittingTime").value = 'Morning Slot';
            } else if (EveningSlot != '') {
                document.getElementById("dtTherapySittingTime").value = 'Evening Slot';
        ...
        function DisplayTherapyCollection() {
            var DoctorCode = document.getElementById("cmbProductCode");
            var DivTherapyCollection = document.getElementById("DivTherapyCollection");
            DivTherapyCollection.style.display = DoctorCode.value == "60" ? "inline-block" : "none";
        ...
        <div id="content" class="content">
            <label><b><u>Therapy - Advance Booking</u></b></label>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" data-dismiss="modal" style='float:right'
                                onclick='SetWaitingList()'>Select</button>
                                        ...
                                        <div class="v2">
                                            ...
                                            <div class="form-inline">
                                                <div class="form-group m-r-10">
                                                    <label
                                                        class="col-md-4 control-label">&nbsp;&nbsp;Old&nbsp;Balance</label>
                                                </div>
                                                <div class="form-group ">
                                                    <input type="hidden" class="form-control" id="txtoldbalance"
                                                        name='txtoldbalance'
                                                        style="text-align: right;background-color:white;" value='0' />


                                                    <b><span class="blinkNew" id='spnOldBalancePlus'> </span></b>

                                                    <b><span class="blinkNegative" id='spnOldBalanceNegative'>
                                                        </span></b>
                ...
                <div class="panel panel-inverse">
                    <div class="panel-body">
                        ...
                        <input type="hidden" name="txtDoctorEmail" id="txtDoctorEmail" placeholder=""
                            class="form-control" />
                        <input type="hidden" name="txtmobileno" id="txtmobileno" placeholder="" class="form-control" />
                        <input type="hidden" name="cmbPaitent" id="cmbPaitent" placeholder="" class="form-control"
                            value='<?php echo $PaitentId; ?>' />

                        <input type="hidden" name="txtPaitentCode" id="txtPaitentCode" placeholder=""
                            class="form-control" value='<?php echo $PaitentId; ?>' />
                        ...
                        $(document).ready(function() {
                            ...
                            $("#cmbProductCode").change(function() {
                                ...
                                var datas = "&ServiceID=" + ServiceID;


                                $.ajax({
                                    url: 'Load/LoadTherapistList.php',
                                    type: 'post',
                                    data: datas,
                                    dataType: 'json',
                        ...
                        <div>
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <?php if ($GroupID == 1) {
                                            echo "<input type='date' id='dtBookingDate' name='dtBookingDate' 
                                    class='form-control' value='" . date('Y-m-d') . "'  />";
                                        } else {
                                            echo "<input type='date' id='dtBookingDate' name='dtBookingDate' 
                                            class='form-control' disabled value='" . date('Y-m-d') . "' />";
                                        }
                                        ?>
                                    ...
                                    <td>
                                        ...
                                        <select class='form-control' id='cmbFreeTherapy' name='cmbFreeTherapy'>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" name="txtPaitentName" id="txtPaitentName" placeholder=""
                                    ...
                                    <td><select class="form-control"
                                            ...
                                            id='cmbDoctorReferedby' name='cmbDoctorReferedby' style="width: 150px;"
                                            onchange='GetTokenNumber();'>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id='cmbProductCode' name='cmbProductCode'
                                                onchange="LoadProductDetails();ClearTotalAmount();DisplayTherapyCollection()"
                                                data-style="btn-white">
                                                <option selected></option>

                                                <?php
                                                $sqli = " SELECT consultationid,consultationname FROM 
                             consultationmaster WHERE activestatus ='Active' and consultingtype='Therapy' order by consultationname";
                                                $result = mysqli_query($connection, $sqli);
                                                while ($row = mysqli_fetch_array($result)) {
                                                    # code...
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <input style="background-color:white;" type="text" name="txtDiscAmount"
                                                id="txtDiscAmount" placeholder="" class="form-control"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Date</label>
                                            <input type="date" name="dtTherapySittingDate" id="dtTherapySittingDate"
                                                placeholder="" class="form-control" onkeyup="CalculateTotal();"
                                                onblur="CalculateTotal();" value='<?php echo date('Y-m-d'); ?>' />
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Time.</label>
                                            <input type="text" name="dtTherapySittingTime" id="dtTherapySittingTime"
                                                placeholder="" class="form-control" onclick="LoadAvailability()"
                                                data-toggle="modal" data-target="#ModalSchedule" readonly
                                                style='cursor:pointer;' value='Schedule' />
                                        </div>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <input type="hidden" class="btn btn-sm btn-warning" onclick="Reset();"
                                                    value='Clear'>

                                                <input style="background-color:white;" type="hidden"
                                                    name="txtTotalHours" id="txtTotalHours" placeholder=""
                                                    class="form-control" disabled />
                                ...
                                <div class="col-md-12" id='DivTherapyCollection' style="display:none;">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="datetime-local" class="form-control" id='dtCollectionTime'
                                                    name='dtCollectionTime' />
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select class="form-control" id='cmbModeofCollection'>
                                                    <option>By Self</option>
                                                    <option>Thru Friend / Relative</option>
                                                    <option>Thru Courier</option>
                                                </select>
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="txtTotalSittings" id="txtTotalSittings"
                                                    placeholder="" class="form-control" value=1
                                                    onkeyup="CalculateTotal();" onblur="CalculateTotal();" />
                                            </div>
                            ...
                            <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table style="position: relative; float:right;">
                                        <td style="text-align: right;"><label>Discount Type&nbsp;&nbsp;&nbsp;</label>
                                        </td>
                                        <td> <select class="form-control" id='cmbDiscountType' name='cmbDiscountType' disabled>
                                        ...
                                        <td> <input style="text-align: right;" type="text" class="form-control"
                                                placeholder="" id='txtDiscountPercent' name='txtDiscountPercent'
                                                  />


                                        </td>
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td style="text-align: right;"><label>Discount Amt.&nbsp;&nbsp;&nbsp;</label>
                                        </td>
                                        <td>
                                            <input style="text-align: right;" type="text" class="form-control"
                                                placeholder="" id='txtTotalDiscountAmount' name='txtTotalDiscountAmount'
                                                disabled />
                                        ...
                                        <td> <input type="button" class="btn btn-sm btn-warning"
                                                onclick="CalculateDiscount()" value='Apply'> </td>
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
