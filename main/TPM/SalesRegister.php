    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <select id='cmbPaymentMode' name='cmbPaymentMode' onchange='focusamount();'
          ...
          ?>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" onclick="ModifyPaymentMode();"
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <select id='cmbChangeDoctor' name='cmbChangeDoctor' onchange='focusamount();'
                    style="width: 150px; height:30px; padding-top:6px; padding-bottom: 4px; margin-right: 4px; font-size:15px; border-radius: 4px;">
                    <option></option>
                    <?php
          ...
          ?>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" onclick="ModifyDoctor();"
                    data-dismiss="modal">Save</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
        </div>
...
<div id="myModalCourierTracking" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" onclick="SaveCourierDetails();"
                    data-dismiss="modal">Save</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <label>Reference Number</label>&nbsp;&nbsp;&nbsp;
                <input class="form-control" type='text' id='txtCourierTrackingReference'
                    name='txtCourierTrackingReference' />
                <br>

                <label>Remarks</label>&nbsp;&nbsp;&nbsp;
                <textarea class="form-control" id='txtCourierTrackingRemarks'
                    name='txtCourierTrackingRemarks'></textarea>
        ...
        <div id="content" class="content">
            <div class="row">
                ...
                function ModifyDoctor() {
                    ...
                    var datas = "&InvoiceNo=" + InvoiceNo + "&DoctorCode=" + DoctorCode;
                    if (DoctorCode == '') {
                        swal("Alert!", "Select the Doctor Name", "warning");
                    } else {
                        $.ajax({
                            url: "Save/UpdateDoctorName.php",
                            method: "POST",
                            data: datas,
                            success: function(data) {
                                if (data == 1) {
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-heading">
                            <h5 class="panel-title">Therapy Report
                  ...
                  ?>
                                    ...
                                    <select hidden style='border-radius: 4px; padding: 5px;' id='cmbType'
                                        name='cmbType'>
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <select style='border-radius: 4px; padding: 5px;' id='cmbConsultationTypeGroup'
                                        name='cmbConsultationTypeGroup'> 
                                        <option value="Therapy">Therapy</option>

                                    </select>


                                    <select style='border-radius: 4px; padding: 5px;' id='cmbConsultationType'
                                        name='cmbConsultationType'>
                                        <option value="All" selected>All Therapy</option>
                                        <?php
                    $sqli = "SELECT a.consultationid,a.consultationname FROM consultationmaster
                      AS a JOIN consultingdetails AS b ON a.`consultationid`=b.`consultationid` where
                        consultingtype ='Therapy' AND a.activestatus='Active'
                    ...
                    ?>
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <select style='border-radius: 4px; padding: 5px; display:none' id='cmbPaymentModeReport'
                                        name='cmbPaymentModeReport'>
                    ...
                    ?>
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <select hidden style='border-radius: 4px; padding: 5px;' id='cmbBillMode'
                                        name='cmbBillMode'>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td> <input style='border-radius: 4px; padding: 5px;  text-align: right;'
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td>Card&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td><input style='border-radius: 4px; padding: 5px; text-align: right;' size="8"
                                                type='text' id='txtCard' name='txtCard' />
                                            &nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td>Others&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td><input style='border-radius: 4px; padding: 5px; text-align: right;' size="8"
                                                type='text' id='txtOthers' name='txtOthers' />
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        </td>
                                        ...
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;<input
                                                ...
                                                id='txtItemSearch' name='txtItemSearch' onkeyup='myFunction()'
