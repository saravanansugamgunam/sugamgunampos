        ...
        <div id="content" class="content">
            <div class="row">
                ...
                function LoadRecomendedTherapy() {
                    ...
                    // alert(datas);
                    $.ajax({
                        url: "Load/LoadRecomendedTherapyRegister.php",
                        method: "POST",
                        data: datas,
                        success: function(data) {
                            // alert(data);
                            $('#DivRecomendedTherapy').html(data);
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Recomended Therapy Register &nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive" >
                                ...
                                <br>
                                <div id="DivRecomendedTherapy"></div>
                            </div>
