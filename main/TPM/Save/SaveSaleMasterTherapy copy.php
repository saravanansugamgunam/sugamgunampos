...
$TherapyStatus ='Closed';
 ...
 $TotalBillValue = $TotalSaleAmount*1   ;
  try {
	...
	('$currentdate','$Invoice','$DoctorReferedby','$PaitentCode','$TotalDiscountAmount',
...
VALUES 
('Therapy','Therapy Bill','$Invoice','$currentdate','$PaitentCode','$TotalBillValue' ,'0','$userid','$LocationCode','$Remarks');";
...
//}
	...
	if($ReceivedAmount>0)
	{
		if($TotalBillValue > $ReceivedAmount  )
		{
			...
			creditamount,createdby,clientid,remarks)
			VALUES 
			('Therapy','Therapy - Advance Payment','$Invoice','$currentdate','$PaitentCode','0','$ReceivedAmount','$userid','$LocationCode','$Remarks');";
		...
		{   $SaveSaleMaster.= " INSERT INTO transactionledger (transactiontype,transactionmode,invoicegrn,invoicegrndate,vendorcode,debitamount,
			creditamount,createdby,clientid,remarks)
			VALUES 
			('Therapy','Therapy - Payment','$Invoice','$currentdate','$PaitentCode','0','$ReceivedAmount','$userid','$LocationCode','$Remarks');";
	...
	if($NewBalance<>0)
	{
	   $SaveSaleMaster.= "insert into outstandingdetails (uniqueno,totalamount,outstandingamount,date,transactiontype,createdby) values 
		('$Invoice','$TotalSaleAmount','$NewBalance','$currentdate','Therapy - Sale','$userid');";  
	}
