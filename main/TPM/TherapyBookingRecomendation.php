    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function SaveTherapyDetails() {
            ...
            if (PaitentName == "" || Therapist == "" || DoctorReferedby == "" || TherapyName == "" ||
                ...
                $.ajax({
                    url: "Save/SaveTherapyBookingRecomended.php",
                    method: "POST",
                    data: datas,
        ...
        function redirect() {
            ...
            if(TID=='0')
            {
                var URL = '../CLM/PaitentHistoryView.php?';
            }
            else
            {
                var URL = '../CLM/PaitentHistory.php?';
            }

            var Status = 'O';
           
            var BillPrintURL = URL.concat('PID=',PID,'&INV=',INV,'&TID=',TID,'&S=',Status,'&MID=31');
        ...
        function LoadInvoiceTotal() {
            ...
            // alert(datas);
            $.ajax({
                url: "Load/LoadBookedTherapyTotalRecomended.php",
                method: "POST",
                data: datas,
                dataType: "json",
                success: function(data) {
        ...
        function LoadProductList() {
            ...
            // alert(datas);
            $.ajax({
                url: "Load/LoadBookedTherapyListRecomended.php",
                method: "POST",
                data: datas,
                success: function(data) {
        ...
        function SaveBillingDetails() {
            ...
            if (Invoice == "" || TotalSaleAmount == "" || PaitentCode == "" || SaleDate == "" ||
                ...
                //        swal(datas);
                $.ajax({
                    url: "Save/SaveSaleMasterTherapyRecomended.php",
                    method: "POST",
                    data: datas,
                    success: function(data) {
                        // swal(data);
        ...
        function DeleteProductinBillingItem() {
            ...
            $.ajax({
                url: "Delete/DeleteTherapyBookingItemsRecomended.php",
                method: "POST",
                data: datas,
                success: function(data) {
                    LoadProductList();
                            ...
                            ?>
                                    ...
                                    <td>
                                        <select class="form-control" id='cmbPaitent' name='cmbPaitent'
                                            onchange='LoadPaitentDetails();' disabled>
                                            <option selected></option>
