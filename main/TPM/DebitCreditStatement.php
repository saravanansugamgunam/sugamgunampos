...
FROM (
SELECT saledate,'a. SaleMaster' AS Source, DATE_FORMAT(saledate, '%d-%m-%Y')AS DATE,paitientcode,saleid,saleuniqueno, 'Purchase' AS Transcation ,
nettamount AS Debit, 0 AS 
