...
SUM(nettamount) AS Total,b.mobileno,a.discountamount,IFNULL(address1,'-') AS address1,address2,b.city,state,b.pincode,c.couriercharge, b.`paitentid`, b.`gender`  FROM salemaster AS a
