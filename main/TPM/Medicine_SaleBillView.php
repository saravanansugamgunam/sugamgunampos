...
state,c.pincode,c.couriercharge,billtype,newbalance,remarks,deliverystatus,a.transactiontype FROM salemaster AS a
...
?>
    ...
    function redirecttoReceiptPrint() {
        ...
        var str1 = "Medicine_ReceiptPrint.php?invoice=";
        var str2 = Invoice;
        var str3 = "";
