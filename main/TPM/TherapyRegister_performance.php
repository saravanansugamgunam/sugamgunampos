...
//$UpdateStatus .= "UPDATE therapybookingdetails SET newstatus = bookingstatus ;";
 $UpdateStatus .= "UPDATE therapybookingdetails SET newstatus = 'Pending' WHERE newstatus='Booked' AND  reviseddate < CURRENT_DATE ;";


if (mysqli_multi_query($connection, $UpdateStatus)) {
    // echo "1";
} else {
    // echo "ERROR: Could not able to execute $DeleteItems. " . mysqli_error($connection);
    // echo "0";
}
...
<body onload="LoadTherapyRegister(); LoadInvoiceNo();" onmousedown="CalculateBalance()">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function LoadDatewiseRegister() {
            ...
            var Referedby = document.getElementById("cmbReferedby").value;
            var Therapy = document.getElementById("cmbTherapy").value;
            var UploadStatus = document.getElementById("cmbUploadStatus").value;
            ...
            $.ajax({
                url: "Load/LoadDatewiseTherapyList_Performance.php",
                method: "POST",
                data: datas,
                success: function(data) {
                    // alert(data);
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Therapy Performance Report</h4>
                            ...
                            <div class="panel-body">
                                <form class="form-inline">
                                    ...
                                    <div style='display: ' class="form-group">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <label for="exampleInputPassword2">Referedby</label>

                                        <select class="js-states form-control" tabindex="-1" id='cmbReferedby'
                                            name='cmbReferedby'>
                                            <option value='%'>All Therapist</option>
                                            <?php
                                            $sqli = "SELECT userid,username FROM usermaster where designationid in('9' )  and  activestatus ='Active'";
                                            $result = mysqli_query($connection, $sqli);
                                            while ($row = mysqli_fetch_array($result)) {
                                                # code...
                                    ...
                                    <div style='display: ' class="form-group">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <label for="exampleInputPassword2">Therapy</label>

                                        <select class="js-states form-control" tabindex="-1" id='cmbTherapy'
                                            name='cmbTherapy'>
                                            <option value='%'>All Therapist</option>
                                            <?php
                                            ...
                                            AS a JOIN consultingdetails AS b ON a.`consultationid`=b.`consultationid` where
                                              consultingtype ='Therapy' AND a.activestatus='Active' GROUP BY a.consultationid,a.consultationname";
                                    ...
                                    <hr>
                                    <div style='display: ' class="form-group">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <label for="exampleInputPassword2">Form Status</label>

                                        <select class="js-states form-control" tabindex="-1" id='cmbUploadStatus'
                                            name='cmbUploadStatus'>
                                    ...
                                    <div style='display: ' class="form-group">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <label for="exampleInputPassword2">Therapy Status</label>
