...
<body onload="LoadInvoiceNo();">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function SaveTimeSlot() {
            ...
            var ToTimeCheck = document.getElementById("txtToTime").value;
            ...
            if (ToTimeCheck * 1 > FromTime * 1) {
                ...
                swal("Alert!", "End time should not less than starting time", "warning");
            }
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="date" class="form-control" placeholder="" id='dtFromDate'
                                            name='dtFromDate' value='<?php echo date('Y-m-d');?>' />
                                    </div>

                                    <div class="col-md-4">
                                        <input type="date" class="form-control" placeholder="" id='dtToDate'
                                            name='dtToDate' value='<?php echo date('Y-m-d');?>' />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">From
                                        <select id='txtFromTime' name='txtFromTime' class='form-control'>
                                    ...
                                    <div class="col-md-4">To
                                        <select id='txtToTime' name='txtToTime' class='form-control'>
