...
if (isset($_POST["InvoiceNo"])) {
  ...
  $SaveSaleMaster = " INSERT INTO transactionledger (transactiontype,transactionmode,invoicegrn,
    ...
    VALUES 
    ('Diagnosis','Diagnosis - Outstanding Payment','$InvoiceNo','$currentdate','$PaitentCode','0','$PaymentAmount',
    '$userid','$LocationCode','-');";
  ...
  $SaveSaleMaster .= "insert into salepaymentdetails (customercode ,paymentmode,amount,invoiceno,date,clientid,
   ...
   ('$PaitentCode','$PaymentMode','$PaymentAmount','$InvoiceNo','$currentdate','$LocationCode','Diagnosis Payment','Diagnosis')";
  // echo $SaveSaleMaster; 
