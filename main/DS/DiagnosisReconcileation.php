  ...
  function LoadDiagnosisReport()
	  {
		...
		var Courier = document.getElementById("cmbCourier").value;   
		 
		var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&Type="+Type+"&DoctorCode="+DoctorCode+"&Courier="+Courier; 
	 // alert(datas);
		 $.ajax({
		   url:"Load/LoadDiagnosisRegister.php",
		   method:"POST",
		   data:datas,
...
function GetCourierID(x)
{
	var CourierID = x;
	document.getElementById("txtCourierID").value=CourierID;
	 
}
function SaveDiagnosisVendorPayment()
{
	var CourierID =document.getElementById("txtCourierID").value;
	var PaidAmount =document.getElementById("txtPaidAmount").value;
	var datas = "&CourierID="+CourierID+"&PaidAmount="+PaidAmount;	
	 
		  if (CourierID=='' || PaidAmount=='')
		  {
			   swal("Alert!", 'Kindly fill the details', "warning");
		  }
		  
			  else
			  {
				   $.ajax({
		   url:"Save/SaveDiagnosisVendorPayment.php",
		   method:"POST",
		   data:datas,
		   success:function(data)
		   {	
			 ...
			 swal("Updated!", "Payment Added", "success"); 
			  ...
			  LoadDiagnosisReport();
						 ...
						 <div class="modal fade" id="modalCourierPayment">
								<div class="modal-dialog" style="width:200px;">
									<div class="modal-content">
										...
										<div class="modal-body">
				<input type='hidden' id='txtCourierID' name='txtCourierID' />
				<input type='text' id='txtPaidAmount' name ='txtPaidAmount' class='form-control' />
										</div>
										<div class="modal-footer">
										 
											<a href="javascript:;" class="btn btn-sm btn-success" onclick="SaveDiagnosisVendorPayment()" data-dismiss="modal" >Add</a>
						 ...
						 <div class="panel-heading">
						    <h5 class="panel-title">Diagnosis Reconcileation Register
							  ...
							  <div class="form-group">
                                    ...
                                    <div class="col-md-12">
											...
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											   ...
											   <select style='border-radius: 4px; padding: 5px;' id='cmbCourier' name='cmbCourier' > 
					   
					     <option selected value='All'>All</option> 
							 <?php  
                            $sqli = "SELECT  courier from couriermaster";
                            ...
                            ?>
											...
											<select hidden style='border-radius: 4px; padding: 5px;' id='cmbDoctorCode' name ='cmbDoctorCode'>
                            ...
                            ?>
											...
											&nbsp;&nbsp;&nbsp;
                                         <input type="button"  class="btn btn-sm btn-info" onclick="LoadDiagnosisReport();"  value='View'>
                                    </div>
