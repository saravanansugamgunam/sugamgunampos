...
<body onload="Reset();">
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
        ...
        function SaveDiagnosis() {
            ...
            var Diagnosis = document.getElementById("txtDisgnosis").value;
            ...
            if (Diagnosis == "") {
                ...
                var datas = "&Diagnosis=" + Diagnosis + "&Description=" + Description + "&Rate=" + Rate;

                $.ajax({
                    url: "Save/SaveDiagnosis.php",
                    method: "POST",
                    data: datas,
                    success: function(data) {
        ...
        function LoadDiagnosis() {
            ...
            $.ajax({
                url: "Load/LoadDiagnosisDetails.php",
                method: "POST",
                data: datas,
                success: function(data) {

                    $('#DivDiagnosis').html(data);
        ...
        function LoadDiagnosisStatus(a) {
            // document.getElementById("txtDisgnosisID").value=a;
            // document.getElementById("txtDisgnosisName").value=b;
            // document.getElementById("txtDisgnosis").value=c;
        ...
        function GetRowID(x) {
            ...
            document.getElementById("txtDisgnosisID").value = document.getElementById("indextable").rows[row].cells
                .namedItem("DiagnosisID").innerHTML;
            document.getElementById("txtDisgnosis").value = document.getElementById("indextable").rows[row]
                .cells.namedItem("Diagnosis").innerHTML;
            document.getElementById("txtDisgnosisStatus").value = document.getElementById("indextable").rows[row].cells
                .namedItem("DiagnosisStatus").innerHTML;

        }


        function Reset() {
            document.getElementById("txtDisgnosis").value = "";
        ...
        <div id="content" class="content">
            <div class="row">
                ...
                <div class="col-md-8">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" placeholder="Diagnosis Name"
                                            id='txtDisgnosis' name='txtDisgnosis' />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" placeholder="Rs: 350" id='txtRate'
                                            name='txtRate' />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="button" class="btn btn-sm btn-success" onclick="SaveDiagnosis();"
                                            value='Save'>
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            <h4 class="panel-title">Diagnosis List</h4>
                        </div>

                        <div class="panel-body">
                            <form class="form-horizontal">
                                <div id="DivDiagnosis" style="display: ;"></div>
                            </form>
                        </div>
                    </div>
