...
if (isset($_POST["Dumy"])) {
  ...
  SELECT centerid,centername,contactno,pincode FROM diagnosticcentre ");
  ...
  echo " <thead><tr>  
		...
		<th  ><a href=\"javascript:SortTable(3,'T');\">Contact No</a></th>     
  ...
  <td  onclick='GetCenterDetails($data[0]);'><a href='#' 
  class='btn btn-sm btn-danger btn-xs' data-toggle='modal'>Edit</a></td>  
