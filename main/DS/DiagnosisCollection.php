...
<body onload="Reset();">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function Reset() {
            ...
            LoadDiagnosisPaymentDetails();
        }


        function LoadDiagnosisPaymentDetails() {
            ...
            $.ajax({
                url: "Load/LoadDiagnosisPaymentList.php",
                method: "POST",
                data: datas,
        ...
        function GetID(x, y, z) {
            ...
            document.getElementById("txtPaitentID_LabReport").value = y;
            document.getElementById("txtInvoiceNo_LabReport").value = x;
        ...
        function UpdateSampleCollection() {
            ...
            var CollectedBy = document.getElementById("txtSampleCollectedBy").value;
            var CollectionDate = document.getElementById("dtSamplesCollectionDate").value;
            if (InvoiceNo == '' || CollectionDate == '' || CollectedBy == '') {
                swal("Alert", "Please try again", "warning");
            } else {
                ...
                $.ajax({
                    url: "Save/UpdateSampleCollection.php",
                    method: "POST",
                    data: datas,
                    success: function(data) {

                        if (data == 1) {
                            swal("Sucess", "Sample collection details updated!", "success");
                            LoadDiagnosisPaymentDetails();
                        } else {
                            swal("Alert", "Error Saving sample collection, Please try again!", "error");
        ...
        function UpdateDeliveryStatus() {
            var InvoiceNo = document.getElementById("txtInvoiceNo").value;
            var DeliveryDate = document.getElementById("dtDeliveryDate").value;
            if (InvoiceNo == '' || DeliveryDate == '') {
                swal("Alert", "Please try again", "warning");
            } else {
                var datas = "&InvoiceNo=" + InvoiceNo +
                    "&DeliveryDate=" + DeliveryDate;
                $.ajax({
                    url: "Save/UpdateDeliveryStatus.php",
                    method: "POST",
                    data: datas,
                    success: function(data) {

                        if (data == 1) {
                            swal("Sucess", "Delivery Status updated!", "success");
                            LoadDiagnosisPaymentDetails();
                        } else {
                            swal("Alert", "Error Saving Delivery status, Please try again!", "error");
                        }
                    }
                });
            }
        ...
        function UpdatePayment() {
            ...
            if (InvoiceNo == '' || PaitentCode == '' || PaymentAmount == '' || PaymentMode == '0') {
                ...
                $.ajax({
                    url: "Save/UpdateDiagnosisPayment.php",
                    method: "POST",
                    data: datas,
                    success: function(data) {
        ...
        function LoadMedicalReports() {
            var Dumy = 0;
            var PaitentID = document.getElementById("txtPaitentID_LabReport").value;
            var ReferenceID = document.getElementById("txtInvoiceNo_LabReport").value;

            var datas = "&PaitentID=" + PaitentID + "&ReferenceID=" + ReferenceID;
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#DivMedicalReportsView').html(data);
        ...
        <div id="ModalSampleCollection" class="modal fade" role="dialog">
            <div class="modal-dialog ">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Sample Collection</h4>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <input type='text' id='txtSampleCollectedBy' name='txtSampleCollectedBy' class="form-control" />
                        <br>

                        <label>
                            Collected On
                        </label>
                        <input type='datetime-local' id='dtSamplesCollectionDate' name='dtSamplesCollectionDate'
                            class="form-control" />
                        <br>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-success" data-dismiss="modal"
                            onclick='UpdateSampleCollection()'>Update</button>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    </div>
                </div>
        ...
        <div id="ModalDeliveryReport" class="modal fade" role="dialog">
            <div class="modal-dialog ">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Deliver Report</h4>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <input type='date' id='dtDeliveryDate' name='dtDeliveryDate' class="form-control" />
                        <br>
                    </div>
                    ...
                    <center>
                        <div>
                            <button type="button" class="btn btn-success" data-dismiss="modal"
                                onclick='UpdateDeliveryStatus()'>Update</button>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        </div>
                    </center>
                    <br>
                    <div class="col-md-12">
                        ...
                        <body>
                            <form id="uploadForm_LabReport" enctype="multipart/form-data" method="post">
                                ...
                                <input type='hidden' id='txtPaitentID_LabReport' name='txtPaitentID_LabReport' />
                                <input type='hidden' id='txtInvoiceNo_LabReport' name='txtInvoiceNo_LabReport' />
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <input type='text' class="form-control" id='txtDocumentName_LabReport'
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label>File </label>
                                            <input type="file" class="form-control" name="file_LabReport"
                                                id="fileupload_LabReport">
                                        </div>
                                    </div>
                                </div>
        ...
        <div id="ModalReportView" class="modal fade" role="dialog">
            <div class="modal-dialog ">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <label><u><b>Medical Reports List</b></u></label>
                        <div id='DivMedicalReportsView'> </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Diagnosis Report</h4>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="radio-inline">
                                ...
                                <select class='form-control' id='cmbSupplierCodeReport' name='cmbSupplierCodeReport'
                                    ...
                                    <?php
                                    $sqli = "SELECT b.paitentid,b.paitentname FROM transactionledger AS a JOIN paitentmaster AS b 
                            ON a.vendorcode= b.paitentid GROUP BY b.paitentid,b.paitentname order by b.paitentname  ";
                                    $result = mysqli_query($connection, $sqli);
                                    while ($row = mysqli_fetch_array($result)) {
                                        # code...
                            ...
                            <label class="radio-inline">
                                ...
                                <a class="btn btn-success  btn-sm" onclick='LoadDiagnosisPaymentDetails();'>View</a>
