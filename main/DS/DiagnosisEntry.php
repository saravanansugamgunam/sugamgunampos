...
<body onload="Reset();LoadInvoiceNo();">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function SaveDisgnoisMaster() {
            ...
            var OtherPayment = document.getElementById("txtOtherPaymentAmount").value;
            var BillBalance = document.getElementById("txtBalanceAmount").value;
            var Remarks = document.getElementById("txtRemarks").value;
            var DoctorCode = document.getElementById("txtDoctorCode").value;

            var CenterID = document.getElementById("cmbCenterID").value;
            var SampleCollectedBy = document.getElementById("txtSampleCollectedBy").value;


            if (PaitentCode == "" || EntryDate == "" || DoctorCode == "" || CenterID == "") {
                ...
                if (BillBalance == 0) {
                    ...
                    $.ajax({
                        url: "Save/SaveDiagnosisSaleMaster.php",
                        method: "POST",
                        data: datas,
                        success: function(data) {
                            // swal(data);
                    ...
                    swal("Alert!", "Balance should be '0'", "warning");
        ...
        function LoadDiagnosisList() {
            ...
            // alert(datas);
            $.ajax({
                url: "Load/LoadDiagnosisList.php",
                method: "POST",
                data: datas,
                success: function(data) {
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="panel-body">
                                        DIAGNOSTIC CENTRE<br><br>

                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Center</label>
                                            <select class="selectpicker" data-show-subtext="true"
                                                data-live-search="true" data-style="btn-white" id='cmbCenterID'
                                                name='cmbCenterID'>
                                                <option selected></option>
                                                <?php
                                            $sqli = "SELECT centerid,centername FROM 
                                            diagnosticcentre WHERE activestatus='Active' ORDER BY 2 ";
                                            $result = mysqli_query($connection, $sqli);
                                            while ($row = mysqli_fetch_array($result)) { 
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Samples Collected By</label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" id='txtSampleCollectedBy'
                                                    name='txtSampleCollectedBy' />
                                            </div>
                ...
                <div class="col-md-7">
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Lab Test List</h4>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Lab Test / Investigation</label>
                                    <select class="selectpicker" data-show-subtext="true" data-live-search="true"
                                        data-style="btn-white" id='cmbTestName' name='cmbTestName'>
                                        <option selected></option>

                                        <?php
                                            $sqli = "SELECT id,diagnosisname FROM 
                                            `disagnosismaster` WHERE activestatus='Active' ORDER BY 2 ";
                                            $result = mysqli_query($connection, $sqli);
                                            while ($row = mysqli_fetch_array($result)) {
                                                # code...

                                                echo ' <option value=' . $row['id'] . '>' . $row['diagnosisname'] . '</option>';
                                            }
                                            ?>
                                    </select>
                                    <button class='btn btn-primary ' onclick='SaveDisgnoisList()'>Add </button>
                                ...
                                <table style='float:right'>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control" placeholder="" id='txtTotalAmount'
                                                name='txtTotalAmount' disabled />
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-md-6  control-label">Cash</label>
                                        </td>
                                        <td>
                                            <input type="number" class="form-control" placeholder="" id='txtCashAmount'
                                                name='txtCashAmount' onkeyup="CalculateTotal()" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control" placeholder=""
                                                id='txtOtherPaymentAmount' name='txtOtherPaymentAmount'
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control" placeholder=""
                                                id='txtBalanceAmount' name='txtBalanceAmount'
                                                onkeyup="CalculateTotal()" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="button" class="btn btn-sm btn-success"
                                                onClick="SaveDisgnoisMaster();" value='Save'>
                                ...
                                <div class="form-group col-md-6" style='float:left;display:none'>
                                    <label class="col-md-3 control-label">Remarks.</label>

                                    <div class="col-md-12">
                                        <textarea id='txtRemarks' name='txtRemarks' row='10'
