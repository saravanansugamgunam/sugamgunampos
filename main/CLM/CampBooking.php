...
<body onload="Reset();">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function ConfirmBooking(x) {

            var CampCode = x;

            var Invoice = new Date().getTime();

            var datas = "&CampCode=" + CampCode + "&Invoice=" + Invoice;

            $.ajax({
                url: "Save/SaveSaleMasterCampConfirmation.php",
                method: "POST",
                data: datas,
                success: function(data) {
                    swal("Patient Visit Confirmed!", "Sucessfully", "success");
                    LoadOnlineBookingRegister();
                ...
                <div class="col-md-12">
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Camp Booking Register
                                &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;

                                <button class='btn btn-xs btn-warning' onclick="FocusQR();">
                                    <a href='#modal-QRCode' data-toggle='modal' style='color:white'>
                                        <i class='fa fa-2x fa-qrcode'></i></a> </button>
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-states form-control" tabindex="-1" id='cmbPeriod' name='cmbPeriod'
                                onchange='ShowHideDiv();' style='display:none;'>
                            ...
                            <label class="radio-inline">
                                Camp Name
                                <select class='form-control' id='cmbCampName' name='cmbCampName' style="width: 150px;">
                                    <option value='%'>All</option>
                                    <option value='100027'>Free Thyroid</option>
                                    <option value='100028'>Free Consulting</option>
                            ...
                            <label class="radio-inline">
                                ...
                                <a class="btn btn-success  btn-sm" onclick='LoadOnlineBookingRegister();'>View</a>
