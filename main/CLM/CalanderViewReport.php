    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        <script>
            ...
            function LoadEnquiryRegister() {
                ...
                Enquiry
                var datas = "&FromDate=" + FromDate + "&ToDate=" + ToDate + "&Period=" + Period + "&Enquiry=" + Enquiry;
            ...
            <div class="modal-dialog ">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type='hidden' id='txtInvoiceNo' name='txtInvoiceNo' class="form-control" style='width:150px;' />
                        <input type='hidden' id='txtPaitentID' name='txtPaitentID' class="form-control" style='width:150px;' />


                        <label>
                            Total Balance
                        </label>
                        <input type='number' style='font-size:20px;' id='txtCurrentBalance' name='txtCurrentBalance' class="form-control" disabled />
                        <br>
                        <label>
                            Payment Amount
                        </label>
                        <input type='number' id='txtPaymentAmount' name='txtPaymentAmount' class="form-control" style='width:150px;' onblur='CalculateTotal()' />
                        <br>
                        <label>
                            Balance
                        </label>
                        <b><input type='number' id='txtFinalBalance' name='txtFinalBalance' class="form-control" style='font-size:20px;' style='width:150px;color:blue;' value=0 disabled /></b>
                        <br>
                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label>Please Scan QR Code on below
                                            box</label>
                                        <div class="col-md-12">
                                            <input type="text" class="form-control" placeholder="" id='txtQRCode' name='txtQRCode' onblur='redirect()' />
                                        </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Enquiry Details
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <button class='btn btn-warning btn-xs  m-r-5'>
                                    <a href='CalendarView.php?MID=61'>
                                        <i class='fa fa-list'></i>&nbsp;&nbsp; Calendar View</a>
                                </button>
                        ...
                        <div class="form-group">
                            ...
                            <label class="radio-inline"> Enquiry Type
