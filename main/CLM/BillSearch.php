  ...
  function LoadSalesReport()
	  {
		...
		var PaitientID = document.getElementById("cmbPaitient").value;   
		...
		+ConsultationType+"&Location="+Location+"&ConsultationGroup="
		+ConsultationGroup+"&Doctor="+Doctor+"&PaitientID="+PaitientID; 
	  // alert(datas);
		 $.ajax({
		   url:"Load/LoadSalesReportSearch.php",
		   method:"POST",
		   data:datas,
	...
	var FromDate = document.getElementById("dtFromDate").value;   
		...
		var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&Type="+Type+"&ConsultationType="+ConsultationType+
		"&Location="+Location+"&ConsultationGroup="+ConsultationGroup+"&Doctor="+Doctor+"&PaitientID="+PaitientID;  
	  	     // alert(datas);
		 $.ajax({
		   url:"Load/LoadSalesReportTotalSearch.php",
		   method:"POST",
		   data:datas,	
		   dataType:"json",
		   success:function(data)
      ...
      format: "dd/mm/yyyy"
        ...
        $('.datepicker').hide();
		 	...
		 	<input type='hidden' id='txtLocationCode' name ='txtLocationCode' value ='<?php echo $LocationCode; ?>' />
									   ...
									   data-live-search="true" data-style="btn-white" id='cmbPaitient' name='cmbPaitient'  style="width: 150px;">
                            ...
                            ?>
                                               ...
                                               <input type="hidden" class="" placeholder="From" id="dtFromDate" style='border-radius: 4px; padding: 5px;'>
                                            
                                            <input type="hidden" class="" placeholder="To" id="dtToDate" style='border-radius: 4px; padding: 5px;'>
											&nbsp;&nbsp;&nbsp; 
											<?php 
											if($GroupID=='1')
											{
                      ...
                      echo ' <option value='.$row['locationcode'].'>'.$row['locationname'].'</option>';
                            ...
                            ?>
											...
											<option value ='Summary'>Summary</option>
												...
												&nbsp;&nbsp;&nbsp;
											<select hidden style='border-radius: 4px; padding: 5px;' id='cmbConsultationTypeGroup' name ='cmbConsultationTypeGroup'>
											   <option value="All" selected>All Consultation Group</option> 
											   ...
											   <option value="Therapy" >Therapy</option> 
													...
													<select hidden style='border-radius: 4px; padding: 5px;' id='cmbConsultationType' name ='cmbConsultationType'>
											   <option value="All" selected>All Consultation</option> 
						 <?php
                            $sqli = "SELECT a.consultationid,a.consultationname FROM consultationmaster  AS a JOIN consultingdetails AS b ON a.`consultationid`=b.`consultationid`
                      ...
                      echo ' <option value='.$row['consultationid'].'>'.$row['consultationname'].'</option>';
                            ...
                            ?>
											...
											&nbsp;&nbsp;&nbsp;
											<select hidden style='border-radius: 4px; padding: 5px;' id='cmbDoctor' name ='cmbDoctor'>
			   ...
			   <div class="col-md-12" >
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
							...
							<td><b><input style='border-radius: 4px; padding: 5px; text-align: right;'   size="15"  type='text' id='txtTotalSale' 
							name ='txtTotalSale' /></b></td>
							<td> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;</td>
