...
<body onload="Reset();">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function LoadNonClosedConsulting() {
            ...
            // alert(datas);
            $.ajax({
                url: "Load/LoadNonClosedConsultation.php",
                method: "POST",
                data: datas,
                success: function(data) {
                    // alert(data);
        ...
        function SaveConsultingReschedule() {
            var InvoiceNo = document.getElementById("txtConsultingID").value;
            var RevisedDate = document.getElementById("dtTherapySittingDate").value;
            var Session = document.getElementById("cmbSession").value;
            var Remarks = document.getElementById("txtRescheduleRemarks").value;

            if (InvoiceNo == '' || RevisedDate == '' || Session == '' || Remarks == '') {
                ...
                $.ajax({
                    url: "Save/UpdateRevisedConsultingDate.php",
                    method: "POST",
                    data: datas,
                    success: function(data) {

                        if (data == 1) {
                            swal("Sucess", "Consulting Date Revised Sucessfully!", "success");
                            LoadNonClosedConsulting();
                        } else {
                            swal("Alert", "Error Changing Consulting Date, Please try again!", "error");
        ...
        function GetInvoiceNo(x) {

            document.getElementById("txtConsultingID").value = x;
            ...
            <div class="modal-dialog ">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type='hidden' name='txtConsultingID' id='txtConsultingID' />
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" style='border-radius: 4px; padding: 5px; text-align: left;'
                                    id='cmbSession' name='cmbSession' style="width: 150px;">
                    ...
                    <div class="modal-footer">
                        <a href="javascript:;" class="btn btn-sm btn-success" data-dismiss="modal"
                            onclick='SaveConsultingReschedule()'>Save</a>
                ...
                <div class="col-md-12">
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Consultation - Rescheduling</h4>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="radio-inline">
                                Doctor
                                <select class='form-control' id='cmbDoctorCode' name='cmbDoctorCode'
                                    style="width: 150px;">
                                    <option value='%'>All</option>

                                    <?php
                                    $sqli = "
                                    SELECT userid,username FROM usermaster  WHERE designationid=9 AND activestatus ='Active' ";
                                    $result = mysqli_query($connection, $sqli);
                                    while ($row = mysqli_fetch_array($result)) {
                                        # code...
                            ...
                            <label class="radio-inline">
                                ...
                                <a class="btn btn-success  btn-sm" onclick='LoadNonClosedConsulting();'>View</a>
