    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function SaveSaleItems() {
            ...
            if (Number(BillQty) > Number(Currentstock)) {
                ...
                var ProductCode = 9999; //document.getElementById("cmbProductCode").value;
                ...
                var ProductName = document.getElementById("cmbProductCode").value; //
                ...
                if (Invoice == "" || TotalAmount == "" || PaitentCode == "" || SaleDate == "" || DoctorCode == "" ||
                    TotalAmount == "0" && DiscountPercent < 100) {
        ...
        function SaveBillingDetails() {
            ...
            if (Invoice == "" || TotalSaleAmount == "" || PaitentCode == "" || SaleDate == "" || DoctorCode == "" ||
                ...
                var datas = "&Invoice=" + Invoice + "&TotalSaleQty=" + TotalSaleQty + "&TotalDiscountAmount=" +
                    ...
                    "&TokenNo=" + TokenNo + "&GrossAmount=" + GrossAmount + 
					"&BillingType=" + BillingType + "&LocationCode=" + LocationCode + "&OldAmountAdjusted=" + OldAmountAdjusted;
        ...
        function LoadProductList() {
            ...
            // alert(datas);
            $.ajax({
                url: "Load/LoadBillingItemListOpenBill.php",
                method: "POST",
                data: datas,
                success: function(data) {
        ...
        <div id="content" class="content">
            <label><b><u>Consultation Bill</u></b></label>
                    ...
                    <div class="panel-body">
                        ...
                        <table>
                            <tr>
                                ...
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    Token No: &nbsp;&nbsp;</td>
                                <td><input type='text' id='txtTokenNo' name='txtTokenNo'
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type='text' name='cmbProductCode' id='cmbProductCode' placeholder=""
                                            class="form-control" />
                                ...
                                <input style="background-color:white;" type="hidden" name="txtCategory" id="txtCategory"
