...
<body onload="LoadInvoiceNo();" onmousedown="CalculateCurrentTotal()">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function SaveBillingDetails() {
            var IsAdvance = document.getElementById("cmbAdvancePayment").value;
            var OldBalance = document.getElementById("txtoldbalance").value;
            var CurrentBillAmount = document.getElementById("txtAmountCurrentBill").value;
            var ExraCharge = document.getElementById("txtExtraCharge").value;
            var BillAmount = document.getElementById("txtTotalDueAmount").value;
            var ReceiptAmount = document.getElementById("txtTotalPayment").value;
            var Balace = document.getElementById("txtBalance").value;


            if (IsAdvance == 'Full') {

                SaveBillingDetailsFinal();
        ...
        function SaveBillingDetailsFinal() {
            ...
            if (Invoice == "" || TotalSaleAmount == "" || PaitentCode == "" || SaleDate == "" || TherapyDate == "" ||
                EveningTimeSlotID == "" && MorningTimeSlotID == "" && WaitingList == "" || userid == "" ||
                EntryType == "" ||
                ...
                var datas = "&Invoice=" + Invoice + "&TotalDiscountAmount=" + TotalDiscountAmount +
                    ...
                    "&ReceivedAmount=" + ReceivedAmount + "&userid=" + userid + "&BillType=" + BillType +
        ...
        function GetTokenNumber() {
            ...
            var datas = "&Dummy=" + Dummy + "&userid=" + userid;
            // alert(datas);
            $.ajax({
        ...
        function LoadAvailability() {
            ...
            var datas = "&Dummy=" + Dummy + "&userid=" + userid + "&TherapyDate=" + TherapyDate;
            // alert(datas);
            $.ajax({
                    ...
                    <div id='ModalProject' class='modal-window'>
                        <div class="row">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td> <select class="form-control" id='cmbAdvancePayment' name='cmbAdvancePayment'
                                            onchange='EnableAmount()'>
                            ...
                            <div class="col-md-4">
                                ...
                                <table>
                                    <tr>
                                        <td>Old Due &nbsp;&nbsp;&nbsp;</td>
                                        <td width=";"><b><input type="number" class="form-control" disabled
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><select class="form-control"
                                            ...
                                            <?php  
                            $sqli = "SELECT userid,username FROM doctormaster";
                            $result = mysqli_query($connection, $sqli); 
                             while ($row = mysqli_fetch_array($result)) {
                            	# code...
