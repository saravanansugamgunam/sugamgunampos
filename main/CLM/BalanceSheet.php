  ...
  function LoadSalesReport()
	  {
		...
		var PaymentModeStatus = document.getElementById("cmbPaymentModeStatus").value;   
		   // alert(Group);
		if(Group =='1')
		{
		...
		var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&Type="+Type+"&Location="+Location+"&Ledger="+Ledger+"&Category="+Category+"&PaymentModeStatus="+PaymentModeStatus; 
	 // alert(datas);
		 $.ajax({
		   url:"../FM/Load/LoadBalanceSheet.php",
		   method:"POST",
		   data:datas,
				...
				<input type='hidden' id='txtLocationCode' name ='txtLocationCode' value ='<?php echo $LocationCode; ?>' />
							  ...
							  <div class="form-group">
                                    ...
                                    <div class="col-md-12">
											...
											&nbsp;&nbsp;&nbsp; 
											<select  style='border-radius: 4px; padding: 5px;' id='cmbType' name ='cmbType' disabled >
											...
											&nbsp;&nbsp;&nbsp; 
											<select  style='border-radius: 4px; padding: 5px;' id='cmbCategory' name ='cmbCategory' >
											 <option value='All' selected >All</option>  
											  <?php
											$sqli = "SELECT UPPER(displayname) as categoryname FROM transactionmasterreport WHERE displayname NOT IN ('Expense Entry','Income Entry') UNION
											SELECT categoryname FROM accoutingcategory order by 1";
									  ...
									  echo ' <option value="'.$row['categoryname'].'">'.$row['categoryname'].'</option>';
											...
											<select  style='border-radius: 4px; padding: 5px;' id='cmbLedger' name ='cmbLedger' >
											 ...
											 <option value='-' >-</option> 
											  <?php
											$sqli = "SELECT ledgername FROM accountingledger";
											$result = mysqli_query($connection, $sqli); 
											 while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Details &nbsp;&nbsp;&nbsp;&nbsp; 
							 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
							<select id='cmbPaymentModeStatus' name='cmbPaymentModeStatus' 
