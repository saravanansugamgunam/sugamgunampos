	  ...
	  ?>
        ...
        function LoadCardData() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    // swal(data); 
                    var Profit = data[6] - data[7];
                    document.getElementById("pTherapyFee").innerHTML = data[0];
                    document.getElementById("pConsultingFee").innerHTML = data[1];
                    document.getElementById("pTotalIncome").innerHTML = data[2];
                    document.getElementById("pTotalExpense").innerHTML = data[3];
                    document.getElementById("pNettIncome").innerHTML = data[4];
                    // document.getElementById("pTotalProfit").innerHTML = data[5];
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Discount Bill Details</h4>
                    </div>
        ...
        <div id="content" class="content">
            ...
            <div class="row">
				...
				?>
                    ...
                    <input type="<?php echo $Visibility1; ?>" class="" placeholder="From" id="dtFromDate"
                        style='border-radius: 4px; padding: 5px;' />
                    <span <?php echo $Visibility2; ?>> &nbsp;&nbsp;&nbsp; to &nbsp;&nbsp;&nbsp; </span>
                    <input type="<?php echo $Visibility1; ?>" class="" placeholder="To" id="dtToDate"
                        style='border-radius: 4px; padding: 5px;' />
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <input type="<?php echo $Visibility3; ?>" class="btn btn-sm btn-info" onclick="LoadCardData();"
                        value='View'>
                    ...
                    <div class="col-md-2 col-sm-6">
                        <div class="widget widget-stats bg-green">
                            <div class="stats-info">
                                <h4><b>Nett Income</b></h4>
                                <p id='pNettIncome'>p</p>
                            </div>
                            <div class="stats-link">
                                <a href="javascript:;">View Detail <i class="fa fa-arrow-circle-o-right"></i></a>
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class=" panel panel-inverse">
                            <div class="panel-heading">
                                ...
                                <h4 class="panel-title">Day Summary</h4>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class=" panel panel-inverse">
                            <div class="panel-heading">
                                ...
                                <h4 class="panel-title">Cash Card Summary</h4>
                            </div>
                            <div class="panel-body">
                        ...
                        <div class=" panel panel-inverse">
                            <div class="panel-heading">
                                ...
                                <h4 class="panel-title">Balance Sheet
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <select id='cmbPaymentModeStatus' name='cmbPaymentModeStatus' style="color:black;"
                                        onchange='LoadBalanceSheet()'>
