...
<body onload="Reset();">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function LoadCaseSheetRegister() {
            ...
            // alert(datas);
            $.ajax({
                url: "Load/LoadCaseSheetRegister.php",
                method: "POST",
                data: datas,
                success: function(data) {
                    // alert(data);
        ...
        function SaveEnquiry() {
            ...
            var Status = document.getElementById("cmbLeadStatusFilter").value;
        ...
        function LoadCustomerDetails(x) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $("#txtName").val(data[2]);
                    $("#txtMobileNo").val(data[1]);
                    $("#cmbReference").val(data[6]);
                        ...
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form">
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control" id='cmbStakeholder' name='cmbStakeholder' disabled>

                                        <?php
                            $sqli = "  SELECT stakeholderid,stakeholder  FROM stakeholderlist WHERE activestatus ='Active' and
                            stakeholderid='1'";
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="fullname">Status * :</label>
                                <div class="col-md-6 col-sm-6">
                            ...
                            <div class="form-group" style='display:none'>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <select class="form-control" id='cmbReference' name='cmbReference' disabled>
                                        <?php
                            ...
                            <div class="form-group" style='display:none'>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <select class="form-control" id='cmbPriority' name='cmbPriority' disabled>
                ...
                <div class="col-md-12">
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Case Sheet Analysis
                                &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="form-group">
                            ...
                            <label class="radio-inline">
                                ...
                                <a class="btn btn-success  btn-sm" onclick='LoadCaseSheetRegister();'>View</a>
