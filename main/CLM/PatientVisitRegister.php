...
<html lang="en" class="ie8">
 ...
 <div id="content" class="content">
  ...
  function LoadPatientVisitReport()
	  {
		  // alert(1);
	 ...
	 // alert(datas);
		 $.ajax({
		   url:"Load/LoadPatientVisitReport.php",
		   method:"POST",
		   data:datas,
		  ...
		  LoadPatientVisitReportTotal();
	  }
	   
	    function LoadPatientVisitReportTotal()
	  {
	...
	var Type = document.getElementById("cmbType").value;  
		...
		var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&Type="+Type;  
	  	   // alert(datas);
		 $.ajax({
		   url:"Load/LoadPatientVisitReportTotal.php",
		   method:"POST",
		   data:datas,	
		   dataType:"json",
		   success:function(data)
      ...
      format: "dd/mm/yyyy"
        ...
        $('.datepicker').hide();
						 ...
						 <div class="panel-heading">
						    <h5 class="panel-title">Patient Visit Report
                        ...
                        <div class="panel-body">
							  ...
							  <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                         ...
                                         <input type="button"  class="btn btn-sm btn-info" onclick="LoadPatientVisitReport();"  value='View'>
                                    </div>
			   ...
			   <div class="col-md-12">
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
							...
							<tr>
							<td>Total Patient&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td>  <input style='border-radius: 4px; padding: 5px;  text-align: right' size="8" type='text' id='txtPatientCount' name ='txtPatientCount' /> 
							&nbsp;&nbsp;&nbsp;&nbsp;</td>
						 
							<td><b>Total Fees</b>&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td><b><input style='border-radius: 4px; padding: 5px; text-align: right;'   size="15"  type='text' id='txtTotalFees' 
							name ='txtTotalFees' /></b></td>
							</tr>
