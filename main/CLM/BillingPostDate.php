...
<body onload="LoadInvoiceNo();" onmousedown="CalculateCurrentTotal()">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        <script>
            ...
            function SaveBillingDetails() {
                ...
                if (Invoice == "" || TotalSaleAmount == "" || PaitentCode == "" || SaleDate == "" || DoctorCode == "") {
                    ...
                    var Session = document.getElementById("cmbSession").value;
                    ...
                    $.ajax({
                        url: "Save/SaveSaleMasterAdvance.php",
                        method: "POST",
                        data: datas,
                        success: function(data) {
            ...
            <div class="modal-dialog" style="width:500px;">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="javascript:;" class="btn btn-sm btn-info" onclick='UpdatePaitentDetails();' data-dismiss="modal">Save</a>
                        <a href="javascript:;" class="btn btn-sm btn-white" data-dismiss="modal">Close</a>
        ...
        <div id="content" class="content">
            <label><b><u>Consultation Bill - Post Date</u></b></label>
            &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <b><span class="blinkNew" id='spnNewConsulting'> </span></b>
            ...
            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <table>
                                    <tr>
                                        <td>Old Due</td>
                                        <td width="120px;"><b><input type="number" class="form-control" disabled id='txtoldbalance' name='txtoldbalance' style="text-align: right;background-color:white;" value='0' onchange="CalculateCurrentTotal();" /></b></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    </tr>
                            ...
                            <textarea id="txtRemarks" name="txtRemarks" rows="4" cols="50" placeholder='Remarks'></textarea>
                        </div>
                ...
                <div class="panel panel-inverse">
                    <div class="panel-body">
                        <input type="hidden" name="txtInvoiceNo" id="txtInvoiceNo" placeholder="" class="form-control" <div>
                        <table>
                            <tr>
                                <td>Sale Date </td>
                                <td></td>
                                ...
                                <td hidden>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    Token: &nbsp;&nbsp;</td>
                                <td hidden><input type='text' id='txtTokenNo' name='txtTokenNo' disabled style="font-size: 20px; box-shadow: 2px 2px 3px blue; border-radius: 5px; padding: 4px 7px;  text-align: center;" maxlength="4" size="4" /> </td>

                            </tr>
                            <tr>
                                <td><input type="date" class="form-control" placeholder="" id='dtSaleDate' name='dtSaleDate' min="<?php echo date("Y-m-d", strtotime("+ 0 day")); ?>" value='<?php echo date("Y-m-d", strtotime("+ 0 day")); ?>' />
                                ...
                                <td><select class="form-control" style='border-radius: 4px; padding: 5px; text-align: left;' id='cmbSession' name='cmbSession' style="width: 150px;">

                                        <?php
                                        $sqli = "SELECT sessionvalue,billingsession FROM onlinesessionlist ";
                                        $result = mysqli_query($connection, $sqli);
                                        while ($row = mysqli_fetch_array($result)) {
                                            # code...

                                            echo ' <option value=' . $row['sessionvalue'] . '>' . $row['billingsession'] . '</option>';
                                        }
                                        ?>
                                    </select></td>
                    ...
                    locationcode ='$LocationCode'";
                                ...
                                <td><select class="form-control" style='border-radius: 4px; padding: 5px; text-align: left;' id='cmbDoctor' name='cmbDoctor' style="width: 150px;" onchange='GetTokenNumber();'>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id='cmbProductCode' name='cmbProductCode' onchange="LoadProductDetails();ClearTotalAmount();LoadSpeacailTokenTiming()">
                                            <option selected></option>
                                ...
                                <input style=" background-color:white;" type="hidden" name="txtShortcode" id="txtShortcode" placeholder="" class="form-control" disabled />
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <label>MRP</label>
                                                    <input style="background-color:white;" type="text" name="txtMRP" id="txtMRP" placeholder="" class="form-control" onkeyup="CalculateTotal();" disabled />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <label>Disc %</label>
                                                    <input type="text" disabled name="txtDiscPercent" id="txtDiscPercent" placeholder="" class="form-control" value=0 onkeyup="CalculateTotal();" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <td>
                                            <div class="col-md-12">
                                                <b> <input style="text-align: right;" type="text" class="form-control" placeholder="" id='txtNettAmount' name='txtNettAmount' disabled /><b>
                                                        ...
                                                        <input style="text-align: right;" type="hidden" class="form-control" placeholder="" id='txtGrossAmt' name='txtGrossAmt' disabled />
