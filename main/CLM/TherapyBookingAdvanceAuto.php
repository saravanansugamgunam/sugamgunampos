...
<?php 
    ...
    SELECT
    (SELECT doctorcode FROM user WHERE id IN
...
<body onload="LoadInvoiceNo();" onmousedown="CalculateCurrentTotal()">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function SaveBillingDetails() {
            ...
            var EntryType = 'Advanced';
            var TherapyType = 'Recomended';


            if (Invoice == "" || TotalSaleAmount == "" || PaitentCode == "" || SaleDate == "" || TherapyDate == "" ||
                TherapyTime == "" || DoctorCode == "" || EntryType == "" || DoctorReferedby == "" || TotalSaleAmount ==
                "0") {
                swal("Alert!", "Kindly provide valid details!", "warning");
        ...
        <div id="content" class="content">
            <label><b><u>Therapy - Recomendation</u></b></label>
                    ...
                    <div class="panel-body">
                        ...
                        <div>
                            ...
                            ?>
                                    ...
                                    <td><input type="time" class="form-control" placeholder="" id='dtTherapyTime'
                                            name='dtTherapyTime' value="13:30" /></td>
                                    <td hidden>&nbsp;&nbsp;</td>
