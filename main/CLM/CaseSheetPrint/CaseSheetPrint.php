...
if(strlen($UniqueID)==16 || strlen($UniqueID)==14)
{
    ...
    (SELECT GROUP_CONCAT('&nbsp;',consultationname,'- (',duration,' Sittings',' ',c.conditionname,')'  ORDER BY mappingid ASC) 
    FROM diseasemapping_paitent AS a 
    ...
    testsrequired,
    c.doctorshortcode,
     IFNULL(a.referotherdoctor,'-') AS referotherdoctor
...
testsrequired,
c.doctorshortcode,
     IFNULL(d.referotherdoctor,'-') AS referotherdoctor
...
<head>
    ...
    <link rel="stylesheet" href="app-invoice-print5.css">
...
<body onload="window.print()">
    ...
    <div class="invoice-print p-4">
        ...
        <div class="outerDiv">
            <div class="leftDiv">
                <img src='newlogo1.png' height='110'><br>

            </div>
            <div class="rightDiv p-4">
 ...
 IF(mor='','',IF(mor='0','',CONCAT(mor,' ',IF(prescriptionuom='-','',prescriptionuom)))),
  ...
  ?>
        ...
        <div class="table-responsive border border-bottom-0 rounded">
            ...
            <table class="table m-0">
                <thead class="table-light border-top">
                    <tr>
                        <th style='border-right: 1px solid black;font:18px' width='%'><b>Medicine</b> </th>
                        <th style='border-right: 1px solid black;font:18px' width='%'><b>Mor</b> </th>
                        <th style='border-right: 1px solid black;font:18px' width='%'><b>Aft</b> </th>
                        <th style='border-right: 1px solid black;font:18px' width='%'><b>Eve</b> </th>
                        <th style='border-right: 1px solid black;font:18px' width='%'><b>Nig</b> </th>
                        <th style='border-right: 1px solid black;font:18px' width='%'><b>Condition</b> </th>
                        <th style='border-right: 1px solid black;font:18px' width='%'><b>Duration</b> </th>
                ...
                while ($data = mysqli_fetch_row($result)) {
                  echo " 
                    <tr >
                        <td width='%' style='border-right: 1px solid black;' id='Name'>$data[0]</td>
                        <td nowrap width='%' style='border-right: 1px solid black;' id='ID'>$data[1]</td>
                        <td nowrap width='%' style='border-right: 1px solid black;' id='ID'>$data[2]</td>
                        <td nowrap width='%' style='border-right: 1px solid black;' id='ID'>$data[3]</td>
                        <td nowrap width='%' style='border-right: 1px solid black;' id='ID'>$data[4]</td>
                        <td width='%' style='border-right: 1px solid black;' id='ID'>$data[5]</td>
                        <td width='%' style='border-right: 1px solid black;' id='ID' style='text-align:center'>$data[6]</td>
                    </tr>";
                  } 
                  ?>
        ...
        <div class="table-responsive border border-bottom-0 rounded" style='width:90%'>
            ...
            <table class="table m-0" style='width:100%'>
                <tbody>
                    ...
                    {?>
                    <tr>
                        <th style='border-right: 1px solid black;font:18px' width='%'><b>#</b> </th>
                        <th style='border-right: 1px solid black;font:18px' width='%'><b>Therapy</b> </th>
                        <th style='border-right: 1px solid black;font:18px' width='%'><b>Sittings</b> </th>
                        <th style='border-right: 1px solid black;font:18px' width='%'><b>Condition</b> </th> 
                        <th style='border-right: 1px solid black;font:18px' width='%'><b>Comments</b> </th> 
                    </tr>
                    <?php   
                    $Sno=1;
  $result = mysqli_query($connection, " SELECT  consultationname,duration,c.conditionname,condmanual 
  FROM diseasemapping_paitent AS a 
  ...
  WHERE  diseasemappinguniqueid ='$UniqueID' GROUP BY  consultationname,duration,c.conditionname ");
     while ($data = mysqli_fetch_row($result)) {
        echo " 
          <tr>
              <td width='%' style='border-right: 1px solid black;' id='Name'>$Sno</td>
              <td width='%' style='border-right: 1px solid black;' id='Name'>$data[0]</td>
              <td nowrap width='%' style='border-right: 1px solid black;' id='ID'>$data[1]</td>
              <td nowrap width='%' style='border-right: 1px solid black;' id='ID'>$data[2]</td> 
              <td nowrap width='%' style='border-right: 1px solid black;' id='ID'>$data[3]</td> 
            ...
            <table class="table m-0 table-borderless">
                <tbody>
                    ...
                    <tr>
                        <td class="align-top px-2 py-2">
                            <p class="mb-1">
                                <span class="me-1 fw-medium">Refer:</span>
                                <span><?php echo $OtherDoctorReference; ?></span>
                            </p>
                        </td>
