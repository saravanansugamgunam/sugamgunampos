    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
        ...
        function SaveStaff() {
            ...
            if (Name == "" || MobileNo == "" || Salary == "") {
                ...
                var datas = "&Name=" + Name + "&DOB=" + DOB + "&Gender=" + Gender + "&MaritalStatus=" + MaritalStatus +
                    "&MobileNo=" + MobileNo + "&AlternateContactNo=" + AlternateContactNo + "&Address=" + Address +
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-6">
                    <button class='btn btn-primary' onclick='LoadStaffList()'>Search</button>
                </div>
                <div class="col-md-12">
