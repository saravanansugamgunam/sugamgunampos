...
var datas = "&Dumy="+Dumy;	
		 ...
		 $.ajax({
		   url:"Load/LoadTokenDisplay11.php",
		   method:"POST",
		   data:datas,
...
var datas = "&Dumy="+Dumy;	
		 ...
		 $.ajax({
		   url:"Load/LoadTokenDisplay21.php",
		   method:"POST",
		   data:datas,
		   success:function(data)
		   {	
 ...
 var datas = "&Dumy="+Dumy;	
	  	  // alert(datas);
		 $.ajax({
		   url:"Load/LoadTokenNumberforDisplay11.php",
		   method:"POST",
		   data:datas,
		   dataType:"json",
		   success:function(data)
...
var datas = "&Dumy="+Dumy;	
	  	  // alert(datas);
		 $.ajax({
		   url:"Load/LoadTokenNumberforDisplay21.php",
		   method:"POST",
		   data:datas,
		   dataType:"json",
		   success:function(data)
...
else
{
  ...
  <div class="column full-height" style="background-color:#53c0cb;">
	...
	<span  style='font-size: 25px;'><?php echo $Room1Caption; ?> </span></b> </p> 
  
	</center>
	 
	<hr>
	<p style='font-size: 25px;'>&nbsp;&nbsp; 
	<span id='pNextTokenNo1' style='font-size: 25px;'></span></p>
	
	<p style='font-size: 25px;'>&nbsp;&nbsp; 
	<span id='pNextTokenName1' style='font-size: 25px;'> </span></p>
  ...
  <div class="column full-height" style="background-color:#9bd3f7;">
    <center>
	<p  style='font-size: 25px;'>&nbsp;&nbsp; <b>
	<span  style='font-size: 25px;'> <?php echo $Room2Caption; ?> </span></b> </p> 
  
	</center>
	 
	<hr>
	<p style='font-size: 25px;'>&nbsp;&nbsp;  
	<span id='pNextTokenNo2' style='font-size: 25px;'></span></p>
	
	<p style='font-size: 25px;'>&nbsp;&nbsp;  
	<span id='pNextTokenName2' style='font-size: 25px;'> </span></p>
