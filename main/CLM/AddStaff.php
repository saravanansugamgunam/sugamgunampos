...
<html lang="en" class="ie8">
  ...
  function SaveStaff()
	  ...
	  {
var datas = "&Name="+Name+"&DOB="+DOB+"&Gender="+Gender+"&MaritalStatus="+MaritalStatus+"&MobileNo="+MobileNo+"&AlternateContactNo="+AlternateContactNo+"&Address="+Address+"&Salary="+Salary+"&DOJ="+DOJ+"&BiometricID="+BiometricID;	
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Staff Name" id='txtStaffName' name='txtStaffName' />
                                    </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="date" class="form-control" placeholder="" id='dtDOJ' name='dtDOJ' />
                                    </div>
									 <label class="col-md-2 control-label">Salary</label>
                                    <div class="col-md-3">
                                        <input type="number" class="form-control" placeholder="" id='txtSalary' name='txtSalary' />
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" class="form-control" placeholder="" id='txtBiometricID' name='txtBiometricID' />
                                    </div> 
                                </div>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" placeholder="" id='txtModifyBiometricID' name='txtModifyBiometricID' />
                                    </div>
