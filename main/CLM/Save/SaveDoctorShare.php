...
if(isset($_POST["InvoiceNo"]))
{
 ...
 $InvoicePrefix  = 	"L".$InvoicePrefix;  
  ...
  try { 
    ...
    $SaveSaleMaster = "insert into doctorsharedetails (invoiceno,doctorcode,entrydate,fromdate,todate,calculationmode,profitpercent,shareamount,totalsale,totalprofit,paymentmode,remarks,enteredby,sharefor) values 
	('$InvoiceNo','$DoctorCode','$EntryDate','$FromDate','$ToDate','$CalculationMode','$SharePercent','$AmountToPay','$TotalSale','$Profit','$PaymentMode','$Remarks','$userid','$ShareFor');"; 
  ...
  {
  $SaveSaleMaster.= "insert into salepaymentdetails (customercode ,paymentmode,amount,invoiceno,date,clientid,transactiontype,transactiongroup) values ('$DoctorCode','$PaymentMode','$AmountToPay','$InvoiceNo','$EntryDate','$ClientID','Consulting Share','Clinic')"; 
  }
  else
  {
	$SaveSaleMaster.= "insert into salepaymentdetails (customercode ,paymentmode,amount,invoiceno,date,clientid,transactiontype,transactiongroup) values ('$DoctorCode','$PaymentMode','$AmountToPay','$InvoiceNo','$EntryDate','$ClientID','Therapy Share','Clinic')";   
  }
