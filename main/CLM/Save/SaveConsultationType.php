...
if(isset($_POST["PatientType"]))
{
 ...
 $Status = mysqli_real_escape_string($connection, $_POST["Status"]);    
  ...
  try {
    ...
    consultationcharge,consultationid,activestatus) values
    ('$ConsultationType','$ConsultationName','$FeesAmount','$ID','$Status') on 
    DUPLICATE KEY UPDATE consultingtype='$ConsultationType',consultationname='$ConsultationName',
    consultationcharge='$FeesAmount',activestatus='$Status' "; 
