 <?php
  ...
  if (isset($_POST["InvoiceNo"])) {
    ...
    SELECT COUNT(*) FROM therapybookingdetails WHERE bookinguniqueid ='$BookingID' AND bookingstatus='Booked';  ");
      ...
      if ($BalanceSitting == 1 || $BalanceSitting == 0) {
        ...
        $SaveSaleMaster .= "insert into therapyclosredetails (bookinguniqueid,therapyid,paitentid,sitting,closingdate,updatedby,bookingitemid,remarks) 
...
revisedtherapydate=(select min(reviseddate) from therapybookingdetails where bookinguniqueid ='$BookingID' and  bookingstatus='Booked' ) 
