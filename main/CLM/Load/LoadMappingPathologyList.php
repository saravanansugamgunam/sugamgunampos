 <?php
  ...
  $result = mysqli_query($connection, "  SELECT mappingid,pathology  FROM diseasemapping AS a 
  JOIN pathologymaster AS b ON a.conceptid=b.`pathologyid` AND a.conceptname='Pathology'
    AND a.diseaseid='$DiseaseID'");
