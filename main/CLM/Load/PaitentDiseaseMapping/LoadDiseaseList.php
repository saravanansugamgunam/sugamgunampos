 <?php
  ...
  $result = mysqli_query($connection, " SELECT mappingid,disease FROM diseasemapping_paitent AS a 
  JOIN diseasemaster AS b ON a.conceptid=b.diseaseid and a.conceptname='Disease' AND a.paitientid='$PaitentID'
