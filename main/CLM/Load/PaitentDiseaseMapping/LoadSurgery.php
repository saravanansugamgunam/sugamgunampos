 <?php
  ...
  $result = mysqli_query($connection, " SELECT mappingid,surgeryname,condmanual FROM diseasemapping_paitent AS a 
  JOIN surgerymaster AS b ON a.conceptid=b.surgeryid and a.conceptname='Surgery' AND a.paitientid='$PaitentID' 
  ");
