 <?php
  ...
  $result = mysqli_query($connection, " SELECT mappingid,medicinename,condmanual FROM diseasemapping_paitent AS a 
  JOIN medicinehistorymaster AS b ON a.conceptid=b.medicineid and a.conceptname='Medicine History' AND a.paitientid='$PaitentID' 
  ");
