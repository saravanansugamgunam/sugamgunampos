 <?php
  ...
  $result = mysqli_query($connection, " SELECT mappingid,medicationname,condmanual FROM diseasemapping_paitent AS a 
  JOIN previousmedicationmaster AS b ON a.conceptid=b.medicationid and a.conceptname='Medical Stream History' AND a.paitientid='$PaitentID' 
  ");
