 <?php
  ...
  SELECT mappingid,
  CONCAT(productshortcode,':<br> ' ,productname),
  ...
  <td width='%'  id='ID' >$data[8]</td>
    <td width='%'  nowrap><i style='color:blue;cursor: pointer;' 
  class='fa fa-edit' onclick='UpdateProductIDEdit($data[0])'></i></td>
