...
SELECT a.bookingid,b.consultationname,a.totalsitings, a.rate,a.discount,a.nettamount FROM therapybookingdetails AS a JOIN 
...
echo " <thead><tr>  
		<th>S. No</th>     
		<th width='%'><a href=\"javascript:SortTable(2,'T');\">Item ID</a></th>        
