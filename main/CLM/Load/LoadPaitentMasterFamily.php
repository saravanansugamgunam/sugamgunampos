...
echo "<hr>";
    $result = mysqli_query($connection, "SELECT paitentid, paitentname,gender, relationship  FROM 
paitentmaster where mobileno in(select mobileno from paitentmaster where paitentid='$PaitentID') order by paitentname limit 100
  ");
    ...
    echo " <thead><tr>  
		...
		<th width='0%'><a href=\"javascript:SortTable(3,'T');\">Relation No</a></th>      
