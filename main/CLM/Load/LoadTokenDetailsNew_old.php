...
if (isset($_POST["Location"])) {
   ...
   else
   {
	...
	if($Type=='Consultation'){
		...
		d.consultationname,a.patientarivalstatus
		...
		if ($data[2]=='Open')
		{
			if ($data[11] == '1') {
				echo "<td >
				 ...
				 <i style=' color:lightgreen'  class='fa fa-3x fa-circle'></i>
...
while ($data = mysqli_fetch_row($result)) {
	echo " <tr> <td width='%'> $SerialNo </td> ";
	echo " <td width='%'> <i style=' color:#25d366' class='fa fa-3x fa-leaf	'></i> </td>"; 
	echo " <td> <label style=' font-size: 20px;color: blue;'>
