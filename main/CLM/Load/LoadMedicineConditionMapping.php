 <?php
  ...
  SELECT a.id,alternatebarcode,b.`productshortcode`
FROM alternate_medicines AS a JOIN productmaster AS b ON a.`alternatebarcode`=b.`uniquebarcode`
WHERE parentbarcode ='$SelectedMedicine'  ");
  ...
  <td width='%' id='Name' >$data[2]</td>      
   <td width='%'>
   <a href='#'  onclick='DeleteAlternateMedicine($data[0]);' class='btn btn-sm btn-danger btn-xs' >Delete</a></td>    
  </tr>";
