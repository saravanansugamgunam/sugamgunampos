 <?php
  ...
  $result = mysqli_query($connection, "  SELECT mappingid,acupoints  FROM diseasemapping AS a 
  JOIN acupuncturepoints AS b ON a.conceptid=b.`acuid` AND a.conceptname='Acupoints'
