...
if (isset($_POST["MobileNo"])) {
 ...
 DATEDIFF(IFNULL(d.nextappointmentdate,'1900-01-01'),CURRENT_DATE) AS AppointmentDate, IFNULL(d.freestatus,'Paid') AS FreeAppointment
...
LEFT JOIN nextappointmentdetails AS d ON a.paitentid=d.paitentid
WHERE a.barcode ='" . $Barcode . "'");
   ...
   LEFT JOIN nextappointmentdetails AS d ON a.paitentid=d.paitentid
	...
	while ($row = mysqli_fetch_assoc($query)) {
		...
		$data[] = $row['AppointmentDate'];
		$data[] = $row['FreeAppointment'];
	}
