 <?php
  ...
  $result = mysqli_query($connection, "  SELECT mappingid,CONCAT(productshortcode,': ' ,productname)  FROM diseasemapping AS a 
  JOIN productmaster AS b ON a.conceptid=b.`productid` AND a.conceptname='Medicine' AND a.diseaseid='$DiseaseID'");
