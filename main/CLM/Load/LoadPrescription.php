...
SELECT a.id,DATE_FORMAT(a.createddate,'%d-%m-%Y') as date,b.username,
a.prescription,a.documentlink FROM prescriptionmaster AS a JOIN usermaster AS b ON a.doctorid=b.userid 
