...
$(document).ready(function() {
 ...
 <?php
  ...
  $result = mysqli_query($connection, "  SELECT durationid,duration,noofdays,activestatus
 								FROM prescriptionduration order by duration");
  ...
  <td width='%' id='noofdays' >$data[2]</td>       
