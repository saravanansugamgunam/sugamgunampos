...
$result = mysqli_query($connection, "
 ...
 FROM consultingbillmaster  AS a  JOIN doctormaster AS b ON a.doctorid=b.doctorcode 
 ...
 WHERE billdate > '2022-08-01'  
  AND billdate   BETWEEN '$FromDate' AND '$ToDate'  AND  a.locationcode LIKE('%') 
   AND a.cancelledstatus =0  AND a.doctorid LIKE ('$DoctorCode') AND a.billtype='$ShareFor'   $Status 
