...
$(document).ready(function() {
 ...
 <?php
  ...
  $result = mysqli_query($connection, "  SELECT conditionid,conditionname
 								FROM medicineprescriptioncondition where conditiontype ='Medicine'
                and conditionname<>'-' order by conditionname");
