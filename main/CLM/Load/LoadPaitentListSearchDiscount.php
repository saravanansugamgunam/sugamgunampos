...
DATE_FORMAT(dob ,'%d-%m-%Y') dob ,mobileno,email,medicinediscount,consultingdiscount, therapydiscount  FROM 
  paitentmaster where
medicinediscount <> 0 OR  consultingdiscount <> 0 OR therapydiscount <> 0   order by paitentname
  ");
...
echo " <thead><tr>  
		...
		<th width='0%'><a href=\"javascript:SortTable(4,'T');\">Med Disc%</a></th>     
		<th width='0%'><a href=\"javascript:SortTable(4,'T');\">Con Disc%</a></th>     
		<th width='0%'><a href=\"javascript:SortTable(4,'T');\">Thy Disc%</a></th>     
...
while($data = mysqli_fetch_row($result))
{
  ...
  <td id='PatientEmail' width='0%'>$data[6]</td>    
  <td id='PatientEmail' width='0%'>$data[7]</td>    
  <td id='PatientEmail' width='0%'>$data[8]</td>    

  <td width='0%' onclick='GetRowID(this);'><a href='ConsultingView.php?PID=$data[0]&INV=0&TID=0&S=C&MID=52' 
