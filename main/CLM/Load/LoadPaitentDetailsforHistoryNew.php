...
while ($data = mysqli_fetch_row($result)) {
	...
	echo "<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>";
	if ($data[9] > 0) {
		echo "<td><p style='font-size: 20px;color:red;'>Outstanding:&nbsp;&nbsp;<b>";
		echo  $data[9];
		echo "</p></td>";
	} else if ($data[9] < 0) {
		echo "<td><p style='font-size: 20px;color:green;'>Outstanding:&nbsp;&nbsp;<b>";
		echo  $data[9];
		echo "</p></td>";
	} else {
		...
		<div class="modal-dialog ">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type='number' id='txtDiscountMedicine' name='txtDiscountMedicine' class='form-control' style="width:50%;" value=<?php echo  $data[10]; ?> />

					<label>Consulting Discount %</label>
					<input type='number' id='txtDiscountConsulting' name='txtDiscountConsulting' class='form-control' style="width:50%;" value=<?php echo  $data[11]; ?> />

					<label>Therapy Discount %</label>
					<input type='number' id='txtDiscountTherapy' name='txtDiscountTherapy' class='form-control' style="width:50%;" value=<?php echo  $data[12]; ?> />
