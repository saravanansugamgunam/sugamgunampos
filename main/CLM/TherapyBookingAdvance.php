...
<body onload="LoadInvoiceNo();" onmousedown="CalculateCurrentTotal()">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function SaveTherapyDetails() {
            ...
            if (PaitentName == "" || Doctor == "" || DoctorReferedby == "" || TherapyName == "" || BookingDate == "" ||
                ...
                var datas = "&PaitentName=" + PaitentName + "&TherapyName=" + TherapyName + "&BookingDate=" +
                    ...
                    "&EntryType=" + EntryType + "&TotalHours=" + TotalHours + "&EveningTimeSlotID=" + EveningTimeSlotID + 
        ...
        function SaveBillingDetails() {
            ...
            EveningTimeSlotID == "" && MorningTimeSlotID=="" && WaitingList=="" || DoctorCode == "" || EntryType == "" 
            ...
            <div class="modal fade" id="ModalSchedule" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-warning" onclick='SetWaitingList()' data-dismiss="modal" style='float:left'>Waiting List</button>
                            ...
                            ?>
                                    ...
                                    <td> 
                                            <input type="text" class="form-control" placeholder="Select Schedule"
                                                id='dtTherapyTime' name='dtTherapyTime'
                                                onclick="LoadAvailability()" data-toggle="modal" 
                                                data-target="#ModalSchedule" readonly style='cursor:pointer;' /> 
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <label>&nbsp;</label>
                                            <div class="controls">
                                                ...
                                                <input style="background-color:white;" type="hidden" name="txtTotalHours"
                                                    id="txtTotalHours" placeholder="" class="form-control" disabled />
