            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table>
                        <tr>
                            <td>Patient</td>
                            <td><input type='text' id='txtPatientUpdatedName' name='txtPatientUpdatedName' /></td>
                        </tr>
                        <td><br></td>
                        <tr>
                            <td>Mobile No</td>
                            <td><input type='text' id='txtPatientUpdatedMobileNo' name='txtPatientUpdatedMobileNo' />
                            </td>
                        </tr>
                        <td><br></td>
                        <tr>
                            <td>Email ID</td>
                            <td><input type='text' id='txtPatientUpdatedEmail' name='txtPatientUpdatedEmail' /></td>
                        </tr>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-info" onclick="UpdatePatient();"
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
        ...
        function SaveRoomSettings() {
            ...
            if (Doctor == "" || Room == "") {
                ...
                var datas = "&Doctor=" + Doctor + "&Room=" + Room;
                // alert(datas);
                $.ajax({
                    url: "Save/SaveRoomSettings.php",
                    method: "POST",
                    data: datas,
                    success: function(data) {
                        if (data == 1) {
                          LoadRoomDetails()
                            swal("Settings!", "Room Settings Saved", "success");

                        } else {
                            swal("Settings!", "Try again later", "warning");
...
if (roomid == "") {
    ...
    var datas = "&roomid=" + roomid;
    // alert(datas);
    $.ajax({
        url: "Save/DeleteRoomDetails.php",
        method: "POST",
        data: datas,
        success: function(data) {
            if (data == 1) {
              LoadRoomDetails();
                swal("Settings!", "Room Settings Removed", "success");
        ...
        function LoadRoomDetails()
        {
          var Invoice = 123;
                ...
                $.ajax({
                    url: "Load/LoadRoomAllocationList.php",
                    method: "POST",
                    data: datas,
                    success: function(data) {


                        $('#DivRoomDetails').html(data);
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            <h4 class="panel-title">Room Allocation</h4>
                        </div>
                            ...
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" id='cmbRoom' name='cmbRoom'
                                            onchange='focusamount();'>
                                            <option></option>
                                            <?php
                                            $sqli = "  SELECT id, roomname FROM roommaster WHERE clientid='$LocationCode '";
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" id='cmbDoctor' name='cmbDoctor'
                                            ...
                                            activestatus ='Active' and userid <>'33'";
                                            $result = mysqli_query($connection, $sqli);
                                            while ($row = mysqli_fetch_array($result)) {
                                                # code...
                                    ...
                                    <input type="button" class="btn btn-sm btn-success" onclick="SaveRoomSettings();"
                                        value='Save'>
