 ...
 <div id="content" class="content">
  ...
  function LoadAttendanceRegister()
	...
	var FromDate = document.getElementById("dtFromDate").value;   
	 ...
	 // alert(datas);
		 $.ajax({
		   url:"Load/LoadAttendanceRegister.php",
		   method:"POST",
		   data:datas,
      ...
      format: "dd/mm/yyyy"
        ...
        $('.datepicker').hide();
						 ...
						 <div class="panel-heading">
						    <h5 class="panel-title">Biometric Log 
                        ...
                        <div class="panel-body">
							  ...
							  <div class="form-group">
                                    ...
                                    <div class="col-md-8">
											...
											&nbsp;&nbsp;&nbsp;
                                         <input type="button"  class="btn btn-sm btn-info" onclick="LoadAttendanceRegister();"  value='View'>
                                    </div>
