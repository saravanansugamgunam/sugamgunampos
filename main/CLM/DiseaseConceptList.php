...
<body onload="LoadDiseaseConceptList();">
    <!-- begin #page-loader -->
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function Reset() {
            ...
            LoadDiseaseConceptList();
        }


        function LoadDiseaseConceptList() {

            var ReportFilter = document.getElementById("cmbReportFilter").value;


            var datas = "&ReportFilter=" + ReportFilter;

            // alert(datas);
            $.ajax({
                url: "Load/LoadDiseaseConceptList.php",
                method: "POST",
                data: datas,
                ...
                <div class="col-md-12">
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Disease Concept Mapping List
                        ...
                        <div class="form-group">
                            ...
                            <label class="radio-inline"> List Filter

                                <select class="js-states form-control" tabindex="-1" id='cmbReportFilter'
                                    name='cmbReportFilter'>
                            ...
                            <label class="radio-inline">
                                ...
                                <a class="btn btn-success  btn-sm" onclick='LoadDiseaseConceptList();'>View</a>
