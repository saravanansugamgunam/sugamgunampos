<form action="" method="post">
    ...
    $originalDate = mysqli_real_escape_string($connection, $_POST["NextAppointment"]); 
    $MobileNo = mysqli_real_escape_string($connection, $_POST["MobileNo"]); 
    $NextAppointment = date("d-m-Y", strtotime($originalDate)); 
   
   if($NextAppointment=='01-01-1970')
   {
   ...
   
   {
    ...
    $Message1='Dear ';
    $Message2=', Thank you for Visiting Sugamgunam, your next visit is on ';
    $Message3= $NextAppointment;  
    $Message4= ' Kindly book your appointment before 1 day, use the link to book your appointment ';  
    $Message5= 'https://tinyurl.com/mdj56jtt'; 
    $Message6= ' In case of any clarrifications please call: +91 94882 28603'; 
    
    $MessageOriginal =  $Message1.$PaitentName.$Message2.$Message3.$eInvoiceNo.$Message4.$Message5.$Message6;
