...
<html lang="en" class="ie8">
  ...
  function SaveStaff()
	  ...
	  {
var datas = "&Name="+Name+"&DOB="+DOB+"&Gender="+Gender+"&MaritalStatus="+MaritalStatus+"&MobileNo="+MobileNo+"&AlternateContactNo="+AlternateContactNo+"&Address="+Address+"&Salary="+Salary+"&DOJ="+DOJ;	
	  ...
	  function LoadStaffList()
	  {
		...
		var datas = "&Dumy="+Dumy;	
	  	  // alert(datas);
		 $.ajax({
		   url:"Load/LoadPaitentListSearchDiscount.php",
		   method:"POST",
		   data:datas,
		   success:function(data)
		   {	
								...
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										<div class="modal-header">
											...
											<h4 class="modal-title">Paitent List</h4>
										</div>
										<div class="modal-bod">
											 <div class="col-md-12">
			        <!-- begin panel -->
       ...
       <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Paitent List  
							  </h4> 
