...
?>
        ...
        function LoadTokenDetails() {
            ...
            $.ajax({
                url: "Load/LoadReconsultationDetails.php",
                method: "POST",
                data: datas,
                success: function(data) {
 ...
 function SaveReconsultationClosure(x) {

            var TherapyBookingID = x;
            var datas = "&TherapyBookingID=" + encodeURIComponent(TherapyBookingID);


            $.ajax({
                url: "Save/SaveTherapyClosureInstant.php",
                method: "POST",
                data: datas,
                success: function(data) {
                    ...
                    if (data == 1) {
                        ...
                        Swal.fire({
                            position: 'center',
                            icon: 'success',
                            title: 'Therapy Reconsulation Completed Sucessfully',
                        ...
                        setTimeout(function() {
                            window.location.href =
                                "TodaysReconsultation.php?MID=31"; //will redirect to your blog page (an ex: blog.html)
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            <h4 class="panel-title">Reconsultation List
