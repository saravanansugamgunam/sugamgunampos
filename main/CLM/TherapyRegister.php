...
<body onload="LoadTherapyRegister(); LoadInvoiceNo();" onmousedown="CalculateBalance()">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function LoadTherapyRegisterScheduled() {
            var FromDate = document.getElementById("dtFromDate").value;
            var ToDate = document.getElementById("dtToDate").value;
            ...
            $.ajax({
                url: "Load/LoadTherapyScheduled.php",
                method: "POST",
                data: datas,
                success: function(data) {
                    // alert(data);
        ...
        function SendSMSDoctor(x) {
            ...
            var row = x.parentNode.rowIndex;
            // alert(row);
            var MobileNo = document.getElementById("tblTherapyRegister").rows[row].cells.namedItem("DoctorMobile")
                .innerHTML;
            var TherapyDate = document.getElementById("tblTherapyRegister").rows[row].cells.namedItem("TherapyDate")
                .innerHTML;
            var TherapyTime = document.getElementById("tblTherapyRegister").rows[row].cells.namedItem("TherapyTime")
                            ...
                            ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="selectpicker form-control" data-show-subtext="true"
                                                data-live-search="true" data-style="btn-white" id='cmbDoctor'
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <i onclick='LoadAvailability()' style='cursor:pointer;' class="fa fa-2x fa-clock-o"></i>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Therapy Status &nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            <ul class="nav nav-tabs ">
                                ...
                                <li class=""><a href="#default-tab-1" data-toggle="tab">1. Waiting List</a></li>
                                <li class=""><a href="#default-tab-2" data-toggle="tab">2. Scheduled</a></li>
                                <li class=""><a href="#default-tab-3" data-toggle="tab">3. Completed</a></li>
                                <li class=""><a href="#default-tab-4" data-toggle="tab">4. Cancelled</a></li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade in" id="default-tab-1">
                                    <h4 class="m-t-10">Waiting List - Therapy</h4>

                                    <div class="table-responsive" id='DivTherapyWaitingList'></div>
                                    ...
                                    <div class="panel-body">
                                        <form class="form-inline">
                                            ...
                                            <div class="form-group" id='DivCustomDate' name='DivCustomDate'
                                                ...
                                                <input class="form-control" type='date' id='dtFromDate'
                                                    name='dtFromDate' />
                                                <label>To Date</label>
                                            ...
                                            <button type="button" class="btn btn-info"
                                                onclick='LoadTherapyRegisterScheduled()'>Load</button>
                                        </form>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="default-tab-3">
                                        ...
                                        <form class="form-inline">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="js-states form-control" tabindex="-1"
                                                    id='cmbPeriodClosure' name='cmbPeriodClosure'
                                                    onchange='ShowHideDivClosure();'>
                                            ...
                                            <div class="form-group" id='DivCustomDateClosure'
                                                name='DivCustomDateClosure' style='display:none;'>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <label>From Date</label>
                                                <input class="form-control" type='date' id='dtFromDateClosure'
                                                    name='dtFromDateClosure' />
                                                <label>To Date</label>
                                                <input class="form-control" type='date' id='dtToDateClosure'
                                                    name='dtToDateClosure' />
                                            </div>
                                            ...
                                            <button type="button" class="btn btn-info"
                                                onclick='LoadTherapyCompleted()'>Load</button>
                                        </form>
                                    </div>
                                    ...
                                    <div class="table-responsive" id='DivTherapyClosed'></div>
                                </div>
