  ...
  <body  onload="LoadCardData();">
    ...
    $('#dtToDate').datepicker({
	     ...
	     function LoadCardData()
	  {
	   ...
	   <iframe width="1160" height="700" src="https://app.powerbi.com/view?r=eyJrIjoiYTI4NjhiMmQtZDgyMy00ZGYyLTg4ZTItZmNjYjhiNTdiNTg2IiwidCI6ImIxYmYwNDBjLTVhZTMtNDQyYy04YjMxLTQ1ODljMDc3YzA5ZSJ9" frameborder="0" allowFullScreen="true"></iframe>
