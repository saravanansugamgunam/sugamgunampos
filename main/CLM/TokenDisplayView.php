        ...
        <div id="myModalRefund" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                function LoadCaseHistoryCurrent() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $("#txtCompliant").val(data[6]);
                            $("#txtPresentIllness").val(data[7]);
                            $("#txtPastIllness").val(data[8]);
                            $("#txtDiagnosis").val(data[9]);
                            $("#txtMedicine").val(data[10]);
                            $("#txtAdvice").val(data[11]);
                            $("#txtTestRequired").val(data[12]);
                ...
                function UpdateCaseHistory() {
                    ...
                    var Advice = document.getElementById("txtAdvice").value;
                    var TestRequired = document.getElementById("txtTestRequired").value;
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class=" " onclick='LoadCaseHistoryCurrent();'><a href="#default-tab-13"
                                            data-toggle="tab">Case Sheet</a></li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="default-tab-13">
                                        ...
                                        <h3 class="m-t-10"> Paitent Case Sheet</h3>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control" id="txtSkinHairNail"
