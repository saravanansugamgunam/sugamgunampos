...
<div id="myModifyPaymentMode" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Modify Payment Mode</h4>
            </div>

            <div class="modal-body">

                <select id='cmbPaymentMode' name='cmbPaymentMode' onchange='focusamount();' style="width: 150px; height:30px; padding-top:6px; padding-bottom: 4px; margin-right: 4px; font-size:15px; border-radius: 4px;">
                    <option></option>
                    <?php
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" onclick="ModifyPaymentMode();" data-dismiss="modal">Save</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
        </div>
...
<div id="ModifyDoctor" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <select id='cmbChangeDoctor' name='cmbChangeDoctor' onchange='GetTokenNewNumber();' style="width: 150px; height:30px; padding-top:6px; padding-bottom: 4px; margin-right: 4px; font-size:15px; border-radius: 4px;">
                    <option></option>
                    <?php
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" onclick="ModifyDoctor();" data-dismiss="modal">Save</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <br>
                <textarea class="form-control" id='txtCancelledRemarks' name='txtCancelledRemarks' placeholder='Remarks'></textarea>
            ...
            <div class="row">
                ...
                <script>
                    ...
                    function LoadSalesReport() {
                        ...
                        var ConsultationType = document.getElementById("cmbConsultationType").value;
                        var ConsultationGroup = document.getElementById("cmbConsultationTypeGroup").value;
                        var Doctor = document.getElementById("cmbDoctor").value;
                        var PaymentMode = document.getElementById("cmbPaymentModeReport").value;
                        ...
                        var datas = "&FromDate=" + FromDate + "&ToDate=" + ToDate + "&Type=" + Type + "&ConsultationType=" +
                            ConsultationType + "&Location=" + Location + "&ConsultationGroup=" + ConsultationGroup +
                            "&Doctor=" + Doctor + "&PaymentMode=" + PaymentMode;
                        // alert(datas);
                        $.ajax({
                            url: "Load/LoadSalesReport.php",
                            method: "POST",
                            data: datas,
                    ...
                    function ModifyPaymentMode() {
                        ...
                        var InvoiceNo = document.getElementById("txtCancelInvoiceNo").value;
                        var PaymentMode = document.getElementById("cmbPaymentMode").value;
                        var datas = "&InvoiceNo=" + InvoiceNo + "&PaymentMode=" + PaymentMode;
                        if (PaymentMode == '') {
                            swal("Alert!", "Select the Paymentmode", "warning");
                        } else {
                            $.ajax({
                                url: "Save/ModifyPaymentMode.php",
                                method: "POST",
                                data: datas,
                                success: function(data) {

                                    // swal("Alert!", 'Selected item returned', "success"); 
                                    swal("Alert!", "Payment Mode Modified Sucessfully", "success");
                    ...
                    function GetTokenNewNumber() {
                        var Dummy = 1;
                        var DoctorCode = document.getElementById("cmbChangeDoctor").value;
                    ...
                    function ModifyDoctor() {
                        ...
                        var DoctorID = document.getElementById("cmbChangeDoctor").value;
                        var datas = "&InvoiceNo=" + InvoiceNo + "&DoctorID=" + DoctorID + "&NewToken=" + NewToken;

                        alert(datas);
                        if (DoctorID == '') {
                            swal("Alert!", "Select the Doctor Name", "warning");
                        } else {
                            $.ajax({
                                ...
                                success: function(data) {
                                    alert(data);
                                    if (data == 1) {
                                        swal("Alert!", "Doctor Modified Sucessfully", "success");
                                        LoadSalesReport();
                                    } else {
                                        swal("Alert!", "Unable to Modify Doctor", "warning");
                                    }
                    ...
                    function SaveCourierDetails() {
                        ...
                        if (CourierName == '' || CourierDate == '' || CourierReference == '' || CourierInvoice == '') {
                            ...
                            var datas = "&CourierName=" + CourierName + "&CourierDate=" + CourierDate +
                                "&CourierReference=" + CourierReference + "&CourierRemarks=" + CourierRemarks +
                    ...
                    function CancellBill() {
                        ...
                        var CancelledRemarks = document.getElementById("txtCancelledRemarks").value;

                        if (Password != '12345') {
                            swal("Alert!", "Admin password not matchihg", "warning");
                        } else {
                            var datas = "&Invoice=" + Invoice + "&CancelledRemarks=" + CancelledRemarks;
                            // alert(datas);
                            $.ajax({
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-heading">
                            <h5 class="panel-title">Consultation Report
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <select style='border-radius: 4px; padding: 5px;' id='cmbConsultationTypeGroup' name='cmbConsultationTypeGroup'>
                                        <option value="General">General</option>

                                    </select>


                                    <select style='border-radius: 4px; padding: 5px;' id='cmbConsultationType' name='cmbConsultationType'>
                                        <option value="All" selected>All Consultation</option>
                                        <?php
                                        $sqli = "SELECT a.consultationid,a.consultationname FROM consultationmaster
                      AS a JOIN consultingdetails AS b ON a.`consultationid`=b.`consultationid` where
                        consultingtype ='General' AND a.activestatus='Active'
							GROUP BY a.consultationid,a.consultationname";
                                        $result = mysqli_query($connection, $sqli);
                                        while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    <select style='border-radius: 4px; padding: 5px;' id='cmbDoctor' name='cmbDoctor'>
                                        <option value="All" selected>All Doctor</option>
                                        <?php
                                        $sqli = "SELECT userid,username FROM usermaster where designationid='9' and  activestatus='Active'";
                                        $result = mysqli_query($connection, $sqli);
                                        while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <select style='border-radius: 4px; padding: 5px;display:none ' id='cmbPaymentModeReport' name='cmbPaymentModeReport'>
                                        <option value="All" selected>All Payment Mode</option>
                                        <?php
                                        $sqli = "SELECT paymentmodecode,paymentmode FROM paymentmodemaster WHERE activestatus='Active'";
                                        $result = mysqli_query($connection, $sqli);
                                        while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <select hidden style='border-radius: 4px; padding: 5px;' id='cmbBillMode' name='cmbBillMode'>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive" id='DivStockReport'>
                                ...
                                <table>
                                    <tr>
                                        <td>Cash&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td> <input style='border-radius: 4px; padding: 5px;  text-align: right;' size="8" type='text' id='txtCash' name='txtCash' />
                                            &nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td>Card&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td><input style='border-radius: 4px; padding: 5px; text-align: right;' size="8" type='text' id='txtCard' name='txtCard' />
                                            &nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td>Others&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td><input style='border-radius: 4px; padding: 5px; text-align: right;' size="8" type='text' id='txtOthers' name='txtOthers' />
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        </td>
                                        <td><b>Total Sales</b>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td><b><input style='border-radius: 4px; padding: 5px; text-align: right;' size="15" type='text' id='txtTotalSale' name='txtTotalSale' /></b>
                                        </td>
                                        <td> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                        </td>
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td>Search:&nbsp; <select style='border-radius: 4px; padding: 5px;' id='cmbSelectionCriteria' name='cmbSelectionCriteria'>
                                                <option value='4'>Paitent</option>
                                                <option value='5'>Doctor</option>

                                            </select></td>
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;<input style='border-radius: 4px; padding: 5px; text-align: left;' id='txtItemSearch' name='txtItemSearch' onkeyup='myFunction()' placeholder='Search...' /></b></td>
