...
<html lang="en" class="ie8">
  ...
  <body onload="getDate();LoadOpeningBalance(); LoadDayCloseList();">
    <!-- begin #page-loader -->
			   ...
			   <div class="col-md-5">
                   ...
                   <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal">
							 ...
							 <div class="form-group">
                                    ...
                                    <div class="col-md-6">
									<select style='border-radius: 4px; padding: 5px;' id='cmbLocation' name ='cmbLocation' onchange='LoadDayCloseList(); LoadOpeningBalance();'>
                      ...
                      name="dtEntryDate">
									 ...
									 onclick='LoadOpeningBalance(); LoadDayCloseList();'/>
				...
				<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="panel-body"> 
						<input   type='date' id='dtFromDate' name ='dtFromDate' style='height: 2.2em;' />
							<input type='date' id='dtToDate' name ='dtToDate'   style='height: 2.2em;'/>
							
							<input type="button"  class="btn btn-sm btn-success" onClick="LoadDayCloseList();" value='Load'> 	
