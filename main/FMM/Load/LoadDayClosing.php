...
{
	$FromDateQuery = " and  closingdate between '$FromDate' and ";
}
...
$result = mysqli_query($connection, "  
 SELECT DATE_FORMAT(closingdate, '%d-%m-%Y') AS DATE , openingbalance,cashcollection,releasedamount,closingbalance 
 FROM dayclosedetails  where   clientid ='$Location' 
 $FromDateQuery $ToDate 
