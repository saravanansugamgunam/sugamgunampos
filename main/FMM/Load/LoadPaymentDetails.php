...
$result = mysqli_query($connection, "SELECT paymentmodecode, paymentmode,activestatus  FROM   paymentmodemaster order by 3  ");
 //echo "<table id='tblProject' class='tblMasters'>";
  echo " <table class='table table-fixed table-striped' id='indextable' name='tblCategoryMaster'   >";
echo " <thead><tr>  
		<th>S. No</th>  
		<th hidden>Code</th>    
		<th width='50%'><a href=\"javascript:SortTable(2,'T');\">Mode</a></th>     
