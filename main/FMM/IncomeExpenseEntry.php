    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function SaveIncomeExpenses() {
            ...
            if (Ledger == "" || EntryDate == "" || Amount == "" || InvoiceNo == "" || Amount == "0") {
                ...
                var datas = "&Ledger=" + Ledger + "&Group=" + Group + "&EntryDate=" + EntryDate + "&EntryType=" +
                    EntryType + "&Amount=" + Amount + "&Remarks=" + Remarks + "&PaymentMode=" + PaymentMode +
                    "&InvoiceNo=" + InvoiceNo+
                    "&LocationCode=" + LocationCode;
                // alert(datas);
                $.ajax({
                    url: "Save/SaveIncomeExpense.php",
                    method: "POST",
                    data: datas,
        ...
        function LoadIncomeExpenseList() {
            ...
            // alert(datas);
            $.ajax({
                url: "Load/LoadIncomeExpenseList.php",
                method: "POST",
                data: datas,
                success: function(data) {
                    // alert(data);
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Lcation</label>
                    ...
                    ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="selectpicker" data-show-subtext="true" data-live-search="true"
                                            data-style="btn-white" id='cmbLedger' name='cmbLedger'
                                            style="width: 100px;">
