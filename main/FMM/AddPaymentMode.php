    ...
    <div class="modal-content">
      ...
      <div class="modal-body"> 
							...
							<input hidden='text' id='txtCategoryStatus' name='txtCategoryStatus' />
							  ...
							  <table>
							  <tr>
							  <td>Payment Mode</td><td><input type='text' id='txtCategoryUpdatedName' name='txtCategoryUpdatedName' /></td>
							  </tr>
							  <tr>
							  <td><br></td>
							  </tr>
...
function UpdateCategory()
{
		...
		var datas = "&CategoryID=" + encodeURIComponent(CategoryID) +
		 ...
		 $.ajax({
		   url:"Save/UpdatePaymentMode.php",
		   method:"POST",
		   data:datas,
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" placeholder="Payment Mode" id='txtCategory' name='txtCategory' />
                                    </div>
                                </div>
