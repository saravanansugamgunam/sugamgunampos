            ...
            if (DayCloseDate == "") {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        document.getElementById("txtConsultingCash").value = data[1];
                        document.getElementById("txtTherapyCash").value = data[2];
                        document.getElementById("txtOtherCash").value = data[3];
                        document.getElementById("txtGrossCash").value = data[4];
                        document.getElementById("txtExpense").value = data[5];
                        document.getElementById("txtNettCash").value = data[6];
                        // } else {
                ...
                <div class="col-md-5">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Cash Details
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Med+ Con+The</label>
                                    <div class="col-md-3">

                                        <input type="number" class="form-control" placeholder="" id='txtMedicineCash'
                                            name='txtMedicineCash' disabled style='text-align:right;' />

                                    </div>
                                    <div class="col-md-3">

                                        <input type="number" class="form-control" placeholder="" id='txtConsultingCash'
                                            name='txtConsultingCash' disabled style='text-align:right;' />

                                    </div>
                                    <div class="col-md-3">

                                        <input type="number" class="form-control" placeholder="" id='txtTherapyCash'
                                    ...
                                    <div style='float:left;width:50%'>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <input type="number" class="form-control" placeholder=""
                                                    id='txtGrossCash' name='txtGrossCash' disabled
                                                    style='text-align:right;' onkeyup="CalculateClosingBalance()" />
