    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        <script>
            ...
            function SaveDoctorShare() {
                ...
                if (userid == "" || EntryDate == "" || FromDate == "" || ToDate == "" || SharePercent == "" ||
                    ...
                    var datas = "&userid=" + userid + "&EntryDate=" + EntryDate + "&FromDate=" + FromDate +
                        "&ToDate=" + ToDate +
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data == 1) {
                                ...
                                swal("Doctor Share Updated!", "Sucessfully", "success");
                                // swal(data);
            ...
            function LoadDoctorShare() {
                ...
                var datas = "&userid=" + userid + "&FromDate=" + FromDate +
                    "&ToDate=" + ToDate +
                    "&SelectedBill=" + SelectedBill +
                    "&CheckAllStatus=" + CheckAllStatus +
                    "&DoctorTherapist=" + DoctorTherapist +
            ...
            function LoadDoctorSharePaymentDetails() {
                ...
                $.ajax({
                    url: "Load/LoadDoctorSharePaymentDetails.php",
                    method: "POST",
                    data: datas,
                    success: function(data) {
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Bill Details
                            &nbsp;&nbsp;&nbsp;
                            <select id='cmbBillStatus' name='cmbBillStatus' onchange="LoadPendingBills()">
                            ...
                            <button type="button" class="btn btn-success" data-dismiss="modal" onclick='LoadDoctorShare()'>
                                Select Bills</button>
                ...
                <div class="col-md-5">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Doctor Payment Entry</h4>
                        </div>
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="date" class="form-control" placeholder="" id='dtEntryDate' name='dtEntryDate' value='<?php echo date('Y-m-d'); ?>' />
                                    </div>
                    ...
                    locationcode ='$LocationCode'";
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="selectpicker" data-show-subtext="true" data-live-search="true" data-style="btn-white" id='cmbDoctorTheraist' name='cmbDoctorTheraist' style="width: 100px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="selectpicker" data-show-subtext="true" data-live-search="true" data-style="btn-white" id='cmbuserid' name='cmbuserid' style="width: 100px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="date" class="form-control" placeholder="" id='dtFromDate' name='dtFromDate' />
                                    </div>

                                    <div class="col-md-4">
                                        <input type="date" class="form-control" placeholder="" id='dtToDate' name='dtToDate' />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <a href='' data-toggle='modal' data-target='#ModalBillDetails' onclick='LoadPendingBills()'>Select Bills </a>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="" id='txtTotalSales' name='txtTotalSales' disabled />
                                    </div>

                                    <div class="col-md-4">
                                        <input type="hidden" class="form-control" placeholder="" id='txtProfit' name='txtProfit' disabled />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3" style='display:none'>
                                        <select id='cmbCalculationMode' name='cmbCalculationMode' class="form-control" disabled>
                                    ...
                                    <div class="col-md-3">
                                        <input type="number" class="form-control" placeholder="" id='txtSharePercent' name='txtSharePercent' onkeyup="CalculateTotal()" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" class="form-control" placeholder="" id='txtAmountToPay' name='txtAmountToPay' onkeyup="CalculateSharePercent()" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="button" class="btn btn-sm btn-success" onClick="SaveDoctorShare();" value='Save'>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <label class="radio-inline">
                                    ...
                                    <a class="btn btn-success  btn-sm" onclick='LoadDoctorSharePaymentDetails();'>View</a>

                                    <a class="btn btn-success  btn-sm" onclick="printDiv();"><i class="fa  fa-print"></i></a>
                                </label>
