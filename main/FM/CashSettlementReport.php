...
<body>
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        <div id="content" class="content">
            <div class="row">
                ...
                function LoadAdvanceRegister() {
                    ...
                    var datas = "&ToDate=" + ToDate + "&FromDate=" + FromDate + "&Purpose=" + Purpose;
                    // alert(datas);
                    $.ajax({
                        url: "Load/LoadCashSettlementReport.php",
                        method: "POST",
                        data: datas,
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Cash Settlement Report
                            </h4>
       ...
       value="<?php echo date('Y-m-01'); ?>" />
                                ...
                                <label class="radio-inline">
                                    To
                                    <input type="date" class='form-control' name="dtToDateReprt" 
       id='dtToDateReprt' 
       value="<?php echo date('Y-m-t'); ?>" />
                                ...
                                <label class="radio-inline" style='display:none'>
                                   Purpose
                               <select class='form-control' id='cmbPurpose'>
                                <option selected value='%'>All</option>
                                <option value='1'>Medicine - Advance</option>
                                <option value='2'>Consulting - Advance</option>
                                <option value='3'>Therepy - Advance</option>
                               </select>
                                </label>
