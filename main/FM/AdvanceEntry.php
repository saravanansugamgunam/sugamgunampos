...
<body>
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function SaveAdvanceEntry() {
            ...
            var PaitentCode = document.getElementById("cmbPaitentCode").value;
            var EntryDate = document.getElementById("dtAdvanceEntryDate").value;
            ...
            if (PaitentCode == "" || EntryDate == "" || AdvanceAmount == "" || PaymentMode == ""  || Purpose == "") {

                swal("Alert!", " Fill All details", "warning");

            } else {

                var datas = "&PaitentCode=" + PaitentCode + "&EntryDate=" + EntryDate + "&AdvanceAmount=" +
                    AdvanceAmount + "&PaymentMode=" + PaymentMode + "&Purpose=" + Purpose + "&Remarks=" + Remarks +
                    "&LocationCode=" + LocationCode;
                // alert(datas);
                $.ajax({
                    url: "Save/SaveCashAdvance.php",
                    method: "POST",
                    data: datas,
                    success: function(data) {
                        ...
                        if (data == 1) {
                            ...
                            swal("Advance Entry!", "Added Sucessfully", "success");
                            LoadAdvanceHistory();
                            Reset();
                        } else {
        ...
        function Reset() {
            ...
            document.getElementById("cmbPaitentCode").focus();
        }

        function CalculateTotal() {
            var Qty = document.getElementById("txtAdvanceAmount").value;
        ...
        function LoadAdvanceHistory() {
            ...
            // alert(datas);
            $.ajax({
                url: "Load/LoadAdvanceHistory.php",
                method: "POST",
                data: datas,
                success: function(data) {
                    // alert(data);
        ...
        function LoadProductDetails() {
            ...
            var ProductCode = document.getElementById("cmbPaitentCode").value;
        ...
        function GetItemIDtoRemove(x) {
            var SelectedColumn = x.cellIndex;
            var SelectedRow = x.parentNode.rowIndex;

            var Id = document.getElementById("tblTodayPurchase").rows[SelectedRow].cells[3].innerHTML;
            document.getElementById("txtPurchaseID").value = Id;
            DeletePurchase();
        }
        ...
        function DeletePurchase() {
            ...
            var PurchaseID = document.getElementById("txtPurchaseID").value;

            var datas = "&PurchaseID=" + PurchaseID;

            $.ajax({
                url: "Delete/DeleteTodayPurchase.php",
                method: "POST",
                data: datas,
                success: function(data) {
                    swal(data);
                ...
                <div class="col-md-5">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Advance</h4>
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="date" class="form-control" placeholder="" id='dtAdvanceEntryDate'
                                            name='dtAdvanceEntryDate'  value='<?php echo date('Y-m-d');?>'  />
                                    </div>
                    ...
                    ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="selectpicker"  data-style="btn-white" style="width: 100px;" id='cmbPurpose' name='cmbPurpose'>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label"> Paitent</label>
                                    <div class="col-md-6">


                                        <select class="selectpicker" data-show-subtext="true" data-live-search="true"
                                            data-style="btn-white" id='cmbPaitentCode' name='cmbPaitentCode'
                                            onchange="LoadAdvanceHistory(); " style="width: 100px;">
...
echo ' <option value='.$row['paitentid'].'>'.$row['paitentname'].'</option>';
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Paymet Mode</label>
                                    <div class="col-md-6">
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" class="form-control" placeholder="" id='txtAdvanceAmount'
                                            name='txtAdvanceAmount' onkeyup="CalculateTotal()" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <textarea class="form-control" placeholder="" id='txtRemarks'
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="button" class="btn btn-sm btn-success"
                                            onClick="SaveAdvanceEntry();" value='Save'>
                ...
                <div class="col-md-7">
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Other Advances
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="panel-body">
                            <div data-scrollbar="true" data-height="510px">
                                <ul class="chats">
                                    <input type='hidden' id='txtPurchaseID' name='txtPurchaseID' />
