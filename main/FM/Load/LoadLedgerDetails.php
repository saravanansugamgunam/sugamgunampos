...
$result = mysqli_query($connection, "SELECT ledgerid, b.categoryname, 
ledgername,ledgertype ,ledgerstatus FROM accountingledger AS a JOIN accoutingcategory AS b 
...
echo " <thead><tr>  
		<th>S. No</th>  
		<th hidden>Code</th>    
		<th width='50%'><a href=\"javascript:SortTable(2,'T');\">Category</a></th>     
		<th width='50%'><a href=\"javascript:SortTable(2,'T');\">Ledger</a></th>     
		<th width='50%'><a href=\"javascript:SortTable(2,'T');\">Type</a></th>     
...
while($data = mysqli_fetch_row($result))
{
  ...
  <td id='LedgerStatus' width='40%'>$data[3]</td>  
  <td id='LedgerStatus' width='40%'>$data[4]</td>  
