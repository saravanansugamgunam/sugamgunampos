...
$result = mysqli_query($connection, "  
 SELECT a.ledgerid,a.transactiongroup,c.categoryname,b.ledgername,incomeamount,expenseamount, (incomeamount-expenseamount) AS Total   FROM accountingtransaction AS a JOIN accountingledger AS b ON a.ledgerid=b.ledgerid 
 JOIN accoutingcategory AS c ON b.categoryid=c.categoryid  WHERE  DATE_FORMAT(a.date, '%Y-%m-%d') = '$currentdate' ");
