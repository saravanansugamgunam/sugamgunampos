    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            function Payment(x) {
                ...
                // alert(SelectedRow);
                var PaitientName = document.getElementById("tblOutstanding").rows[SelectedRow].cells[2].innerHTML;
                ...
                // trim()
                // alert(SelectedRow);
                var TotalOutstanding = document.getElementById("tblOutstanding").rows[SelectedRow].cells[7].innerHTML;
            ...
            function SavePayment() {
                ...
                var Amount = document.getElementById("txtTotalPayment").value;
                var NewBalance = document.getElementById("txtNewBalance").value;
                var InvoiceNo = document.getElementById("txtInvoiceNo").value;
              
                var SupplierCode = document.getElementById("txtPatientCode").value;
                var PaymentMode = document.getElementById("cmbPaymentMode").value;
                var EntryDate = document.getElementById("dtOutstandingPaymentDate").value;
                ...
                if (EntryDate == "" || SupplierCode == "" || PaymentMode == "" || NewBalance == "" || Payment == "" ||
                    Payment == 0) {
                    swal("Kindly select payment mode");
                } else if (NewBalance < 0) {
                    swal("Balance should not be Less than Zero");
                } else {
                    var datas = "&SupplierCode=" + SupplierCode + "&PaymentMode=" + PaymentMode + "&EntryDate=" +
                    EntryDate + "&OldBalance=" + OldBalance + "&Amount=" + Amount + "&NewBalance=" +
                        NewBalance + "&InvoiceNo=" + InvoiceNo + "&Remarks=" + Remarks + "&Group=" + Group;
                    // alert(datas);
                    $.ajax({
            ...
            <div class="modal-body">
                ...
                <input type='hidden' id='txtMobile' name='txtMobile' disabled />
                ...
                <div>
                    ...
                    <tr>
                            <td>Group</td>
                            <td>
                            <select class="form-control" id='cmbGroup' name='cmbGroup'   style="width: 100px;" >
	   ...
	   <option value='Course'>Course</option> 
                        ...
                        <tr>
                            <td>Payment Date</td>
                            <td><input class="form-control"   type='date' id='dtOutstandingPaymentDate' name='dtOutstandingPaymentDate'
                        ...
                        <tr>
                            ...
                            <td><input class="form-control"  type='text' id='txtPaitentName' name='txtPaitentName'
                                    style="width: 350px; height:30px; padding-top:6px; padding-bottom: 4px; margin-right: 4px; font-size:15px; border-radius: 4px;"
                                    disabled /></td>
                        </tr>
                        <tr>
                            <td><br></td>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control"   type='text' id='txtTotalOutstanding' name='txtTotalOutstanding'
                                    style="width: 150px; height:30px; padding-top:6px; padding-bottom: 4px; margin-right: 4px; font-size:15px; border-radius: 4px;"
                                    disabled /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><select class="form-control"   id='cmbPaymentMode' name='cmbPaymentMode' onchange='focusamount();'
                                    style="width: 200px; height:30px; padding-top:6px; padding-bottom: 4px; margin-right: 4px; font-size:15px; border-radius: 4px;">
                                    <option></option>
                                    <?php  
                        ...
                        <tr>
                            <td>Total Payment&nbsp;&nbsp;</td>
                            <td><input class="form-control"  type='number' id='txtTotalPayment' name='txtTotalPayment'
                                    style="width: 150px; height:30px; padding-top:6px; padding-bottom: 4px; margin-right: 4px; font-size:15px; border-radius: 4px;"
                        ...
                        <tr>
                            <td>Balance&nbsp;&nbsp;</td>
                            <td><input class="form-control"  type='text' id='txtNewBalance' name='txtNewBalance'
                                    style="width: 150px; height:30px; padding-top:6px; padding-bottom: 4px; margin-right: 4px; font-size:15px; border-radius: 4px;"
                                    disabled /></td>
                        </tr>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Supplier - Outstanding Report&nbsp;&nbsp;&nbsp;&nbsp;
