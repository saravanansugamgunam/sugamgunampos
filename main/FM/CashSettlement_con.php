    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function SaveDayClose() {
            ...
            if (DayCloseDate == "" || ClosingBalance == "" || HandoverCash == "") {
                ...
                // alert(datas);
                $.ajax({
                    url: "Save/SaveDayClosing_con.php",
                    method: "POST",
                    data: datas,
        ...
        function PrintDenomination(x, y) {
            var DayCloseDate = document.getElementById("dtEntryDate").value;
            var Location = document.getElementById("cmbLocation").value;

            var datas = "&DayCloseDate=" + DayCloseDate + "&Location=" + Location;

            var Invoice = x; //document.getElementById("txtClosingID").value;
            var Group = y; //document.getElementById("txtClosingID").value;
            ...
            if (Invoice > 0) {
                ...
                if (Group == '1') {
                    ...
                    var str1 = "ReceiptPrint_con.php?invoice=";
                } else if (Group == '3') {
                    var str1 = "ReceiptPrint_the.php?invoice=";
                }
        ...
        function LoadDenominationDetails() {
            ...
            if (DayCloseDate == "") {
                ...
                $.ajax({
                    url: "Load/LoadDenomination_con.php",
                    method: "POST",
                    data: datas,
                    dataType: "json",
                    success: function(data) {
                        ...
                        if (CloseStatus > 1000) {
                            ...
                            document.getElementById("txtHandedOverTo").value = data[24];
                            ...
                            document.getElementById("txtHandedOverTo").value = '';
        ...
        function LoadOpeningBalance() {
            ...
            if (DayCloseDate == "") {
                ...
                $.ajax({
                    url: "Load/LoadCashBalance_con.php",
                    method: "POST",
                    data: datas,
                    dataType: "json",
                    success: function(data) {
        ...
        function SaveCashClosing() {
            ...
            var HandedOverTo = document.getElementById("txtHandedOverTo").value;



            if (DayCloseDate == "" || CashDifference == '' || HandedOverTo == '') {
                ...
                var datas = "&Note2000=" + Note2000 + "&Note500=" + Note500 +
                    ...
                    "&PettyCashDifference=" + PettyCashDifference + "&HandedOverTo=" + HandedOverTo;
                // alert(datas);
                $.ajax({
                    url: "Save/SaveCashClosing_con.php",
                    method: "POST",
                    data: datas,
                    success: function(data) {
                        ...
                        if (data == 1) {
                            ...
                            swal("Alert!", "Cash Closing Completed", "success");
                            // swal(data);
                            // LoadDayCloseList();
                            Reset();
                        } else {
                ...
                <div class="col-md-5">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Cash Details - Consulting
                            ...
                            <form class="form-horizontal">
                                ...
                                <div style='width:100%'>
                                    ...
                                    <div style='float:left;width:50%'>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Con + The</label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"> Handover to</label>
                                            <div class="col-md-8">
                                                <b>
                                                    <input type="text" class="form-control" placeholder=""
                                                        id='txtHandedOverTo' name='txtHandedOverTo' />
                                        ...
                                        <table class=' '>
                                            ...
                                            <tr>
                                                ...
                                                <td style='width:50%'><input type="text" class="form-control"
                                                        ...
                                                        style='text-align:center;width:70%' ;' disabled />
                                                </td>
                                            </tr>
