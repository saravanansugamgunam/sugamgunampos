    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function SaveDayClose() {
            ...
            if (DayCloseDate == "" || ClosingBalance == "" || HandoverCash == "") {
                ...
                // alert(datas);
                $.ajax({
                    url: "Save/SaveDayClosing_the.php",
                    method: "POST",
                    data: datas,
        ...
        function LoadDenominationDetails() {
            ...
            if (DayCloseDate == "") {
                ...
                $.ajax({
                    url: "Load/LoadDenomination_the.php",
                    method: "POST",
                    data: datas,
                    dataType: "json",
                    success: function(data) {
        ...
        function LoadOpeningBalance() {
            ...
            if (DayCloseDate == "") {
                ...
                $.ajax({
                    url: "Load/LoadCashBalance_the.php",
                    method: "POST",
                    data: datas,
                    dataType: "json",
                    success: function(data) {
        ...
        function SaveCashClosing() {
            ...
            if (DayCloseDate == "" || CashDifference == '' || HandedOverTo == '') {
                ...
                // alert(datas);
                $.ajax({
                    url: "Save/SaveCashClosing_the.php",
                    method: "POST",
                    data: datas,
                    success: function(data) {
                ...
                <div class="col-md-5">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Cash Details - Therapy
