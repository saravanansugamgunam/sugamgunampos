     ...
     <body>
         ...
         <?php
            ...
            openingcash,closingcash,pettycashdifference,handedoverto,locationname
            FROM denomination AS a 
            JOIN usermaster AS b ON a.enteredby=b.userid 
            ...
            while ($data = mysqli_fetch_row($res)) {
                ...
                $HandedOverto = $data[24];
                $LocationName = $data[25];
            }
         ...
         <div class="ticket">
             <p class="centered"><u><b>
                         ...
                         <label style='font-size:15px'>Cash Settlement - Consulting
                         <br>
                         <label><?php echo $LocationName; ?></label>
             ...
             <center>
                 ...
                 <table>
                     ...
                     <tbody>
                         ...
                         <tr>
                             <td style=" " class='sno' colspan=1><b>Difference</b>
                             </td>
                             <td style=" " class='price' colspan=2><b>
                                     <?php if($cashdifference * 1 <0)
                             {
                                echo  "Excess";
                             }
                             else if($cashdifference * 1 >0)
                             {
                                echo  "Short";
                             } 
                 ...
                 <label style='float:left;'>
                     ...
                     <br>
                     <label style='float:left;'>Handed Over To:&nbsp;<?php echo $HandedOverto; ?></label>
                     <br>
                     <br>
                     <br>
             </center>
