...
<html lang="en" class="ie8">
  ...
  <body onload="Reset();">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
	  ...
	  var datas = "&SupplierCode="+SupplierCode+"&Group="+Group+"&EntryDate="+EntryDate+"&EntryType="+EntryType+"&Amount="+Amount+"&Remarks="+Remarks+"&PaymentMode="+PaymentMode+"&InvoiceNo="+InvoiceNo;		  	
	  	        // alert(datas);
		 $.ajax({
...
document.getElementById("txtInvoiceNo").value=InvoiceNo;
	  ...
	  function LoadIncomeExpenseList()
	  {
		  ...
		  var SupplierCode = document.getElementById("cmbSupplierCodeReport").value;   
		   ...
		   var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&SupplierCode="+SupplierCode;		  	
							 ...
							 <input type='hidden' id='txtInvoiceNo' name ='txtInvoiceNo' />
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-6">
									   ...
									   <select class="selectpicker" data-show-subtext="true" data-live-search="true" data-style="btn-white" id='cmbGroup' name='cmbGroup'   style="width: 100px;" >
	   ...
	   <option value='Course'>Course</option> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
									   ...
									   data-style="btn-white" id='cmbSupplier' name='cmbSupplier'   style="width: 100px;" onchange="LoadOutstanding();">
				...
				<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
						...
						<option value='%'>All</option>
                            ...
                            ?>
										  ...
										  onclick='LoadIncomeExpenseList();'>View</a>
                                        </label> 
