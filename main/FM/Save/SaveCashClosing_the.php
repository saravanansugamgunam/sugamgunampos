...
if (isset($_POST["DayCloseDate"])) {
   ...
   $HandedOverTo = mysqli_real_escape_string($connection, $_POST["HandedOverTo"]);
   ...
   try {
      ...
      openingcash,closingcash,pettycashdifference,closinggroup,handedoverto) values 
      ...
      '$OthCash','$CashDifference','$PettycashOpening','$PettycashClosing','$PettyCashDifference',3,
      '$HandedOverTo');";
