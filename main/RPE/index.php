...
(SELECT ROUND(SUM(totalamount),0)  FROM purchaseitems WHERE  invoicedate BETWEEN DATE_FORMAT(NOW() ,'%Y-%m-01') AND LAST_DAY(NOW())) AS Purchase;");
        ...
        function LoadCashCardSTransaction() {
            ...
            var ToDate = document.getElementById("dtFromDate").value;
        ...
        <div id="content" class="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="" placeholder="Date" id="dtFromDate"
                    ...
                    <input type="button" class="btn btn-sm btn-info" onclick="LoadCardData();" value='View'>
