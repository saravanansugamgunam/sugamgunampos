 ...
 <div id="content" class="content">
  ...
  function LoadSalesReport()
    ...
    var DiscountStatus = document.getElementById("cmbDiscountStatus").value;   
		...
		var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&Type="+Type+"&SelectedReportType="+SelectedReportType+"&BillMode="+BillMode+"&DiscountStatus="+DiscountStatus; 
   // alert(datas);
		 $.ajax({
    ...
    var DiscountStatus = document.getElementById("cmbDiscountStatus").value;     
		...
		else
		{
			...
			var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&Type="+Type+"&BillMode="+BillMode+"&Location="+Location+"&DiscountStatus="+DiscountStatus; 
	  	  // alert(datas);
	  	  // alert(datas);
		 $.ajax({
...
$('#txtItemSearch').keyup(function() {
  ...
  <div class="col-md-12">
    ...
    $('#dtToDate').datepicker({
	 ...
	 <select class='selectpicker' style='border-radius: 4px; padding: 5px;' id='cmbSummarise' name='cmbSummarise' multiple data-size='10' data-live-search='true'   data-style="btn-white" >  
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
						 ...
						 <td><b>Total Sales</b>&nbsp;&nbsp;&nbsp;&nbsp;</td>
							...
							<td>&nbsp;&nbsp;&nbsp;&nbsp;
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input style='border-radius: 4px; padding: 5px; text-align: left;'  id='txtItemSearch'  name ='txtItemSearch' onkeyup='myFunction()' placeholder= 'Search...'  /></b></td>
