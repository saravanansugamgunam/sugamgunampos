    ...
    width: 150px; 
      ...
      <div class="modal-body"> 
							...
							<input hidden='text' id='txtDoctorStatus' name='txtDoctorStatus' />
							  ...
							  <tr>
							  <td>Email ID</td>
							  <td ><input type='text' id='txtDoctorUpdatedEmail' name='txtDoctorUpdatedEmail' /></td>
							  </tr>
							  <td><br></td>
								<tr>							  
							  <td>Biometricid</td><td><input type='text' id='txtBiometricIDUpdated' name='txtBiometricIDUpdated' /></td>
...
function UpdateDoctor()
{
		...
		var Biometricid = document.getElementById("txtBiometricIDUpdated").value;
		...
		var datas = "&DoctorID=" + encodeURIComponent(DoctorID) +
				...
				"&Biometricid=" + encodeURIComponent(Biometricid)+
...
var datas = "&Dumy="+Dumy;	
	  ...
	  function GetRowID(x)
	  {
		...
		document.getElementById("txtBiometricIDUpdated").value = document.getElementById("indextable").rows[row].cells.namedItem("DoctorBiometric").innerHTML;
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal">
								...
								<div class="form-group"> 
                                    ...
                                    <label class="col-md-1 control-label">Biometric ID </label>
                                    <div class="col-md-2">
                                        <input type="text" class="form-control"  id='txtBiometricID' name='txtBiometricID' />
                                    </div>
