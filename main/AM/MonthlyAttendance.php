...
function LoadAttendanceRegister()
	...
	//  alert(datas);
		 $.ajax({
		   url:"Load/LoadAttendanceCalendar.php",
		   method:"POST",
		   data:datas,
		   success:function(data)
		   {	
      ...
      format: "dd/mm/yyyy"
        ...
        $('.datepicker').hide();
						 ...
						 <div class="panel-heading">
						    <h5 class="panel-title">Monthly Attendance
                        ...
                        <div class="panel-body">
							  ...
							  <div class="form-group">
                                    ...
                                    <select  style='border-radius: 4px; padding: 5px;' id='cmbMonth' name ='cmbMonth'>
                                    <option value="0">Select Month</option>
                                        ...
                                        <option value="2023-09-01">Sep-23</option>
                                         <option value="2023-10-01">Oct-23</option>
                                          <option value="2023-11-01">Nov-23</option>
                                           <option value="2023-12-01" >Dec-23</option>
                                            <option value="2024-01-01">Jan-24</option>
                                             <option value="2024-02-01">Feb-24</option>
                                              <option value="2024-03-01"  >Mar-24</option> 
                                              <option value="2024-04-01" >Apr-24</option> 
                                              <option value="2024-05-01" >May-24</option> 
                                              <option value="2024-06-01" >Jun-24</option> 
                                              <option value="2024-07-01" selected >Jul-24</option> 
                      ...
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <select   style='border-radius: 4px; padding: 5px;' id='cmbStaffName' name ='cmbStaffName'>
                   
                                            <?php  
                            $sqli = "  SELECT biometricid,username FROM  `usermaster` WHERE activestatus ='Active'  and 
                    userid not in('33','42','43','44','45','50')";
                            $result = mysqli_query($connection, $sqli); 
                             while ($row = mysqli_fetch_array($result)) {
                            	# code...
                          
                             echo ' <option value='.$row['biometricid'].'>'.$row['username'].'</option>';
                              }	
                            ?>
                      ...
                      &nbsp;&nbsp;&nbsp;
												...
												<select hidden style='border-radius: 4px; padding: 5px;' id='cmbReportType' name ='cmbReportType'>
						 ...
						 <?php
                            $sqli = "SELECT userid, username FROM usermaster  WHERE category = 'Staff' AND activestatus ='Active'  and 
                    userid not in('33','42','43','44','45','50')";
                            $result = mysqli_query($connection, $sqli); 
                             while ($row = mysqli_fetch_array($result)) {
