...
salarytype,b.username,a.`amount`,c.`paymentmode`,a.id  FROM salarypaymentdetails AS a JOIN usermaster AS b ON a.`employeecode`=b.`userid`
...
{
    echo "<td><a href='SalarySlip.php?SID=$data[6]' target='_blank' ?>
