    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        <div id="content" class="content">
            <div class="row">
                ...
                function LoadRoutineRegister() {


                    var Staff = document.getElementById("cmbStaffName").value;

                    var Month = document.getElementById("cmbMonth").value;

                    var datas = "&Staff=" + Staff + "&Month=" + Month;

                    $.ajax({
                        url: "Load/LoadRoutineRegister.php",
                        method: "POST",
                        data: datas,
                        success: function(data) {
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-heading">
                            <h5 class="panel-title">Routine List
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <select style='border-radius: 4px; padding: 5px;display:none' id='cmbMonth'
                                        name='cmbMonth'>
                                        <option value="0">Se;ect Month</option>
                                        <option value="2021-07-01">Jul-21</option>
                                        <option value="2021-08-01">Aug-21</option>
                                        <option value="2021-09-01">Sep-21</option> -
                                        <option value="2021-10-01">Ocr-21</option>
                                        <option value="2021-11-01">Nov-21</option>
                                        <option value="2021-12-01">Dec-21</option>
                                        <option value="2022-01-01">Jan-22</option>
                                        <option value="2022-02-01">Feb-22</option>
                                        <option value="2022-03-01">Mar-22</option>
                                        <option value="2022-04-01">Apr-22</option>
                                        <option value="2022-05-01">May-22</option>
                                        <option value="2022-06-01">Jun-22</option>
                                        <option value="2022-07-01">Jul-22</option>
                                        <option value="2022-08-01">Aug-22</option>
                                        <option value="2022-09-01">Sep-22</option>
                                        <option value="2022-10-01">Oct-22</option>
                                        <option value="2022-11-01">Nov-22</option>
                                        <option value="2022-12-01">Dec-22</option>
                                        <option value="2023-01-01" selected>Jan-23</option>
                                        <option value="2023-02-01">Feb-23</option>
                                        <option value="2023-03-01">Mar-23</option>
                                        <option value="2023-04-01">Apr-23</option>
                                        <option value="2023-05-01">May-23</option>
                                        <option value="2023-06-01">Jun-23</option>
                                        <option value="2023-07-01">Jul-23</option>
                                        <option value="2023-08-01">Aug-23</option>
                                        <option value="2023-09-01">Sep-23</option>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <select style='border-radius: 4px; padding: 5px;' id='cmbStaffName'
                                        name='cmbStaffName'>

                                        <?php
                    $sqli = "  SELECT userid,username FROM  `usermaster` WHERE activestatus ='Active' and 
                    userid not in('13','30','33','42','43','44','45','50')";
                    ...
                    ?>
                                    ...
                                    <input type="hidden" class="" placeholder="From" id="dtFromDate"
                                        style='border-radius: 4px; padding: 5px;'>

                                    <input type="hidden" class="" placeholder="To" id="dtToDate"
                                        style='border-radius: 4px; padding: 5px;'>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <select hidden style='border-radius: 4px; padding: 5px;' id='cmbReportType'
                                        name='cmbReportType'>
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <select hidden style='border-radius: 4px; padding: 5px;' id='cmbUserID'
                                        name='cmbUserID'>
                    ...
                    ?>
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <input type="button" class="btn btn-sm btn-info" onclick="LoadRoutineRegister();"
                                        value='View'>
                                </div>
