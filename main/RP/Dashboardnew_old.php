...
function getSummaryData($connection, $start_date, $end_date) {
    ...
    $query = "SELECT COUNT(DISTINCT consultationuniquebill) as total_consulting 
              FROM consultingbillmaster 
              WHERE billdate BETWEEN '$start_date' AND '$end_date 23:59:59'";
    $result = $connection->query($query);
    $data['total_consulting'] = $result->fetch_assoc()['total_consulting'];


     // Total patients consulted
     $query = "SELECT COUNT(DISTINCT paitentid) as total_patients 
     FROM consultingbillmaster 
     WHERE billdate BETWEEN '$start_date' AND '$end_date 23:59:59'";
$result = $connection->query($query);
$data['total_patients'] = $result->fetch_assoc()['total_patients'];
    
    // New patients
    $query = "SELECT COUNT(*) as new_patients 
              FROM paitentmaster 
              WHERE  createdin BETWEEN '$start_date' AND '$end_date 23:59:59' and 
              paitentid in(select paitentid from consultingbillmaster)";
    $result = $connection->query($query);
    $data['new_patients'] = $result->fetch_assoc()['new_patients'];
    ...
    $data['planned_tasks'] = $tasks['planned_tasks'];
    $data['completed_tasks'] = $tasks['completed_tasks'];
    

        // New Total Expenses
        $query = "SELECT round(SUM(amount),0) as total FROM salepaymentdetails WHERE
 ...
 'Supplier Payment','Doctor Share','Therapy Share','Advance','Bonus','Consulting Share','Incentive','Salary')
    AND transactionstatus ='Live'   and 
     date
        BETWEEN '$start_date' AND '$end_date 23:59:59'";
$result = $connection->query($query);
$data['totalexpenses'] = $result->fetch_assoc()['total'];
$data['formated_totalexpenses'] = indianNumberFormat($data['totalexpenses']);


    // Mdeicine Sales 
    $query = "SELECT COUNT(*) as MedicineBillsCounter FROM salemaster 
WHERE saletype IN('Counter','Free') 
AND transactiontype ='Sale' AND cancellstatus ='0'  and 
  saledate  BETWEEN '$start_date' AND '$end_date 23:59:59'";
$result = $connection->query($query);
$data['MedicineBillsCounter'] = $result->fetch_assoc()['MedicineBillsCounter']; 


   
    $query = "SELECT COUNT(*) as MedicineBillsCourier FROM salemaster 
WHERE saletype IN('Online','Courier') 
AND transactiontype ='Sale' AND cancellstatus ='0'  and 
  saledate  BETWEEN '$start_date' AND '$end_date 23:59:59'";
$result = $connection->query($query);
$data['MedicineBillsCourier'] = $result->fetch_assoc()['MedicineBillsCourier']; 


$query = "  SELECT COUNT(*) AS TherapyCompleted FROM therapybookingdetails AS a JOIN 
 therapybookingmaster AS b ON a.bookinguniqueid=b.bookinguniqueid
WHERE bookingstatus IN('Closed','R-Closed')   and 
  reviseddate  BETWEEN '$start_date' AND '$end_date 23:59:59'";
$result = $connection->query($query);
$data['TherapyCompleted'] = $result->fetch_assoc()['TherapyCompleted']; 

$query = "  SELECT COUNT(*) AS TherapyPending FROM therapybookingdetails AS a JOIN 
 therapybookingmaster AS b ON a.bookinguniqueid=b.bookinguniqueid
WHERE bookingstatus IN('Booked')   and 
  reviseddate  BETWEEN '$start_date' AND '$end_date 23:59:59'";
$result = $connection->query($query);
$data['TherapyPending'] = $result->fetch_assoc()['TherapyPending']; 



$query = "  SELECT COUNT(*) as PathologySampleCollected FROM `diagnosissalemaster`      
WHERE resultstatus IN('Not Delivered')   and  completedstatus <>'Cancelled' and 
  saledate  BETWEEN '$start_date' AND '$end_date 23:59:59'";
$result = $connection->query($query);
$data['PathologySampleCollected'] = $result->fetch_assoc()['PathologySampleCollected']; 



$query = "  SELECT COUNT(*) as PathologyReportDelivered FROM `diagnosissalemaster`      
WHERE resultstatus IN('Delivered')   and  completedstatus <>'Cancelled' and 
  saledate  BETWEEN '$start_date' AND '$end_date 23:59:59'";
$result = $connection->query($query);
$data['PathologyReportDelivered'] = $result->fetch_assoc()['PathologyReportDelivered']; 
    ...
    $query = "SELECT round(SUM(amount),0) as total FROM salepaymentdetails WHERE
     transactiontype IN('DoctorFee')
 AND transactionstatus ='Live'   and 
  date
     BETWEEN '$start_date' AND '$end_date 23:59:59'";
    $result = $connection->query($query);
    $data['revenue']['consultation'] = $result->fetch_assoc()['total'] ?? 0;
    $data['formated_consultationerevenue'] = indianNumberFormat( $data['revenue']['consultation']);

    
    // Medicine revenue
    $query = "SELECT round(SUM(amount),0) as total FROM salepaymentdetails WHERE
     transactiontype IN('CashAdvance','PaitentOrder',
 'OutstandingCollection','Sales','Advance - PaitentOrder')
 AND transactionstatus ='Live'   and 
  date
     BETWEEN '$start_date' AND '$end_date 23:59:59'";
    $result = $connection->query($query);
    $data['revenue']['medicine'] = $result->fetch_assoc()['total'] ?? 0;
    $data['formated_medicinerevenue'] = indianNumberFormat( $data['revenue']['medicine']);
    

    // Therapy revenue
    $query = "SELECT round(SUM(amount),0) as total FROM salepaymentdetails WHERE
     transactiontype IN('Therapy Payment')
 AND transactionstatus ='Live'   and 
  date
     BETWEEN '$start_date' AND '$end_date 23:59:59'";
    $result = $connection->query($query);
    $data['revenue']['therapy'] = $result->fetch_assoc()['total'] ?? 0;
    $data['formated_therapyrevenue'] = indianNumberFormat( $data['revenue']['therapy']);
    

    
    // Lab revenue
    $query = "SELECT round(SUM(amount),0) as total FROM salepaymentdetails WHERE
    transactiontype IN('Diagnosis')
AND transactionstatus ='Live'   and 
 date
    BETWEEN '$start_date' AND '$end_date 23:59:59'";
    $result = $connection->query($query);
    $data['revenue']['lab'] = $result->fetch_assoc()['total'] ?? 0;
    $data['formated_labrevenue'] = indianNumberFormat( $data['revenue']['lab']);
    
    // Total revenue
    $data['total_revenue'] = array_sum($data['revenue']);
    $data['formated_totalrevenue'] = indianNumberFormat($data['total_revenue']);
    
    // Total expenses
    $query = "SELECT round(SUM(expenseamount),0) as total FROM accountingtransaction WHERE date BETWEEN '$start_date' AND '$end_date 23:59:59'";
    $result = $connection->query($query);
    $data['total_expenses'] = $result->fetch_assoc()['total'] ?? 0;
             ...
             <div class="card">
                 ...
                 <div class="card-body">
                     ...
                     <div class="summary-card">
                         <div class="summary-row">
                             ...
                             <div class="value">
                                 <h3><?= $summaryData['formated_totalrevenue'] ?></h3>
                             </div>
                         </div>
                         <div class="summary-row">
                             <div class="label">Consulting</div>
                             <div class="value">
                             <?= $summaryData['formated_consultationerevenue'] ?>
                         </div>
                         </div>
                     ...
                     <div class="summary-row">
                         ...
                         <div class="value">
                             <?= $summaryData['formated_medicinerevenue'] ?> </div>
                     </div>
                     <div class="summary-row">
                         <div class="label">Therapy</div>
                         <div class="value">
                             <?= $summaryData['formated_therapyrevenue'] ?> </div>
                     </div>

                     <div class="summary-row">
                         <div class="label">Pathology</div>
                         <div class="value">
                             <?= $summaryData['formated_labrevenue'] ?> </div>
                     </div>
                 ...
                 <div class="summary-card">
                     ...
                     <div class="summary-row">
                         <div class="label">
                             Other Expenses</div>
                         <div class="value"><?= $summaryData['formated_totalexpenses'] ?></div>
                     </div>
                     <div class="summary-row">
             ...
             <div class="card-body">
                 ...
                 <div class="summary-card">
                     <div class="summary-row">
                         ...
                         <div class="value"><?= $summaryData['formated_consultationerevenue'] ?></div>
                     </div>
                     <div class="summary-row">
                         <div class="label">
                             Avg. Per Patient</div>
             ...
             <div class="card-body">
                 ...
                 <div class="summary-card">
                     <div class="summary-row">
                         ...
                         <div class="value"><?= $summaryData['formated_medicinerevenue'] ?></div>
                     </div>
                     <div class="summary-row">
                         <div class="label">
                             Avg. Per Bill</div>
             ...
             <div class="card-body">
                 ...
                 <div class="summary-card">
                     <div class="summary-row">
                         ...
                         <div class="value"><?= $summaryData['formated_therapyrevenue'] ?></div>
                     </div>
                     <div class="summary-row">
                         <div class="label">
                             Avg. Per Patient</div>
         ...
         <div class="card">
             ...
             <div class="card-body">
                 ...
                 <div class="summary-card">
                     <div class="summary-row">
                         <div class="label">Therapy Revenue</div>
                         <div class="value"><?= $summaryData['formated_labrevenue'] ?></div>
                     </div>
                     <div class="summary-row">
                         <div class="label">
                             Avg. Per Patient</div>
