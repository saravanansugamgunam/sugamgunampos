  ...
  <body  onload="LoadCardData();">
    ...
    $('#dtToDate').datepicker({
	     ...
	     function LoadCardData()
	  {
	   ...
	   <iframe width="1160" height="700" src="https://app.powerbi.com/view?r=eyJrIjoiMzE2MGYxYWEtNjZmMS00NzljLWE1YTgtODE2MDc2OTEwZWI0IiwidCI6Ijk3NGI1MmRkLTZkYTQtNDMxNi1hMjM3LThkMTU0MDc4NmQyYyJ9&pageName=ReportSection" frameborder="0" allowFullScreen="true"></iframe>
