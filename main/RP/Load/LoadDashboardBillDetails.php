...
ROUND(nettamount+discountamount,0),ROUND(discountamount,0),
ROUND((discountamount/(nettamount+discountamount))*100,0) AS DiscPercent,
c.`username` FROM salemaster AS a JOIN paitentmaster AS b ON 
