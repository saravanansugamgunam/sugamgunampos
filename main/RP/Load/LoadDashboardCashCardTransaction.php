...
WHERE  a.`date` BETWEEN '$ActualFromDate' AND '$ActualToDate' 
 and a.clientid like ('$Location')  and transactiongroup ='Inventory' 
 and a.transactiontype in ('CashAdvance','IncomeEntry','OutstandingCollection','PaitentOrder' )  
...
WHERE  a.`date` BETWEEN '$ActualFromDate' AND '$ActualToDate' 
 and a.clientid like ('$Location')  and transactiongroup ='Inventory' 
 and a.transactiontype in ( 'Sales') and 
 completionstatus ='1'
 GROUP BY  b.`paymentmode`,b.`paymentmodecode`
...
and transactiongroup ='Inventory' and a.transactiontype in ('RefundToCustomer','ExpenseEntry','Doctor Share')  
 GROUP BY  b.`paymentmode`,b.`paymentmodecode` 
...
ON a.`paymentmode`=b.`paymentmodecode`
WHERE  a.`date` BETWEEN '$ActualFromDate' AND '$ActualToDate'  and a.clientid like ('$Location')  
and transactiongroup ='Inventory' and a.transactiontype in ('Supplier Payment')  
 GROUP BY  b.`paymentmode`,b.`paymentmodecode` 
 union
...
ON a.`paymentmode`=b.`paymentmodecode`
WHERE  a.`date` BETWEEN '$ActualFromDate' AND '$ActualToDate'  and a.clientid like ('$Location')   
 AND transactionstatus ='Live'  and transactiongroup ='Clinic' 
  and a.transactiontype in ('Therapy PaymentAdvance','Therapy Payment', 'DoctorFee','Diagnosis') and 
  completionstatus ='1'
 GROUP BY  b.`paymentmode`,b.`paymentmodecode`
...
WHERE  a.`date` BETWEEN '$ActualFromDate' AND '$ActualToDate'  and a.clientid like ('$Location')   
 AND transactionstatus ='Live'  and transactiongroup ='Clinic' 
  and a.transactiontype in ( 'IncomeEntry' ) 
 GROUP BY  b.`paymentmode`,b.`paymentmodecode`
...
ON a.`paymentmode`=b.`paymentmodecode`
WHERE  a.`date` BETWEEN '$ActualFromDate' AND '$ActualToDate'  and a.clientid like ('$Location')   
 AND transactionstatus ='Live'  and transactiongroup ='Clinic' and 
 a.transactiontype in ('ExpenseEntry','Salary','Supplier Payment','Therapy Share')  
 GROUP BY  b.`paymentmode`,b.`paymentmodecode`
 )AS a GROUP BY PaymentMode,paymentmodecode
