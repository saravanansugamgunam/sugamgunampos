                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Enquiries
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <button class='btn btn-warning btn-xs  m-r-5' href='#ModalAddEnquiry'>
                                    <a href='CalanderViewReport.php?MID=61'>
                                        <i class='fa fa-list'></i>&nbsp;&nbspReport View</a>
                                </button>



                                <button class='btn btn-info btn-xs  m-r-5' href='#ModalAddEnquiry' data-toggle='modal'
                                    style='float:right;'>
