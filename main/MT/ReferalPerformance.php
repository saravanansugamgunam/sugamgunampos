        ...
        <div id="content" class="content">
            <div class="row">
                ...
                function LoadSalesReport() {
                    ...
                    var ReportType = document.getElementById("cmbSummarise");
                    var Arr_cmbReportType = [];
                    for (var i = 0; i < ReportType.options.length; i++) {

                        if (ReportType.options[i].selected == true) {

                            // alert("'" + x.options[i].value + "'" );
                            Arr_cmbReportType.push(ReportType.options[i].value);

                        }
                    }
                    var SelectedReportType = "'" + Arr_cmbReportType.join("','") + "'"
                    ...
                    var datas = "&FromDate=" + FromDate + "&ToDate=" + ToDate + "&Type=" + Type +
                        "&SelectedReportType=" + SelectedReportType + "&BillMode=" + BillMode + "&DiscountStatus=" +
                        DiscountStatus;
                    // alert(datas);
                    $.ajax({
                ...
                function LoadSalesReportTotal() {
                    ...
                    var datas = "&FromDate=" + FromDate + "&ToDate=" + ToDate + "&Type=" + Type + "&BillMode=" +
                        BillMode + "&Location=" + Location + "&DiscountStatus=" + DiscountStatus;
                    // alert(datas);
                    // alert(datas);
                    $.ajax({
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-heading">
                            <h5 class="panel-title">Sales Report - Based on Reference
                      ...
                      echo ' <option value='.$row['locationcode'].'>'.$row['locationname'].'</option>';
                            ...
                            ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select class='selectpicker' style='border-radius: 4px; padding: 5px;'
                                        id='cmbSummarise' name='cmbSummarise' multiple data-size='10'
                            ...
                            <div class="table-responsive" id='DivStockReport'>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input style='border-radius: 4px; padding: 5px; text-align: left;'
