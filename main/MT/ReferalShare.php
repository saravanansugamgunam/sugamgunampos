...
<body onload="LoadInvoiceNo();">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data == 1) {
                            ...
                            swal("Referal Share Updated!", "Sucessfully", "success");
                            // swal(data);
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data[2] == '0') {
                        ...
                        document.getElementById("txtSharePercent").value = data[3];
                        document.getElementById("txtAmountToPay").value = data[4];
                    } else {
                        swal('Already Paid');
                        ...
                        document.getElementById("txtSharePercent").value = '';
                    }
        ...
        function LoadDoctorSharePaymentDetails() {
            ...
            $.ajax({
                url: "Load/LoadReferenceSharePaymentDetails.php",
                method: "POST",
                data: datas,
                success: function(data) {
                ...
                <div class="col-md-5">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Referal Payment Entry</h4>
                        </div>
                    ...
                    locationcode ='$LocationCode'";
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="selectpicker" data-show-subtext="true" data-live-search="true"
                                            data-style="btn-white" id='cmbuserid' name='cmbuserid'
                                            style="width: 100px;">

                                            <?php
                                            $sqli = "SELECT referenceid,reference FROM referencemaster 
                                            where referencestatus='Active' order by 2 ";
                                            $result = mysqli_query($connection, $sqli);
                                            while ($row = mysqli_fetch_array($result)) {
                                                # code...
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <option selected value='Therapy'>Therapy</option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="button" class="btn btn-sm btn-success" onClick="SaveDoctorShare();"
                                            value='Save'>
                            ...
                            <div class="form-group">
                                ...
                                <label class="radio-inline">
                                    ...
                                    <a class="btn btn-success  btn-sm"
                                        onclick='LoadDoctorSharePaymentDetails();'>View</a>
