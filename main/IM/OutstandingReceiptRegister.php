...
.modal-open[style] {
 ...
 <div id="content" class="content">
  ...
  function LoadSalesReport()
	 ...
	 // alert(datas);
		 $.ajax({
		   url:"Load/LoadOutstandingReceiptReport.php",
		   method:"POST",
		   data:datas,
	...
	var FromDate = document.getElementById("dtFromDate").value;   
		...
		var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&Type="+Type+"&Location="+Location;  
	  	      // alert(datas);
		 $.ajax({
		   url:"Load/LoadOutstandingReceiptReportTotal.php",
		   method:"POST",
		   data:datas,	
		   dataType:"json",
		   success:function(data)
      ...
      format: "dd/mm/yyyy"
        ...
        $('.datepicker').hide();
						 ...
						 <div class="panel-heading">
						    <h5 class="panel-title">Outstanding Receipt Report
			   ...
			   <div class="col-md-12" >
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
							...
							<td> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;</td>
							  <td><input style='border-radius: 4px; padding: 5px; text-align: left;'  id='txtSearch'  name ='txtSearch'  placeholder= 'Search...'  /></b></td>
