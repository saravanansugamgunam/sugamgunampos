    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type='password' id='txtAdminPasswordReturn' name='txtAdminPasswordReturn' />
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type='hidden' id='txtBillLocationCode' name='txtBillLocationCode' />

                <h2 style="color: red;">Are you sure want to canell the bill? </h2>
                <br>

                <label>Cancel Type:</label>&nbsp;&nbsp;&nbsp;
                <select class='form-control' id='cmbCancelType' name='cmbCancelType'>
                    <option value='Refund' selected>
                        Refund to Customer
                    </option>
                    <option value='Wrong Entry'>
                        Wrong Entry Full Cancellation
                    </option>
                    <option>
                ...
                <textarea class="form-control" id='txtCancelledRemarks' name='txtCancelledRemarks'
                    placeholder='Cancellation Remarks'></textarea>
                <br>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <select class="form-control" id='cmbCourier' name='cmbCourier'>
                    ...
                    <?php  
                            $sqli = "SELECT  courier from couriermaster WHERE courierstatus='Active'";
        ...
        <div id="content" class="content">
            <div class="row">
                ...
                function LoadSalesReport() {
                    ...
                    var DiscountStatus = document.getElementById("cmbDiscountStatus").value;
                    var DeliveryStatus = document.getElementById("cmbDeliveryStatus").value;
                    ...
                    var datas = "&FromDate=" + FromDate + "&ToDate=" + ToDate + "&Type=" + Type + "&BillMode=" +
                        BillMode + "&Location=" + Location + "&DiscountStatus=" + DiscountStatus  + "&DeliveryStatus=" + DeliveryStatus;
                    // alert(datas);
                    $.ajax({
                ...
                function ReturnItems() {
                    ...
                    var PercentageConsidered = document.getElementById("txtPercentageDeducted").value;
                    var ItemID = document.getElementById("txtItemId").value;
                    var Password = document.getElementById("txtAdminPasswordReturn").value;
                    var ReturnValue = document.getElementById("txtTotalReturn").value;
                    ...
                    if (Password != '12345') {
                        ...
                        var datas = "&InvoiceNo=" + InvoiceNo + "&ReturnInvoice=" + ReturnInvoice + "&ItemID=" +
                            ItemID +
                            "&PercentageConsidered=" + PercentageConsidered + 
                ...
                function CancellBill() {
                    ...
                    var CancellType = document.getElementById("cmbCancelType").value;
                    var BillLocationCode = document.getElementById("txtBillLocationCode").value;
                    ...
                    if (Password != '12345') {
                        ...
                        var datas = "&Invoice=" + Invoice +
                            ...
                            "&BillLocationCode=" + BillLocationCode +
                            "&CancellType=" + CancellType;
                        // alert(datas);
                        $.ajax({
                            ...
                            success: function(data) {
                                // alert(data);
                                if (data == 1) {
                                    swal("Alert!", "Bill Cancelled Sucessfully", "success");
                                } else {
                                    swal("Alert!", data, "warning");
                                }
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-heading">
                            <h5 class="panel-title">Sales Report
          ...
          ?>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-danger"
                                                    onclick="ModifyPaymentMode();" data-dismiss="modal">Save</button>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td>Search:&nbsp; <select style='border-radius: 4px; padding: 5px;'
                                                ...
                                                <option value='5'>Short Code</option>
