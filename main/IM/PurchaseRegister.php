        ...
        <div id="content" class="content">
            <div class="row">
                ...
                function LoadSalesReport() {
                    ...
                    // alert(datas);
                    $.ajax({
                        url: "Load/LoadPurchaseReport.php",
                        method: "POST",
                        data: datas,
                ...
                function LoadSalesReportTotal() {
                    ...
                    // alert(datas);
                    $.ajax({
                        url: "Load/LoadPurchaseReportTotal.php",
                        method: "POST",
                        data: datas,
                        dataType: "json",
                        success: function(data) {
                ...
                function ModifyRate(a, b, c, d) {
                    var GRN = a;
                    var ProductCode = b;
                    var Rate = c;
                    var MRP = d;

                    document.getElementById("txtModifiedRate").value = Rate;
                    document.getElementById("txtModifiedMRP").value = MRP;

                    document.getElementById("txtOldRate").value = Rate;
                    document.getElementById("txtOldMRP").value = MRP;

                    document.getElementById("txtModifyGRN").value = GRN;
                    document.getElementById("txtModifyProductCode").value = ProductCode;
                    document.getElementById("txtModifiedProfit").value = MRP * 1 - Rate * 1;

                }

                function UpdateRate() {
                    var ModifiedRate = document.getElementById("txtModifiedRate").value;
                    var ModifiedMRP = document.getElementById("txtModifiedMRP").value;
                    var ModifiedProfit = document.getElementById("txtModifiedProfit").value;
                    var Remarks = document.getElementById("txtRemarks").value;
                    var ProductCode = document.getElementById("txtModifyProductCode").value;
                    var GRN = document.getElementById("txtModifyGRN").value;
                    var OldRate = document.getElementById("txtOldRate").value;
                    var OldMRP = document.getElementById("txtOldMRP").value;



                    var datas = "&ModifiedRate=" + ModifiedRate + "&ModifiedMRP=" + ModifiedMRP +
                        "&ModifiedProfit=" + ModifiedProfit + "&Remarks=" + Remarks +
                        "&ProductCode=" + ProductCode + "&GRN=" + GRN + "&OldRate=" + OldRate + "&OldMRP=" + OldMRP;


                    $.ajax({
                        url: "Save/ModifyRate.php",
                        method: "POST",
                        data: datas,
                        success: function(data) {
                            ...
                            if (data == 1) {
                                ...
                                swal("Purchase Entry!", "Rate Modified Sucessfully", "success");
                                LoadSalesReport();
                ...
                function PrintTable() {
                    ...
                    printWindow.document.write('Purchase Report');
                    printWindow.document.write('        From: ');
                    printWindow.document.write(FromDate);
                    printWindow.document.write('        To: ');
                    printWindow.document.write(ToDate);

                    var divContents = document.getElementById("DivPaymentHistory").innerHTML;
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Modify Rate and MRP</h4>

                                        <input type='hidden' class='form-control' id='txtModifyGRN' name='txtModifyGRN'
                                            style="width: 150px;" />

                                        <input type='hidden' class='form-control' id='txtModifyProductCode'
                                            name='txtModifyProductCode' style="width: 150px;" />


                                        <input type='hidden' class='form-control' id='txtOldRate' name='txtOldRate'
                                            style="width: 150px;" />

                                        <input type='hidden' class='form-control' id='txtOldMRP' name='txtOldMRP'
                                            style="width: 150px;" />
                                    ...
                                    <div class="modal-body">
                                        <label>Rate</label>
                                        <input class='form-control' id='txtModifiedRate' name='txtModifiedRate'
                                            style="width: 150px;" />

                                        <label>MRP</label>
                                        <input class='form-control' id='txtModifiedMRP' name='txtModifiedMRP'
                                            style="width: 150px;" />

                                        <label>Profit</label>
                                        <input class='form-control' id='txtModifiedProfit' name='txtModifiedProfit'
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-danger" onclick="UpdateRate();"
                        ...
                        <div class="panel-heading">
                            <h5 class="panel-title">Purchase Report
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Details &nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="button" class="btn btn-sm btn-warning btn-xs" onclick="PrintTable();"
                                    value='Print' style=float:right;'>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td>Search:&nbsp; <select style='border-radius: 4px; padding: 5px;'
                                                ...
                                                <option value='6'>Short Code</option>
