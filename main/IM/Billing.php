...
<body onload="LoadInvoiceNo();" onmousedown="CalculateCurrentTotal()">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        <script>
            function AddComplementory() {


                var CurrentBillValue = document.getElementById("txtNettAmount").value;
                var Currentstock = 1; //document.getElementById("txtComplementryStock").value;
                var BillQty = 1;

                var Invoice = document.getElementById("txtInvoiceNo").value;
                var ProductCode = '229'; //document.getElementById("txtComplementryProductCode").value;
                var ProductName =
                    'COWDUNG CAKE TOOTH POWDER (40GM)'; //document.getElementById("txtComplementryProductName").value; //

                if (CurrentBillValue >= 3500) {


                    if (Currentstock == '0') {
                        swal("Alert!", "Stock Not available", "warning");
                    } else {
                        var Qty = 1;
                        var Shortcode = 'BTP - Complementary'; //document.getElementById("txtComplementryShortcode").value;
                        var Category = 'CHOORNAM'; //document.getElementById("txtComplementryCategory").value;
                        var MRP = 55; //document.getElementById("txtComplementryMRP").value;
                        var BatchCode = '-';
                        var SaleDate = document.getElementById("dtSaleDate")
                            .value; //                                                            
                        var PaitentCode = document.getElementById("txtPaitentCode").value;
                        var Rate = 33; //document.getElementById("txtComplementryRate").value;
                        ...
                        var TotalAmount = 0;
                        var DiscountAmount = 55;
                        var DiscountPercent = 100;


                        var datas = "&Invoice=" + Invoice + "&ProductCode=" + ProductCode + "&Qty=" + Qty +
                            "&Shortcode=" + Shortcode +
                        ...
                        // alert(datas);
                        $.ajax({
                            url: "Save/SaveBillingProductName.php",
                            method: "POST",
                            data: datas,
                    ...
                    swal("Alert!", "Total Bill value should be above 3500 ", "warning");
                }
            ...
            function SaveSaleItems() {
                ...
                if (ProductCode == '' || ProductName == '' || BillQty == '' || BillQty == 0) {
                    swal("Alert!", "Kindly enter the product details", "warning");
                } else {
                    ...
                    if (Number(BillQty) > Number(Currentstock)) {
                        ...
                        var DoctorCode = document.getElementById("cmbDoctor").value;
                        var BillType = document.getElementById("cmbBillType").value;
                        var StockItemID = document.getElementById("txtBarcode").value;
...

                        {
                            ...
                            var datas = "&Invoice=" + Invoice + "&ProductCode=" + ProductCode + "&Qty=" + Qty +
                                ...
                                BatchCode +
                                "&Currentstock=" + Currentstock + "&PaitentCode=" + PaitentCode + "&Rate=" + Rate +
                                "&SaleDate=" + SaleDate + "&DoctorCode=" + DoctorCode + "&StockItemID=" + StockItemID;
                            $.ajax({
                                url: "Save/SaveBillingProductName.php",
                                method: "POST",
                                data: datas,
            ...
            function SaveBillingDetails() {
                ...
                var txtStateList = document.getElementById("txtStateList").value;
                ...
                if (Invoice == "" || TotalSaleAmount == "" || PaitentCode == "" || SaleDate == "" || DoctorCode == "") {
                    ...
                    var datas = "&Invoice=" + Invoice + "&TotalSaleQty=" + TotalSaleQty + "&TotalDiscountAmount=" +
                        ...
                        TotalSaleAmount + "&BalanceAmount=" + BalanceAmount + "&PaitentCode=" + PaitentCode +
                        "&SaleDate=" +
                        SaleDate + "&OldBalance=" + OldBalance + "&ReceivedAmount=" + ReceivedAmount + "&NewBalance=" +
                        NewBalance + "&DoctorCode=" + DoctorCode + "&BillType=" + BillType + "&txtAddress1=" +
                        txtAddress1 +
                        "&txtAddress2=" + txtAddress2 + "&txtState=" + txtState + "&txtCity=" + txtCity +
                        "&txtPincode=" +
                        txtPincode + "&Remarks=" + Remarks +
                        "&CourierCharges=" + CourierCharges +
                        "&LocationcodeAdmin=" + LocationcodeAdmin +
                        "&txtStateList=" + txtStateList +
                    ...
                    $.ajax({
                        url: "Save/SaveSaleMasterProductName.php",
                        method: "POST",
                        data: datas,
                        success: function(data) {
                            // swal(data);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (CurrentStockQty < 10) {
                            swal("Alert!", "Selected Stock is Below 10, consider for replineshment",
                                "warning");
                            document.getElementById("txtQty").focus();
                        } else {
                            document.getElementById("txtQty").focus();
            ...
            function LoadBarcodeDetails() {
                ...
                var datas = "&ProductCode=" + ProductCode + "&LocationCode=" + LocationCode;

                $.ajax({
                    url: "Load/LoadBarcodeDetailsBillingProductName.php",
                    method: "POST",
                    data: datas,
                    dataType: "json",
                    success: function(data) {
            ...
            function LoadInvoiceTotal() {
                ...
                // alert(datas);
                $.ajax({
                    url: "Load/LoadBillingTotalProductName.php",
                    method: "POST",
                    data: datas,
                    dataType: "json",
                    success: function(data) {
            ...
            function LoadProductList() {
                ...
                var datas = "&Invoice=" + Invoice;
                $.ajax({
                    url: "Load/LoadBillingItemListProductName.php",
                    method: "POST",
                    data: datas,
                    success: function(data) {
            ...
            function LoadEstimateDetails() {
                ...
                $.ajax({
                    url: "Load/LoadPendingEstimateDetails.php",
                    method: "POST",
                    data: datas,
                    success: function(data) {
            ...
            function DeleteProductinBillingItem() {
                ...
                $.ajax({
                    url: "Delete/DeleteBillingItemProductName.php",
                    method: "POST",
                    data: datas,
                    success: function(data) {
                        // alert(data);
            ...
            function LoadPaymentTotal() {
                ...
                var datas = "&Invoice=" + Invoice + "&CurrentBillTotal=" + CurrentBillTotal + "&OldBalance=" +
                    OldBalance;
                // alert(datas);
                $.ajax({
            ...
            function GetSelectedAddress(x) {
                ...
                var Address1 = document.getElementById("tblSavedAddress").rows[SelectedRow].cells.namedItem(
                        "tblAddress1")
                    .innerHTML;
                var Address2 = document.getElementById("tblSavedAddress").rows[SelectedRow].cells.namedItem(
                        "tblAddress2")
                    .innerHTML;
            ...
            <div class="modal-dialog" style="width:800px;">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Pending Estimate Bills</h4>
                    </div>
        ...
        <div class="modal fade" id="modalOnlineRegistration">
            <div class="modal-dialog" style="width:800px;">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title">Online Registered User Paitent</h4>
                    </div>
                    <div class="modal-body">
            ...
            <div class="modal-dialog" style="width:200px;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type='text' id='txtItemwiseDiscountPercent' name='txtItemwiseDiscountPercent' class='form-control' placeholder='Discount %' />
                    </div>
                    <div class="modal-footer">

                        <a href="javascript:;" class="btn btn-sm btn-success" onclick="ApplyDiscountItemwise()" data-dismiss="modal">Apply</a>
            ...
            <div class="row">
                    ...
                    <div id='ModalProject' class='modal-window'>
                        <div class="row">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td> <select class="form-control" id='cmbPaymentMode' name='cmbPaymentMode' onchange='focusamount();'>
                                            <option></option>
                                            <?php
                                    ...
                                    <td>&nbsp;&nbsp;</td>
                                    <td> <input type="number" name="txtPaymentAmount" id="txtPaymentAmount" placeholder="" class="form-control" /></td>
                                    <td>&nbsp;&nbsp;</td>
                                    <td> <button type='button' class="btn btn-sm btn-primary" onclick="SavePaymentDetails(); " data-dismiss='modal'> Add </button> </td>
                                </tr>
                                ...
                                <div id="DivCourierDetails" style="display:none;">
                                    <table width='90%'>
                                        <tr>
                                            ...
                                            <td>&nbsp;&nbsp;&nbsp;<a href="#ModalAddress" data-toggle="modal" onclick='LoadSavedAddress();' class="btn btn-sm btn-success">Saved
                                                    Address</a> </td>
                                        </tr>
                                        <tr>
                                            <td>Address 1 &nbsp;&nbsp;</td>
                                            <td width="250px;"><input type="text" class="form-control" id='txtAddress1' name='txtAddress1' placeholder='Address 1' style="text-align: left;background-color:white;text-transform:uppercase;" />
                                            </td>



                                            <td colspan="2"><input type="text" class="form-control" id='txtAddress2' name='txtAddress2' placeholder='Address 2' style="text-align: left;background-color:white;
                                        ...
                                        <tr>
                                            ...
                                            <td width="20px;">
                                                ...
                                                <select class="selectpicker" data-show-subtext="true" data-live-search="true" data-style="btn-white" id='txtStateList' name='txtStateList' style="height:1.8em;" onchange="UpdateCourierCharges()">
                            ...
                            select stateid,statename from statemaster order by statename ";
                                            ...
                                            <td>
                                                <input type="text" class="form-control" id='txtState' name='txtState' placeholder='State' style="text-align: left;background-color:white;text-transform:uppercase;" />
                                            </td>
                                            <td><input type="text" class="form-control" id='txtCity' name='txtCity' placeholder='City' style="text-align: left;background-color:white;text-transform:uppercase;" />
                                            </td>

                                            <td><input type="number" class="form-control" id='txtPincode' name='txtPincode' placeholder='Pincode' style="text-align: left;background-color:white;" /></td>

                                        </tr>
                                    </table>
                                </div>
                                <br>
                                <textarea rows=3 class="form-control" id='txtRemarks' placeholderr='Remarks' placeholder='Remarks' name='txtRemarks' style="width=50%"></textarea>
                            ...
                            <div class="vl"></div>
                            <div class="col-md-3">
                                <input type="hidden" class="form-control" disabled id='txtBalanceToSave' name='txtBalanceToSave' style="text-align: right;background-color:white;" onchange="CalculateCurrentTotal();" />

                                <table>
                                    <tr>
                                        <td>Old Due</td>
                                        <td width="120px;"><b><input type="number" class="form-control" disabled id='txtoldbalance' name='txtoldbalance' style="text-align: right;background-color:white;" value='0' onchange="CalculateCurrentTotal();" /></b>
                                    ...
                                    <tr>
                                        <td>Current Bill</td>
                                        <td><b><input type="number" class="form-control" disabled id='txtAmountCurrentBill' name='txtAmountCurrentBill' style="text-align: right;background-color:white;" value='0' onchange="CalculateCurrentTotal();" /></b></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    </tr>
                                    ...
                                    <tr class="trCourierCharges" hidden>
                                        <td>Courier </td>
                                        <td><b><input type="number" class="form-control" id='txtCourierCharges' name='txtCourierCharges' style="text-align: right;background-color:#94b75f;" value='0' onchange="CalculateCurrentTotal();" /></b></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>Total</td>
                                        <td><b><input type="number" class="form-control" disabled id='txtTotalDueAmount' name='txtTotalDueAmount' style="text-align: right;background-color:white;" value='0' onchange="CalculateCurrentTotal();" /></b></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td>Payment</td>
                                        <td><b><input type="number" class="form-control" disabled id='txtTotalPayment' name='txtTotalPayment' style="text-align: right;background-color:white;" value='0' onchange="CalculateCurrentTotal();" /></b></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>Balance</td>
                                        <td><b><input type="number" class="form-control" disabled id='txtBalance' name='txtBalance' style="text-align: right;background-color:white;" onchange="CalculateCurrentTotal();" /></b></td>
                                    </tr>
                                    <tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <td> </td>
                                    <td>
                                        <br><input type="button" class="btn btn-sm btn-success" data-dismiss='modal-close' onclick="SaveSaleMaster();" value='Save'>
                ...
                <div class="panel panel-inverse">
                    <div class="panel-body">
                        ...
                        <input type="hidden" name="txtBarcodeToDelete" id="txtBarcodeToDelete" placeholder="" class="form-control" />
                        <input type="hidden" name="txtBarcodeforItemwiseDiscount" id="txtBarcodeforItemwiseDiscount" placeholder="" class="form-control" />
                        ...
                        <div>
                            <table>
                                <tr>
                                    ...
                                    <td></td>
                                    <td>Mobile No &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href='#modalOnlineRegistration' style='color:Green' data-toggle='modal' onclick='LoadOnlineRegistration()'>View
                                            Tab Reg
                                            </i></a>
                                    </td>
                                    <td></td>
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" style='border-radius: 4px; padding: 5px; text-align: left;' id='cmbBillType' name='cmbBillType' onchange='HideCourierDetails()' style="width: 150px;">
                                    ...
                                    <td>
                                        ...
                                        if ($GroupID == '1') {
                                        ?>
                                            <select class="form-control" style='border-radius: 4px; padding: 5px; text-align: left;' id='cmbLocationAdmin' name='cmbLocationAdmin' onchange='HideCourierDetails()' style="width: 150px;">
                                                <?php
                    ...
                    locationcode ='$LocationCode'";
                                    ...
                                    <td><input type="date" class="form-control" placeholder="" id='dtSaleDate' name='dtSaleDate' value='<?php echo date('Y-m-d'); ?>' />
                                    </td>
                                    <td>&nbsp;&nbsp;</td>
                                    <td><select class="form-control" style='border-radius: 4px; padding: 5px; text-align: left;' id='cmbDoctor' name='cmbDoctor' style="width: 150px;">
                                    ...
                                    <td>&nbsp;&nbsp;</td>
                                    <td>
                                        <button class='btn btn-primary' onchange='LoadPaitentBasicDetails();'>
                                            <option value='0'>Search Paitent</option>
                                            </select>

                                            <select class="selectpicker" data-show-subtext="true" data-live-search="true" data-style="btn-white" id='txtMobileNo' name='txtMobileNo' onchange='LoadPaitentDetails();ClearBarcode();'>
                                                <option selected></option>
                                            ...
                                            <input type="hidden" name="txtMobileNoq" id="txtMobileNoq" placeholder="" class="form-control" onblur="LoadPaitentDetails();" />
                                            <input type="hidden" name="txtPaitentCode" id="txtPaitentCode" placeholder="" class="form-control" />
                                    </td>
                                    <td>&nbsp;&nbsp;</td>

                                    <td> <input style="background-color:white;" type="text" name="txtPaitentBarcode" id="txtPaitentBarcode" placeholder="" class="form-control" onblur='LoadPaitentDetails();ClearPaitentDropdown();' /></td>
                                    <td>&nbsp;&nbsp;</td>

                                    <td><a href="AddPaitent.php?MID=18" class="btn btn-sm btn-success">+</a></td>
                                    <td>&nbsp;&nbsp;</td>
                                    <td><input style="background-color:white;" type="text" name="txtName" id="txtName" placeholder="" class="form-control" disabled /></td>
                                    <td>&nbsp;&nbsp;</td>
                                    <td><input style="background-color:white;" type="text" name="txtOldDue" id="txtOldDue" placeholder="0" class="form-control" disabled /></td>
                                    <td>&nbsp;&nbsp;</td>

                                    <td>
                                        <a href='#modal-dialog' style='color:red' data-toggle='modal'>Estimate -
                                            <b><span id='spnEstimates'>0</span< /b></i></a>
                                    </td>

                                    <td hidden> <input style="background-color:white;" type="text" name="txtPendingOrders" id="txtPendingOrders" placeholder="0" class="form-control" disabled /> </td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker" data-show-subtext="true" data-live-search="true" data-style="btn-white" id='txtBarcode' name='txtBarcode' onchange='LoadBarcodeDetails();DisableBillType();'>
                                                <option selected></option>
                                                <?php
                                                $sqli = " SELECT concat(productcode,'-',mrp) as productcode, CONCAT(b.productshortcode,' | &#8377; ',mrp,' | &#9750;',sum(currentstock)) AS Product
                                                FROM newstockdetails_3 AS a JOIN productmaster AS b ON a.productcode=b.productid WHERE currentstock  > 0
                                                GROUP BY concat(productcode,'-',mrp)  ";
                                                $result = mysqli_query($connection, $sqli);
                                                while ($row = mysqli_fetch_array($result)) {
                                                    # code...
                                            ...
                                            <select class="selectpicker" data-show-subtext="true" data-live-search="true" data-style="btn-white" id='txtBarcode' name='txtBarcode' onchange='LoadBarcodeDetails();DisableBillType();'>
                                                <option selected></option>
                                                <?php
                                                //                     $sqli = " select concat(barcode,productcode,'-',mrp) as productcode ,
                                                //                     concat(barcode,'&nbsp;&nbsp;<b>',shortcode,'  &nbsp;&nbsp;&nbsp;&nbsp;
                                                //                      (&#8377;: ',mrp,')',' &nbsp;&nbsp;&nbsp;&nbsp;[&#9750;: ',sum(currentstock),']')  as Product from 
                                                //  newstockdetails_3 where currentstock > 0
                                                // group by concat(barcode,productcode,mrp),concat(shortcode,' (MRP: ',mrp,')',' [Cur.Stk: ',currentstock,']')  order by shortcode";
                                                //                     $result = mysqli_query($connection, $sqli);
                                                //                     while ($row = mysqli_fetch_array($result)) {
                                                //                         # code...
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input style="background-color:white;" type="text" name="txtProductName" id="txtProductName" placeholder="" class="form-control" disabled />

                                            <input style="background-color:white;" type="hidden" name="txtProductCode" id="txtProductCode" placeholder="" class="form-control" disabled />
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <label>MRP</label>
                                            <input style="background-color:white;" type="text" name="txtMRP" id="txtMRP" placeholder="" class="form-control" disabled />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <label><br> </label>
                                            <button class="btn btn-sm btn-success form-control" onclick='SaveSaleItems();'> Add</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-1" style='float:right;'>
                                        <div class="form-group">
                                            <label>Disc %</label>
                                            <input type="text" name="txtDiscPercent" id="txtDiscPercent" placeholder="" class="form-control" disabled value=0 />
                                        </div>
                                    </div>
                                    <div class="col-md-2" style='float:right;'>
                                        <div class="form-group">
                                            <label>Concession Paitent</label>
                                            <input style="background-color:white;" type="text" name="txtDiscountPaitentStatus" id="txtDiscountPaitentStatus" placeholder="0" class="form-control" disabled />
                                        </div>
                                    </div>
                                    ...
                                    <div style="display:none;">
                                        ...
                                        <input type="text" name="txtDiscAmount" id="txtDiscAmount" placeholder="" class="form-control" disabled value=0 />
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input style="background-color:white;" type="text" name="txtTotalAmount" id="txtTotalAmount" placeholder="" class="form-control" disabled />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <br>
                                                <div class="controls">
                                                    <input type="button" class="btn btn-sm btn-success" onclick="SaveSaleItems();" value='Add'>
                        ...
                        <button class="btn btn-sm btn-success" onclick='AddComplementory()'>Apply Complementory
                        </button>
                        <label>Above Rs.3500</label>
                        <div class="col-md-12">
                            <!-- begin panel -->
                                ...
                                <div class="panel-body">
                                    ...
                                    <table style="position: relative; float:right;">
                                        <tr>
                                            ...
                                            ?>
                                                <td style="text-align: right;"><label>Overall Disc %</label></td>
                                                <td>
                                                    <div class="col-md-8">
                                                        <b> <input type="text" name="txtOverallDiscountPercent" id="txtOverallDiscountPercent" placeholder="" class="form-control" value=0 />

                                                    </div>

                                                    <input type="button" class="btn btn-sm btn-info" onclick="ApplyOveralllDiscount();" value='Apply'>
                                                <?php
                                            }
                                                ?>
                                                ...
                                                <td> <a href='#ModalProject'> <input type="button" class="btn btn-sm btn-success" onclick='LoadPaymentDetails();  CalculateCurrentTotal();' value='Save'> </a> </td>
