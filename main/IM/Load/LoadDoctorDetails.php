...
$result = mysqli_query($connection, "SELECT userid, username,doctorphone,doctoremail,activestatus  FROM   usermaster");
...
while($data = mysqli_fetch_row($result))
{
  ...
  <td id='mobileno' width='%'>$data[2]</td>  
  <td id='DoctorEmail' width='%'>$data[3]</td>  
  <td id='DoctorStatus' width='%'>$data[4]</td>  
