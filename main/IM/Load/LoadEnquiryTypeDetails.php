...
$(document).ready(function(){
  $("#txtEnquiryType").on("keyup", function() {
...
$result = mysqli_query($connection, "SELECT enquirytypeid, enquirytype,enquirytypestatus FROM   enquirytypemaster ");
...
while($data = mysqli_fetch_row($result))
{
  ...
  <td hidden id='EnquiryTypeID'>$data[0]</td>
  <td id='EnquiryType' width='50%'>$data[1]</td>  
  <td id='EnquiryTypeStatus' width='40%'>$data[2]</td>  
