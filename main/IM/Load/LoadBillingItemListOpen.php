...
$result = mysqli_query($connection, "
 ...
 SELECT saleid,barcode,productname,batchcode,SUM(saleqty)  AS Qty, mrp*SUM(saleqty) AS Total, 
 round(SUM(discountamount),0) AS Discount, round(SUM(nettamount),0) AS nett, currentstock FROM newsaleitems WHERE invoiceno ='$Invoice'
...
echo " <thead><tr>  
		...
		<th hidden width='%'><a href=\"javascript:SortTable(2,'T');\">Barcode Code</a></th>    
