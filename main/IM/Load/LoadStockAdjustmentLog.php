...
SELECT DATE_FORMAT(updatedon,'%d-%m-%Y'), barcode,oldqty,newqty,adjustmentremarks,b.`username` 
FROM stockadjustmentlog AS a JOIN usermaster AS b ON a.`updatedby`=b.`userid` 
WHERE updatedon  BETWEEN  '$FromPeriod 00:00:00' AND '$ToPeriod 23:59:00' ORDER BY updatedon DESC
...
echo " <thead><tr>  
		...
		<th  width='%'><a href=\"javascript:SortTable(2,'T');\">Old Stock</a></th>           
		<th width='%'> <a href=\"javascript:SortTable(3,'T');\">New Stock</a></th>        
