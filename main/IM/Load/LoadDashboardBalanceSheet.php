...
WHERE  a.date BETWEEN '$ActualFromDate' AND '$ActualToDate'  and a.clientid like ('$Location') and
 transactiontype in ('CashAdvance','IncomeEntry','OutstandingCollection','PaitentOrder','Sales') and transactionstatus='Live' 
...
and a.clientid like ('$Location') and transactiontype in ('CashAdvance','IncomeEntry','OutstandingCollection','PaitentOrder','Sales') 
 and b.paymentmodecode like ('$SelectedPaymentType') and transactiongroup ='Inventory'
...
ON a.paymentmode=b.paymentmodecode
WHERE  a.date BETWEEN  '$ActualFromDate' AND '$ActualToDate' and a.clientid like ('$Location') and 
transactiontype in ('Supplier Payment','Doctor Share')  and b.paymentmodecode like ('$SelectedPaymentType') and transactiongroup ='Inventory'
