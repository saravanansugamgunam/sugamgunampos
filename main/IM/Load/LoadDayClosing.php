...
$result = mysqli_query($connection, "  
 SELECT DATE_FORMAT(closingdate, '%d-%m-%Y') AS DATE , openingbalance,cashcollection,releasedamount,closingbalance FROM dayclosedetails  where clientid ='$Location' ORDER BY closingdate DESC  ");
