...
SELECT 
	(      
      ...
      WHERE orderdate BETWEEN '$ActualFromDate' AND '$ActualToDate'  and b.orderstatus='Open' )   AS Qty,
	...
	(      
      ...
      WHERE orderdate BETWEEN '$ActualFromDate' AND '$ActualToDate' and b.orderstatus='Open' )    AS Total
	  ") ;
