...
if (isset($_POST["STOUniqueNo"])) {
 ...
 SELECT barcode,shortcode,productname,batchcode,SUM(stoqty)  AS Qty, mrp*SUM(stoqty) AS Total , SUM(nettamount) AS nett, 
 currentstock FROM newstoitems WHERE stouniqueno ='$STOUniqueNo'
