...
SELECT a.productcode,b.productname,SUM(qty),rate,mrp,SUM(totalamount) FROM purchaseitemsnew AS a JOIN productmaster AS b
ON a.productcode = b.productid WHERE grnnumber ='$GRNNo'
GROUP BY a.productcode,b.productname,rate,mrp
 ");
