...
$result = mysqli_query($connection, "
 ...
 SELECT itemid,shortcode,productname,SUM(qty)  AS Qty, mrp*SUM(qty) AS Total , SUM(nettamount) AS nett, currentstock FROM preorderitems WHERE uniqueno ='$STOUniqueNo'
