...
if(isset($_POST["DayCloseDate"]))
{
 ...
 $Location = mysqli_real_escape_string($connection, $_POST["Location"]);    
  ...
  try {
		   ...
		   $AddPaymentMode = "insert into dayclosedetails (closingdate,openingbalance,cashcollection,releasedamount,closingbalance,dayclosedby,clientid) values ('$DayCloseDate','$OpeningBalance','$AvailableCash','$HandoverCash','$ClosingBalance','$userid','$Location');";
