...
if (isset($_POST["Invoice"])) {
   ...
   try {
      $SaveSaleItems .= "delete from newstockindentitems where invoiceno='$Invoice' and productcode='$ProductCode';";

      $SaveSaleItems .= "insert into newstockindentitems (invoiceno,productcode,saleqty,shortcode,category,productname,
