...
if(isset($_POST["Invoice"]))
{
 ...
 $InvoicePrefix  = 	"L".$InvoicePrefix;  
  ...
  try {
	  ...
	  if($BillType=='Free')
{ 
    $SaveSaleMaster.= "insert into salemaster_estimate (saledate,invoiceno,saleuniqueno,paitientcode,saleqty,discountamount,nettamount,profitamount,locationcode,oldbalance,received,newbalance,doctorcode,remarks,saletype,couriercharges,billtype,addedby,einvoiceno) values 
	('$SaleDate','$InvoicePrefix','$Invoice','$PaitentCode','$TotalSaleQty','$TotalDiscountAmount','$TotalSaleAmount','$TotalProfitAmount','$LocationCode','$OldBalance','$ReceivedAmount','$NewBalance','$DoctorCode','$Remarks','Free','$CourierCharges','$BillingFormat','$userid','$RandomeInvoiceNo');"; 
}
else if($BillType=='Courier')
{
		   
    $SaveSaleMaster.= "insert into salemaster_estimate (saledate,invoiceno,saleuniqueno,paitientcode,saleqty,discountamount,nettamount,profitamount,locationcode,oldbalance,received,newbalance,doctorcode,remarks,saletype,couriercharges,billtype,addedby,einvoiceno) values 
	('$SaleDate','$InvoicePrefix','$Invoice','$PaitentCode','$TotalSaleQty','$TotalDiscountAmount','$TotalSaleAmount','$TotalProfitAmount','$LocationCode','$OldBalance','$ReceivedAmount','$NewBalance','$DoctorCode','$Remarks','Courier','$CourierCharges','$BillingFormat','$userid','$RandomeInvoiceNo');"; 
}
else if($BillType=='Online')
{
		   
    $SaveSaleMaster.= "insert into salemaster_estimate (saledate,invoiceno,saleuniqueno,paitientcode,saleqty,discountamount,nettamount,profitamount,locationcode,oldbalance,received,newbalance,doctorcode,remarks,saletype,couriercharges,billtype,addedby,einvoiceno) values 
	('$SaleDate','$InvoicePrefix','$Invoice','$PaitentCode','$TotalSaleQty','$TotalDiscountAmount','$TotalSaleAmount','$TotalProfitAmount','$LocationCode','$OldBalance','$ReceivedAmount','$NewBalance','$DoctorCode','$Remarks','Online','$CourierCharges','$BillingFormat','$userid','$RandomeInvoiceNo');"; 
}
else
{
		  
    $SaveSaleMaster.= "insert into salemaster_estimate (saledate,invoiceno,saleuniqueno,paitientcode,saleqty,discountamount,nettamount,profitamount,locationcode,oldbalance,received,newbalance,doctorcode,remarks,saletype,billtype,addedby,einvoiceno) values 
	...
	if($BillType=='Courier' || $BillType=='Online')
{
  ...
  $SaveSaleMaster.= "insert into courierdetails (invoicenumber,couriercharge,address1,address2,city,state,pincode,statecode) values 
	('$Invoice','0','$Address1','$Address2','$City','$State','$Pincode','$StateCode');";
}
