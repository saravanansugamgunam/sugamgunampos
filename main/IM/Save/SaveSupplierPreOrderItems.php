...
$ProductName = mysqli_real_escape_string($connection, $_POST["ProductName"]);  
 ...
 $LocationCode = $_SESSION['SESS_LOCATION'];
  ...
  try {
    $AddBatch = "insert into supplierpreorderitems (uniqueno,itemid,qty,shortcode,category,productname,mrp,discountamount,nettamount,profitamount,date,fromlocation,batchcode,currentstock,paitentid,rate) values 
