...
if (isset($_POST["PatientMobileNo"])) {
  ...
  $ConsultationID = mysqli_real_escape_string($connection, $_POST["ConsultationID"]);
  ...
  try {
    ...
    if (mysqli_query($connection, $AddPaymentMode)) {
      ...
      $AddConsultation = "insert into newregistrationdetails 
      (customercode ,doctorcode,convertedstatus, paymentamount,consultationid) 
      values ('$last_id','$Doctor','0','0','$ConsultationID')";
