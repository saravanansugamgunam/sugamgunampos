...
function SaveNewPatient() {
    ...
    $.ajax({
        ...
        <div id="content" class="content">
            ...
            <a style='float:right;cursor:not-allowed;' href="javascript:;" class="btn btn-xs btn-success" 
                            data-dismiss="modal" >Search Alternate Medicine</a>
            ...
            <div class="row">
                ...
                <div class="panel panel-inverse">
                    ...
                    locationcode ='$LocationCode'";
                                    ...
                                    <select class="form-control select2" id="txtMobileNo" name="txtMobileNo" style="width: 100%"></select>
                                    ...
                                    <td hidden> <input style="background-color:white;" type="text" name="txtPaitentBarcode"
