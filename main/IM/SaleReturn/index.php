    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        <script>
            ...
            function ApplyOveralllAutoDiscount() {
                ...
                var Invoice = document.getElementById("txtInvoiceNo").value;
                var DiscountPercent = 0; //document.getElementById("txtDiscPercent").value;
                                ...
                                swal("Bill Saved Successfuly !", {
                                    ...
                                    .then((value) => {
                                        switch (value) {
                                            ...
                                            case "SendSMS":
                                                redirect();
                                                window.location.href = "index.php?MID=8#modal-close";
            ...
            function LoadProductDetails() {
                ...
                // alert(datas);
                $.ajax({
                    url: "LoadProductDetailsBilling.php",
                    method: "POST",
                    data: datas,
                    dataType: "json",
                    success: function (data) {
            ...
            function LoadMultipleItems() {
                ...
                $.ajax({
                    url: "LoadBarcodeDetailsBilling_STO.php",
                    method: "POST",
                    data: datas,
                    success: function (data) {
...
$.ajax({
    url: "LoadBarcodeDetails_STO.php",
    method: "POST",
    data: datas,
    dataType: "json",
    success: function(data) {
        ...
        if (Barcode != "") {
            ...
            function LoadBarcodeDetails() {
              var Barcode = document.getElementById("txtBarcode").value;
                ...
                $.ajax({
                    url: "LoadBarcodeDetailsBilling.php",
                    method: "POST",
                    data: datas,
                    dataType: "json",
                    success: function (data) {
            ...
            $(document).ready(function () {
                ...
                $('#txtMobileNo').on('select2:select', function (e) {
                    ...
                    if (selected.id === 'add_new') {
                        ...
                        document.getElementById('txtMobileNoq').value = selected.id;
                        LoadPaitentDetails(); // your existing function
                    }
                });
            });
            ...
            function SaveNewPatient() {
                ...
                if (!name || !mobile) {
                    swal("Please enter name and mobile number", "", "warning");
                    return;
                }

                $.ajax({
                    url: 'Save/SaveNewPatient.php',
                    type: 'POST',
                    ...
                    success: function (response) {
                        ...
                        if (res.status === 'success') {
                            ...
                            $('#txtMobileNo').append(newOption).trigger('change');
                        } else {
        ...
        <div id="content" class="content">
            <label><b><u>Sale Return</u></b></label>
                ...
                <div class="panel panel-inverse">
                    ...
                    locationcode ='$LocationCode'";
                                    ...
                                    <td width=350px;>
                                        ...
                                        <select class="form-control select2" id="txtMobileNo" name="txtMobileNo"
                                    ...
                                    <td hidden><input style="background-color:white;" type="text" name="txtName" id="txtName"
                                            placeholder="" class="form-control" disabled /></td>
                                    <td>&nbsp;&nbsp;</td>

                                    <td hidden ><input style="background-color:white;" type="text" name="txtOldDue"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="txtEmployeeCode" id="txtEmployeeCode"
                                                placeholder="" class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-1" style='float:right;display:none' >
                                        <div class="form-group">
                                            <label>Disc %</label>
                                ...
                                <div class="panel-body">
                                    ...
                                    <table style="position: relative; float:right;">
                                        <tr>
                                            ...
                                            <td style="text-align: right;"><label>Overall Deduction %</label></td>
                                            <td>
                                                <div class="col-md-8">
                                            ...
                                            <td style="text-align: right;"><label>Return Value</label></td>
                                            <td>
                                                <div class="col-md-12">
                                                    <b> <input style="text-align: right;" type="text"
