    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        <script>
            ...
            function LoadProductList() {
                ...
                $.ajax({
                    url: "Load/LoadDeliveryProductList.php",
                    method: "POST",
                    data: datas,
                    success: function(data) {
            ...
            function SaveSaleItems() {
                ...
                if (Number(BillQty) > Number(Currentstock)) {
                    ...
                    var StockItemID = document.getElementById("txtStockItemCode").value;
...

                    {
                        ...
                        var datas = "&Invoice=" + Invoice + "&Barcode=" + Barcode + "&Qty=" + Qty + "&StockItemID=" +
                            StockItemID + "&MRP=" + MRP + "&DiscountAmount=" +
                            DiscountAmount +
                            "&TotalAmount=" + TotalAmount + "&ProfitAmount=" + ProfitAmount +
                            "&Currentstock=" + Currentstock + "&PaitentCode=" + PaitentCode + "&Rate=" + Rate +
                            "&SaleDate=" + SaleDate;
                        // alert(datas);
                        $.ajax({
                            url: "Save/SaveBillingDelivery.php",
                            method: "POST",
                            data: datas,
                            success: function(data) {
            ...
            function SaveDeliveryDetails() {
                ...
                if (DeliveryStatus == 1) {
                    ...
                    setTimeout(function() {
                        ...
                        window.location.href = 'DeliveryManagement.php?MID=61';
        ...
        <div class="modal fade" id="ModalModifyProduct" name="ModalModifyProduct">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label"><b><span id='spnProductName'></span></b></label>
                                        <div class="col-md-3">
                                            <input type="hidden" class="form-control" placeholder="" id='txtModifyProductCode' name='txtModifyProductCode' />

                                            <input type="text" class="form-control" placeholder="" id='txtModifiedQty' name='txtModifiedQty' />


                                            <input type="hidden" class="form-control" placeholder="" id='txtActualQty' name='txtActualQty' />

                                        </div>
                                        <div class="col-md-3">
                                            <i style="color:red" class='fa fa-2x fa-trash' title='View' onclick='ClearQty()'></i>
                    ...
                    <div class="modal-footer">
                        <div class="col-md-5">
                            <input type="button" id='btnSave' class="btn btn-sm btn-success" onClick="UpdateItemQty();" value='Update'>
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal">
                                ...
                                <input type='hidden' id='txtDeliveryStatus' name='txtDeliveryStatus' value='<?php echo $DeliveryStatus; ?>' />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="date" class="form-control" placeholder="" id='dtSaleDate' name='dtSaleDate' value='<?php echo $InvoiceDate; ?>' disabled />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" placeholder="" id='txtBillNO' name='txtBillNO' disabled value='<?php echo $BillNo; ?>' />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" placeholder="" id='txtPaitentName' name='txtPaitentName' value='<?php echo $PaitientName; ?>' disabled />

                                        <input type="hidden" class="form-control" placeholder="" id='txtPaitentCode' name='txtPaitentCode' value='<?php echo $PaitentCode; ?>' disabled />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" placeholder="" id='txtTotalSaleQty' name='txtTotalSaleQty' disabled value='<?php echo $TotalSaleQty; ?>' />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" placeholder="" id='txtTotalBillAmount' name='txtTotalBillAmount' disabled value='<?php echo $TotalAmount; ?>' />
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control" placeholder="" id='txtBarcode' name='txtBarcode' onblur="LoadBarcodeDetails()" onkeyup="this.value = this.value.toUpperCase()" />

                                </div>



                                <label class="col-md-1 control-label">Cur. Stock</label>
                                <div class="col-md-2">
                                    <input type="text" class="form-control" id='txtCurrentStock' name='txtCurrentStock' readonly />
                                ...
                                <div class="col-md-1">
                                    <button class='btn btn-success' onclick='SaveSaleItems();'>Add</button>
                                </div>
                            ...
                            <input type="hidden" class="form-control" placeholder="" id='txtTotalSaleQtytoDeliver' name='txtTotalSaleQtytoDeliver' disabled />


                            <input type="hidden" class="form-control" placeholder="Balance" id='txtBalancetoScan' name='txtBalancetoScan' />
                            ...
                            <div style='display:none;'>
                                ...
                                <input type="text" class="form-control" placeholder="Shortcode" id='txtStockItemCode' name='txtStockItemCode' />
                                <input type="text" class="form-control" placeholder="ProductName" id='txtProductName' name='txtProductName' />
                                ...
                                <input type="text" class="form-control" placeholder="Batch" id='txtBatchcode' name='txtBatchcode' />
                                <input type="text" class="form-control" placeholder="Rate" id='txtRate' name='txtRate' />
                                <input type="text" class="form-control" placeholder="Bill Type" id='cmbBillType' name='cmbBillType' value='<?php echo $BillType; ?>' />
                                <input type="text" class="form-control" placeholder="Bill Type" id='cmbLocationAdmin' name='cmbLocationAdmin' value='<?php echo $LocationCode; ?>' />

                                <input type="text" class="form-control" placeholder="Profit" id='txtProfitAmount' name='txtProfitAmount' />
                                <input type="text" class="form-control" placeholder="Total" id='txtTotalAmount' name='txtTotalAmount' />
                                <input type="text" class="form-control" placeholder="Discount" id='txtDiscAmount' name='txtDiscAmount' />
                                <input type="text" class="form-control" placeholder="Disc %" id='txtDiscPercent' name='txtDiscPercent' />
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> </label>
                                <div class="col-md-9">
                                    <input type="button" id='btnSave' class="btn btn-sm btn-success" onClick="SaveDeliveryDetails();" value='Save'>
