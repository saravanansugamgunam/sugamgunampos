  ...
  function LoadSalesReport()
	  {
		...
		var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&PaitentID="+PaitentID; 
	  // alert(datas);
		 $.ajax({
      ...
      format: "dd/mm/yyyy"
        ...
        $('.datepicker').hide();
						 ...
						 <div class="panel-heading">
						    <h5 class="panel-title">Paitent Transaction History
                        ...
                        <div class="panel-body">
							  ...
							  <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        data-show-subtext="true" data-live-search="true" data-style="btn-white" 
                                        id='cmbPaitent' name='cmbPaitent'  style="width:150px;">
	   ...
	   <input type="button"  class="btn btn-sm btn-info" onclick="LoadSalesReport();"  value='View'>
											...
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<select hidden style='border-radius: 4px; padding: 5px;' id='cmbType' name ='cmbType' disabled>
			   ...
			   <div class="col-md-12" >
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
							...
							<input type=" " style='float:right;'  class="btn btn-sm btn-info btn-xs" onclick= "printDiv();" value='Print'>
							&nbsp;&nbsp;&nbsp;&nbsp;
