  ...
  function LoadSalesReport()
	  {
		...
		var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&Type="+Type+"&DoctorCode="+DoctorCode+"&Location="+Location; 
	 // alert(datas);
		 $.ajax({
		   url:"Load/LoadDoctorAnalysis.php",
		   method:"POST",
		   data:datas,
	...
	var FromDate = document.getElementById("dtFromDate").value;   
		...
		var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&Type="+Type+"&DoctorCode="+DoctorCode+"&Location="+Location;   
	  	    // alert(datas);
		 $.ajax({
		   url:"Load/LoadDoctorAnalysisTotal.php",
		   method:"POST",
		   data:datas,	
		   dataType:"json",
		   success:function(data)
      ...
      format: "dd/mm/yyyy"
        ...
        $('.datepicker').hide();
						 ...
						 <div class="panel-heading">
						    <h5 class="panel-title">Doctor Sales Analysis
				...
				<input type='hidden' id='txtLocationCode' name ='txtLocationCode' value ='<?php echo $LocationCode; ?>' />
                                    ...
                                    <div class="col-md-12">
											...
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<select style='border-radius: 4px; padding: 5px;' id='cmbDoctorCode' name ='cmbDoctorCode'>
			   ...
			   <div class="col-md-12" >
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
							...
							<tr>
							<td>Total Sales&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td>  <b><input style='border-radius: 4px; padding: 5px;  text-align: right;' size="15" type='text' id='txtCash' name ='txtCash' /> </b>
							&nbsp;&nbsp;&nbsp;&nbsp;</td> 
							<td>Total Profit&nbsp;&nbsp;&nbsp;&nbsp;</td>
