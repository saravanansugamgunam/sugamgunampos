        ...
        <div id="content" class="content">
            <div class="row">
                ...
                function LoadStockDetails() {
                    ...
                    // alert(datas);
                    $.ajax({
                        url: "Load/LoadStockDetailsExpiry.php",
                        method: "POST",
                        data: datas,
                            ...
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Barcode Details
                                    ...
                                    <button class='btn btn-xs btn-success' data-dismiss="modal"
                                        onclick="printDiv('DivBarcodeDetails')">
                                        Print
                                    </button>
                                </h4>
                            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Expiry Stock Report -
                                <select id='cmbLocation' name='cmbLocation' style="color: black;">
                                    <option value='-'>All</option>
                                    <option value='0'>Vanagaram</option>
                                    <option value='1'>Chetpet</option>
                                    <option value='2'>Vadaperumbakam</option>
                                    <option value='3'>Annanagar</option>
                                    <option value='4'>Godown</option>
                                    <option value='99'>In Transit</option>
                                </select>
                                &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                                <tr>
                                    ...
                                    <td> <button class="btn btn-sm btn-primary "
                                        ...
                                        <button class="btn btn-sm btn-danger " onclick="LoadStockDetailsinTransit()"
                                            style='float:right;'><i class="fa   fa-truck"></i>
                                            In Transit</button>
