    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        <script>
            function SaveSaleItems() {
                ...
                if (ProductCode == '' || ProductName == '' || BillQty == '' || BillQty == 0) {
                    ...
                    if (Number(BillQty) > Number(Currentstock)) {
                        ...
                        var StockItemID = document.getElementById("cmbBillType").value;
            ...
            function UpdateCourierCharges() {
                ...
                $.ajax({
                    url: "Load/AddCourierChargesEstimate.php",
                    method: "POST",
                    data: datas,
                    dataType: "json",
                    success: function(data) {
            ...
            function SaveBillingDetails() {
                ...
                if (Invoice == "" || TotalSaleAmount == "" || PaitentCode == "" || SaleDate == "" || DoctorCode == "") {
                    ...
                    $.ajax({
                        url: "Save/SaveSaleMasterEstimate.php",
                        method: "POST",
                        data: datas,
                        success: function(data) {
                            // swal(data);
                            if (data == 1) {
                                ...
                                var str1 = "SaleEstimateView.php?invoice=";
                                var str2 = Invoice;
                                var str3 = "";
                                var BillPrintURL = str1.concat(str2, str3);

                                swal("Estimate Added Successfuly !", {
                                        buttons: {
        ...
        <div id="content" class="content">
            <label><b><u>Billing - Estimate</u></b></label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker" data-show-subtext="true" data-live-search="true" data-style="btn-white" id='txtBarcode' name='txtBarcode' onchange='LoadBarcodeDetails();DisableBillType();'>
                                                <option selected></option>
                                                <?php
                                                $sqli = " select concat(productcode,'-',mrp) as productcode ,concat(shortcode,' (MRP: ',mrp,')',' [Cur.Stk: ',sum(currentstock),']')  as Product from 
                             newstockdetails_3 where currentstock > 0
                            group by concat(productcode,mrp),concat(shortcode,' (MRP: ',mrp,')',' [Cur.Stk: ',currentstock,']')  order by shortcode";
                                                $result = mysqli_query($connection, $sqli);
                                                while ($row = mysqli_fetch_array($result)) {
                                                    # code...
