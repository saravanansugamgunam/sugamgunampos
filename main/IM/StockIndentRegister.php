        ...
        <div id="content" class="content">
            <div class="row">
                ...
                function LoadSalesReport() {
                    ...
                    // alert(datas);
                    $.ajax({
                        url: "Load/LoadStockIndentRegister.php",
                        method: "POST",
                        data: datas,
                ...
                function LoadSTITotal() {
                    ...
                    // alert(datas);
                    $.ajax({
                        url: "Load/LoadStockIndentRegisterTotal.php",
                        method: "POST",
                        data: datas,
                        dataType: "json",
                        success: function(data) {
                ...
                function UpdateIndentClosure(x) {
                    var UniqueID = x;
                    var datas = "&UniqueID=" + UniqueID;
                    alert(datas);
                    $.ajax({
                        url: "Save/UpdateIndentClosure.php",
                        method: "POST",
                        data: datas,
                        success: function(data) {
                            if (data == 1) {
                ...
                function SendClosureMessage() {
                    ...
                    $.ajax({
                        url: "sendindentupdate.php",
                        method: "POST",
                        data: datas,
                        success: function(data) {
                            alert("Indent Status updated");
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-heading">
                            <h5 class="panel-title">Stock Indent Register
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="" placeholder="From" id="dtFromDate"
                                        style='border-radius: 4px; padding: 5px;' value='<?php echo date('d/m/Y'); ?>'>
                                    <span> &nbsp;&nbsp;&nbsp; to &nbsp;&nbsp;&nbsp; </span>
