...
var datas = "&Invoice="+Invoice+"&ProductCode="+ProductCode+"&Qty="+Qty+"&Shortcode="+Shortcode+"&Shortcode="+Shortcode
			...
			+"&TotalAmount="+TotalAmount+"&ProfitAmount="+ProfitAmount+"&BatchCode="+BatchCode+"&Currentstock="+Currentstock+"&PaitentCode="+PaitentCode+"&Rate="+Rate+
...
// });
	  ...
	  swal("Alert!", "Kindly provide valid deta", "warning");
	  ...
	  {	
		  var OldBalance = document.getElementById("txtOldDue").value;   
			var ReceivedAmount = document.getElementById("txtTotalPayment").value;   
			var NewBalance = document.getElementById("txtBalance").value; 
			var Remarks = document.getElementById("txtFreeRemarks").value; 
			var BillType = 'Free'; 			
...
"&ReceivedAmount="+ReceivedAmount+"&NewBalance="+NewBalance+"&DoctorCode="+DoctorCode+"&BillType="+BillType+"&Remarks="+Remarks;	
...
.then((value) => {
  switch (value) {
    ...
    case "SendSMS": 
	 redirect();
	  window.location.href = "FreeBilling.php?MID=21#modal-close";
	 window.location.reload(); 
      break;
...
function focusamount()
{
 ...
 <div id="content" class="content">
  <label><b><u>Free Billing</u></b></label> 
 ...
 <div id='ModalProject' class='modal-window'>
   ...
   <h1>Payment 
	...
	<td> <button type='button' class="btn btn-sm btn-primary" onclick="SavePaymentDetails(); " data-dismiss='modal' >  Add </button> </td>
					  ...
					  <u><label>Remarks</label></u>
					  <textarea  class="form-control" rows="2" id='txtFreeRemarks' name='txtFreeRemarks' > </textarea>
					  </div>
                       <br>								
						<br>
                      <div class="vl"></div>
					  ...
					  <td>Balance</td><td><b><input type="number" class="form-control" disabled id='txtBalance' name='txtBalance'  style="text-align: right;background-color:white;" onchange="CalculateCurrentTotal();" /></b></td>
					   ...
					   <tr>
					    <tr><td></td></tr>
					  <td> </td><td>
					  <br><input type="button"  class="btn btn-sm btn-success"  data-dismiss='modal-close' onclick= "SaveSaleMaster();"   value='Save'> </td>
					  </tr>
								...
								<input style="background-color:white;" type="hidden" name="txtLocationCode" id="txtLocationCode" placeholder="" class="form-control"  disabled />
												...
												<div class="col-md-1">
												  ...
												  <div class="col-md-1">
													<div class="form-group">
														<label>Disc %</label>
														<input type="text" name="txtDiscPercent" id="txtDiscPercent" placeholder="" class="form-control"  value=100 onkeyup="CalculateTotal();"  />
													</div> 
                                                </div>
												<div class="col-md-1">
													<div class="form-group">
