...
<body onload="LoadInvoiceNo();LoadStockDetails();" onmousedown="CalculateCurrentTotal()">
    <!-- begin #page-loader -->
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function SaveSaleItems() {
            ...
            if (ProductCode == '' || ProductName == '' || BillQty == '' || BillQty == 0) {
                ...
                var DoctorCode = '0';
                var BillType = document.getElementById("cmbIndentType").value;
                var StockItemID = document.getElementById("cmbIndentType").value;
...

                {
                    ...
                    $.ajax({
                        url: "Save/SaveStockIndentItems.php",
                        method: "POST",
                        data: datas,
        ...
        function SaveBillingDetails() {
            ...
            if (Invoice == "" ||
                SaleDate == "" || TotalSaleQty == "" || TotalSaleQty == "0") {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data == 1) {
                            ...
                            swal("Stock Indent Added Successfuly !", {
                                    buttons: {
        ...
        function LoadBarcodeDetails() {
            ...
            $.ajax({
                url: "Load/LoadBarcodeDetailsStockIndent.php",
                method: "POST",
                data: datas,
                dataType: "json",
                success: function(data) {
        ...
        function LoadBarcodeDetails_fromStock(x) {
        ...
        function LoadInvoiceTotal() {
            ...
            // alert(datas);
            $.ajax({
                url: "Load/LoadIndentItemListTotal.php",
                method: "POST",
                data: datas,
                dataType: "json",
                success: function(data) {
        ...
        function LoadProductList() {
            ...
            var datas = "&Invoice=" + Invoice;
            $.ajax({
                url: "Load/LoadIndentItemList.php",
                method: "POST",
                data: datas,
                success: function(data) {
        ...
        function DisableBillType() {
            document.getElementById("cmbIndentType").disabled = true;
        }
        ...
        function DeleteProductinBillingItem() {
            ...
            $.ajax({
                url: "Delete/DeleteStockIndentItems.php",
                method: "POST",
                data: datas,
                success: function(data) {
                    // alert(data);
        ...
        function LoadStockDetails() {
            ...
            var ExcludedStatus = 'Yes';

            var datas = "&ExcludedStatus=" + ExcludedStatus;
            // alert(datas);
            $.ajax({
                url: "Load/LoadStockDetails_Indent.php",
                method: "POST",
                data: datas,
                success: function(data) {
        ...
        <div id="content" class="content">
            <label><b><u>Stock Indent</u></b></label>
                                    ...
                                    <table width='90%'>
                                        <tr>
                                            ...
                                            <td>&nbsp;&nbsp;&nbsp;<a href="#ModalAddress" data-toggle="modal"
                                                    onclick='LoadSavedAddress();' class="btn btn-sm btn-success">Saved
                                                    Address</a> </td>
                                        </tr>
                                        <tr>
                                            <td>Address 1 &nbsp;&nbsp;</td>
                                            <td width="250px;"><input type="text" class="form-control" id='txtAddress1'
                                                    name='txtAddress1' placeholder='Address 1'
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control"
                                            ...
                                            id='cmbIndentType' name='cmbIndentType' onchange='HideCourierDetails()'
                                            style="width: 150px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker" data-show-subtext="true"
                                                data-live-search="true" data-style="btn-white" id='txtBarcode'
                                                name='txtBarcode' onchange='LoadBarcodeDetails();DisableBillType();'>
                                                <option selected></option>
                                                <?php
                                                $sqli = "SELECT uniquebarcode as barcode , 
                                                concat(productshortcode,' - ',productname) AS Product FROM 
                                                 productmaster   ORDER BY uniquebarcode , productshortcode";
                                                $result = mysqli_query($connection, $sqli);
                                                while ($row = mysqli_fetch_array($result)) {
                                                    # code...

                                                    echo ' <option value=' . $row['barcode'] . '>' . $row['Product'] . '</option>';
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <button class="btn btn-sm btn-success form-control"
                                                onclick='SaveSaleItems();'> Add</button>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="column left" style="background-color:white;">
                        ...
                        <input style="text-align: right;" type="text" class="form-control" placeholder=""
                            id='txtTotalSaleQty' name='txtTotalSaleQty' disabled />
                        <input style="text-align: right;" type="text" class="form-control" placeholder=""
                            id='txtNettAmount' name='txtNettAmount' disabled />

                        <a href='#'> <input type="button" class="btn btn-sm btn-success" onclick='SaveBillingDetails();'
                                value='Save'></a>

                        <input type="button" class="btn btn-sm btn-warning" onclick="window.location.reload();"
                            value='Cancel'>
                    ...
                    <div class="column right" style="background-color:white;">
                        <h4>Current Stock Detail bellow 20 Qty</h4>
