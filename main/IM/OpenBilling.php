...
<body onload="LoadInvoiceNo();" onmousedown="CalculateCurrentTotal()">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function SaveSaleItems() {
            ...
            if (Number(BillQty) > Number(Currentstock)) {
                ...
                if (BillType == 'Free') {
                    ...
                    var TempProfitAmount = document.getElementById("txtProfit").value;
                    var ProfitAmount = TempProfitAmount * Qty;
        ...
        function SaveBillingDetails() {
            ...
            if (Invoice == "" || TotalSaleAmount == "" || PaitentCode == "" || SaleDate == "" || DoctorCode == "") {
                ...
                var datas = "&Invoice=" + Invoice + "&TotalSaleQty=" + TotalSaleQty +
                    ...
                    "&TotalSaleAmount=" + TotalSaleAmount + "&BalanceAmount=" + BalanceAmount + "&PaitentCode=" +
                    PaitentCode +
                    "&SaleDate=" + SaleDate + "&OldBalance=" + OldBalance + "&ReceivedAmount=" + ReceivedAmount +
                    "&NewBalance=" + NewBalance + "&DoctorCode=" + DoctorCode + "&BillType=" + BillType +
                    "&txtAddress1=" + txtAddress1 +
                    "&txtAddress2=" + txtAddress2 + "&txtState=" + txtState + "&txtCity=" + txtCity + "&txtPincode=" +
                    txtPincode +
                    "&Remarks=" + Remarks + "&CourierCharges=" + CourierCharges +
                            ...
                            swal("Bill Saved Successfuly !", {
                                ...
                                .then((value) => {
                                    switch (value) {
                                        ...
                                        case "SendSMS":
                                            redirect();
                                            window.location.href = "OpenBilling.php?MID=51#modal-close";
        ...
        function Reset() {
            ...
            document.getElementById("txtCurrentStock").value = '1000';
        ...
        function LoadProductList() {
            ...
            // alert(datas);
            $.ajax({
                url: "Load/LoadBillingItemListOpen.php",
                method: "POST",
                data: datas,
                success: function(data) {
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input style="background-color:white;text-transform:uppercase;" type="text"
                                                name="txtProductName" id="txtProductName" placeholder=""
                                                class="form-control" onfocus="DisableBillType()" />
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <input style="background-color:white;" type="text" name="txtRate"
                                                id="txtRate" placeholder="" class="form-control"
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <label>Profit</label>
                                            <input style="background-color:white;" type="text" name="txtProfit"
                                                id="txtProfit" placeholder="" class="form-control" disabled
                                                onkeyup="CalculateTotal();" />
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                ...
                                                <input style="background-color:white;" type="text"
                                                    ...
                                                    class="form-control" value='1000' disabled />
                                            </div>
                                        </div>


                                        <select class="selectpicker" data-show-subtext="true" data-live-search="true"
                                            data-style="btn-white" id='cmbProductCode' name='cmbProductCode'
                                            onchange="LoadProductDetails(); " style="width: 650px;">
                                            <option selected></option>

                                            <?php  
							 echo "SELECT stockitemid,CONCAT(shortcode,'-',productname,'(B.No-',batchno,')') AS Product FROM 
