  ...
  function LoadSTORegister()
	...
	var FromDate = document.getElementById("dtFromDate").value;   
		...
		var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&Type="+Type;  
	  	    // alert(datas);
		 $.ajax({
		   url:"Load/LoadSTORegisterTotal.php",
		   method:"POST",
		   data:datas,	
		   dataType:"json",
		   success:function(data)
      ...
      format: "dd/mm/yyyy"
        ...
        $('.datepicker').hide();
						 ...
						 <div class="panel-heading">
						    <h5 class="panel-title">Stock Transfer OUT Register
                        ...
                        <div class="panel-body">
							  ...
							  <div class="form-group">
                                    ...
                                    <div class="col-md-8">
											...
											&nbsp;&nbsp;&nbsp;
                                         <input type="button"  class="btn btn-sm btn-info" onclick="LoadSTORegister();"  value='View'>
                                    </div>
