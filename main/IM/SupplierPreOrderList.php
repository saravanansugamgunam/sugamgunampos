...
<html lang="en" class="ie8">
 ...
 <div id="content" class="content">
  ...
  function LoadSalesReport()
	 ...
	 // alert(datas);
		 $.ajax({
		   url:"Load/LoadSupplierPreorderReport.php",
		   method:"POST",
		   data:datas,
	...
	var FromDate = document.getElementById("dtFromDate").value;   
		...
		var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&Type="+Type;  
	  	      // alert(datas);
		 $.ajax({
		   url:"Load/LoadSupplierPreorderReportTotal.php",
		   method:"POST",
		   data:datas,	
		   dataType:"json",
		   success:function(data)
      ...
      format: "dd/mm/yyyy"
        ...
        $('.datepicker').hide();
						 ...
						 <div class="panel-heading">
						    <h5 class="panel-title">Supplier Preorder Report
			   ...
			   <div class="col-md-12">
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
							...
							<td hidden><b>Total Advance</b>&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td hidden><b><input style='border-radius: 4px; padding: 5px; text-align: right;'   size="15"  type='text' id='txtTotalSale' 
