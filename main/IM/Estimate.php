    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function SaveSaleItems() {
            ...
            if (Number(BillQty) > Number(Currentstock)) {
                ...
                if (Invoice == "" || PaitentCode == "" || SaleDate == "" || userid == "") {
...

                {
                    ...
                    var datas = "&Invoice=" + Invoice + "&Barcode=" + Barcode + "&Qty=" + Qty + "&Shortcode=" +
                        ...
                        "&SaleDate=" + SaleDate + "&userid=" + userid;
                    // alert(datas);
                    $.ajax({
        ...
        function SaveBillingDetails() {
            ...
            if (Invoice == "" || TotalSaleAmount == "" || PaitentCode == "" || SaleDate == "" || userid == "") {
                ...
                var datas = "&Invoice=" + Invoice + "&TotalSaleQty=" + TotalSaleQty + "&TotalDiscountAmount=" +
                    ...
                    NewBalance + "&userid=" + userid + "&BillType=" + BillType + "&txtAddress1=" + txtAddress1 +
                    "&txtAddress2=" + txtAddress2 + "&txtState=" + txtState + "&txtCity=" + txtCity + "&txtPincode=" +
                    txtPincode + "&Remarks=" + Remarks + "&CourierCharges=" + CourierCharges + "&BillingFormat=" +
                    BillingFormat;
                // alert(datas);

                $.ajax({
                    url: "Save/SaveSaleMaster_estimate.php",
                    method: "POST",
                    data: datas,
                    success: function(data) {
                        // swal(data);
                            ...
                            swal("Bill Saved Successfuly !", {
                                ...
                                .then((value) => {
                                    switch (value) {
                                        ...
                                        case "SendSMS":
                                            redirect();
                                            window.location.href = "Estimate.php?MID=58#modal-close";
                        ...
                        <div class="row">
                            ...
                            ?>
                                    ...
                                    <td> <button type='button' class="btn btn-sm btn-primary"
                                            onclick="SavePaymentDetails(); " data-dismiss='modal' disabled> Add
                                        </button> </td>
                                </tr>
                            ...
                            <div class="col-md-9">
                                ...
                                <div id="DivCourierDetails" style="display:none;">
                                    <table width='90%'>
                                        ...
                                        <tr>
                                            <td>State & City &nbsp;&nbsp;</td>
                                            <td width="20px;"> <input type="text" class="form-control" id='txtState'
                            ...
                            <table>
								...
								echo "<option value='Free' >Free</option>";
                                    ...
                                    <td><select class="form-control"
                                            ...
                                            name='cmbDoctor' style="width: 150px;" disabled>
                                    ...
                                    <td>
                                        ...
                                        <select class="selectpicker" data-show-subtext="true" data-live-search="true"
                                            ...
                                            <?php  
                            $sqli = "SELECT paitentid,concat(paitentname,' - ', mobileno) as Mobile FROM   `paitentmaster` where paitentname='Estimate' order by mobileno";
                            $result = mysqli_query($connection, $sqli); 
                             while ($row = mysqli_fetch_array($result)) {
                            	# code...
