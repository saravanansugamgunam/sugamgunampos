...
document.getElementById("txtInvoiceNo").value=InvoiceNo;
  ...
  LoadDoctorSharePaymentDetails();
	  ...
	  if (userid=="" || EntryDate=="" || FromDate=="" || ToDate=="" || SharePercent=="" || SharePercent=="0" || AmountToPay=="" || InvoiceNo=="" || AmountToPay=="0"  || TotalSale=="0"  || Profit=="0" || TotalSale==""  || Profit==""  || PaymentMode=="" )
	  {
	  ...
	  var datas = "&userid="+userid+"&EntryDate="+EntryDate+"&FromDate="+FromDate+"&ToDate="+ToDate+"&CalculationMode="+CalculationMode+"&SharePercent="+SharePercent+"&AmountToPay="+AmountToPay+"&PaymentMode="+PaymentMode+"&Remarks="+Remarks+"&TotalSale="+TotalSale+"&Profit="+Profit+"&InvoiceNo="+InvoiceNo;		  	
                   ...
                   <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
						...
						<input type ='hidden' id='txtInvoiceNo' name ='txtInvoiceNo' />
                            <form class="form-horizontal">
							 ...
							 <?php  
                            $sqli = "SELECT userid,username FROM usermasterWHERE activestatus ='Active' ";
                            ...
                            ?>
								...
								<div class="form-group">
                                   <label class="col-md-3 control-label">Period</label>
									 ...
									 <div class="col-md-1">
                                          <a class="btn btn-success btn-icon btn-circle btn-lg" onclick='LoadDoctorShare();'><i class="fa fa-repeat"> </i></a>
                                    </div> 
								...
								<div class="form-group">
                                   <label class="col-md-3 control-label">Total Sales</label>
									 ...
									 <label class="col-md-1 control-label">Profit</label>
									 <div class="col-md-4">
                                           <input type="text" class="form-control" placeholder="" id='txtProfit' name='txtProfit' disabled />
                                    </div> 
									 
                                </div>
								
								<div class="form-group">
                                  <label class="col-md-3 control-label">Calculate by</label>
									 ...
									 <label class="col-md-1 control-label" style='white-space:nowrap;'>Share %</label>
                                   
									 <div class="col-md-2">
                                           <input type="number" class="form-control" placeholder="" id='txtSharePercent' name='txtSharePercent' onkeyup="CalculateTotal()" />
                                    </div> 
									
									  <a href="javascript:;" class="btn btn-primary btn-sm m-r-5" onclick ='CalculateShare()'>Calculate</a>
								...
								<div class="form-group">
									 ...
									 <div class="col-md-4">
                                           <input type="number" class="form-control" placeholder="" id='txtAmountToPay' name='txtAmountToPay' onkeyup="CalculateTotal()" disabled />
                                    </div> 
