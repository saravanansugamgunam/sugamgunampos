...
$STOID=$_GET['invoice'];
	  ...
	  $res = $connection->query(" 
	   ...
	   SELECT DATE_FORMAT(saledate ,'%d-%m-%Y') AS IndentDate ,  CONCAT('ST',saleid) AS 'Indent No'  ,
       b.locationname,nettamount,saleqty FROM salemaster_stockindent AS a
       JOIN locationmaster AS b ON a.locationcode = b.locationcode WHERE saleuniqueno ='$STOID' ;"); 
	 ...
	 ?>
                 ...
                 <div style="width: 136px; float: left; height: 70px;">
                     ...
                     <table cellpadding="3" cellspacing="0"
                         ...
                         <tr>
                             <td style="white-space:nowrap;">Indent #:</td>
             ...
             <div style="width: 40%; margin-top:-70px;">
                ...
                SELECT b.uniquebarcode,shortcode,mrp,SUM(saleqty) FROM  newstockindentitems AS a JOIN productmaster AS b ON 
                a.productcode=b.productid     WHERE invoiceno ='$STOID' 
                GROUP BY b.uniquebarcode,shortcode,mrp "); 
