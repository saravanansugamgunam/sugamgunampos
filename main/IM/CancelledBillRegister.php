  ...
  function LoadSalesReport()
	  {
		...
		var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&Type="+Type+"&ConsultationType="+ConsultationType+"&Location="+Location; 
	 // alert(datas);
		 $.ajax({
		   url:"Load/LoadCancellReport.php",
		   method:"POST",
		   data:datas,
	...
	var FromDate = document.getElementById("dtFromDate").value;   
		...
		var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&Type="+Type+"&ConsultationType="+ConsultationType+"&Location="+Location;   
	  	     // alert(datas);
		 $.ajax({
		   url:"Load/LoadCancellReportTotal.php",
		   method:"POST",
		   data:datas,	
		   dataType:"json",
		   success:function(data)
      ...
      format: "dd/mm/yyyy"
        ...
        $('.datepicker').hide();
						 ...
						 <div class="panel-heading">
						    <h5 class="panel-title">Cancelled Bill Register
