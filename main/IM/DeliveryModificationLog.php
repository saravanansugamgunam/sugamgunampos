...
<body onload="Reset();">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function LoadBillModification() {
            ...
            // alert(datas);
            $.ajax({
                url: "Load/LoadBillModification.php",
                method: "POST",
                data: datas,
                success: function(data) {
                    // alert(data);
...
<div id="ModalPaymentDetails" class="modal fade" role="dialog">
        <div class="modal-dialog ">
            ...
            <div class="modal-content">
                ...
                <input type='number' id='txtInvoiceNo' name ='txtInvoiceNo' 
                class="form-control" style='width:150px;' />
                <input type='number' id='txtPaitentID' name ='txtPaitentID' 
                class="form-control" style='width:150px;' />
                ...
                <!-- begin col-6 -->
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Delivery Bill Modification Log</h4>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="radio-inline">
                                ...
                                <a class="btn btn-success  btn-sm" onclick='LoadBillModification();'>View</a>
