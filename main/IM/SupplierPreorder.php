...
.modal-window h1 {
  ...
  <body onload="LoadInvoiceNo();">
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
	  ...
	  <script>
  function SaveSupplierPreOrderItems()
	  { 
	   ...
	   var Currentstock = document.getElementById("txtCurrentStock").value;//                                                            
	   var SupplierID = document.getElementById("cmbSupplier").value;   
	   var Rate = document.getElementById("txtRate").value;   
	   // alert(2);                                                                                                                                         
	  if (STOUniqueNo=="" ||   SupplierID ==""   )
	  {
	  ...
	  {	
		  // alert(3);
var datas = "&STOUniqueNo="+STOUniqueNo+"&ProductCode="+ProductCode+"&Qty="+Qty+"&Shortcode="+Shortcode+"&Shortcode="+Shortcode
			+"&Category="+Category+"&ProductName="+ProductName+"&MRP="+MRP+"&DiscountAmount="+DiscountAmount
			+"&TotalAmount="+TotalAmount+"&ProfitAmount="+ProfitAmount+"&BatchCode="+BatchCode+"&Currentstock="+Currentstock+"&SupplierID="+SupplierID+"&Rate="+Rate;	
	  	   // alert(datas);
		 $.ajax({
		   url:"Save/SaveSupplierPreOrderItems.php",
		   method:"POST",
		   data:datas,
	  ...
	  {	
		  // alert(3);
var datas = "&STOUniqueNo="+STOUniqueNo+"&SupplierID="+SupplierID+"&DeliveryMode="+DeliveryMode+"&PaymentMode="+PaymentMode+"&AdvanceAmount="+AdvanceAmount+"&Remarks="+Remarks;	
	  	  // alert(datas);
		 $.ajax({
		   url:"Save/SaveSupplierOrderMaster.php",
		   method:"POST",
		   data:datas,
		   success:function(data)
		   {	 
			 if(data==1)
			 {
				   swal("Order Saved!", "Supplier Order Saved Sucessfully", "success");
  ...
  LoadProductList();
	  ...
	  function  LoadSupplierDetails()
	  {
		...
		var datas = "&MobileNo="+MobileNo;	
	  	  // alert(datas);
		 $.ajax({
		   url:"Load/LoadSupplierDetails.php",
		   method:"POST",
		   data:datas,	
		   dataType:"json",
		   success:function(data)
	  ...
	  function LoadProductList()
	  {
		...
		var datas = "&STOUniqueNo="+STOUniqueNo;	
	  	  // alert(datas);
		 $.ajax({
		   url:"Load/LoadSupplierPreorderItems.php",
		   method:"POST",
		   data:datas,
		   success:function(data)
		   {	
	  ...
	  {
var datas = "&PaymentMode="+PaymentMode+"&Invoice="+Invoice+"&SupplierCode="+SupplierCode+"&PaymentAmount="+PaymentAmount;	
	  	  // alert(datas);
		 $.ajax({
		   url:"Save/SaveSupplierPaymentDetails.php",
		   method:"POST",
		   data:datas,
		   success:function(data)
		   {	
	   ...
	   function GetPointID(x)
{
 ...
 <div id='ModalProject' class='modal-window'>
  <div>
			    ...
			    <option value='SomeOne'>Some one</option>  
                            ...
                            ?>
												 ...
												 <div class="col-md-3">
													<div class="form-group">
														<label>Advance</label>
														  <input type="number" name="txtPaymentAmount" id="txtPaymentAmount" placeholder="" class="form-control" />
														  <input type="hidden" name="txtPaymentID" id="txtPaymentID" placeholder="" class="form-control" />
	...
	<a href='#modal-close' title='Close'  ><input type="button"  class="btn btn-sm btn-success"  data-dismiss='modal-close'
										onclick= "SavePreOrderMaster();"   value='Save'></a>
  ...
  <div class="modal fade" id="ModalPreOrderMaster">
                    ...
                    <div class="panel panel-inverse"> 
					 <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Supplier Order Details</h4>
                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
													<div class="form-group">
														...
														<select class="selectpicker form-control" data-show-subtext="true" data-live-search="true" data-style="btn-white" id='cmbSupplier' name='cmbSupplier'  style="width:150px;">
	   <option selected></option> 
							<?php
							  $sqli = "SELECT suplier_id, suplier_name  FROM `supliers` ";
                            $result = mysqli_query($connection, $sqli); 
                             while ($row = mysqli_fetch_array($result)) {
                            	# code...
                            ...
                            ?>
									...
									<div class="form-group">
									<label> Product</label>
									   <select class="selectpicker form-control" data-show-subtext="true" data-live-search="true" data-style="btn-white" id='cmbProductCode' name='cmbProductCode' onchange="LoadProductDetails();ClearTotalAmount();" style="width: 650px;">
	   <option selected></option> 
								...
								<div class="col-md-1" style="margin-left:-0%;">
												...
												<div class="col-md-2">
                                                    <div class="form-group">
                                                        <br>
                                                        <div class="controls">
                                                         <input type="button"  class="btn btn-sm btn-success" onclick= "SaveSupplierPreOrderItems();" value='Add'>
                   ...
                   <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
					 ...
					 <td>
					 <a href="#ModalProject" data-toggle="modal"  class="btn btn-sm btn-success" 
