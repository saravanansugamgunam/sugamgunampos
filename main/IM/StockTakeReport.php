        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <b>
                    ...
                    <br>
                    <br>
                    Stock Adj. +: &nbsp;&nbsp;&nbsp;&nbsp; <input type='text'
                        style="width: 150px; height:30px; padding-top:6px; padding-bottom: 4px; margin-right: 4px; font-size:15px;"
                        id='txtStockAdjPlus' name='txtStockAdjPlus' />
                    <br>
                    <br>
                    Stock Adj. -: &nbsp;&nbsp;&nbsp;&nbsp;<input type='text'
                        style="width: 150px; height:30px; padding-top:6px; padding-bottom: 4px; margin-right: 4px; font-size:15px;"
                        id='txtStockAdjMinus' name='txtStockAdjMinus' />
                </b>
                <br>
                <br>
                <br>
                ...
                <button type="button" class="btn btn-danger" onclick='CancellBill();' data-dismiss="modal">Cancel
                    Invoice</button>
            </div>
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        <div id="content" class="content">
            <div class="row">
                ...
                function LoadStockTakeReport() {

                    var ID = document.getElementById("cmbStockTakeID").value;
                    var Type = document.getElementById("cmbReportType").value;

                    var datas = "&ID=" + ID + "&Type=" + Type;
                    // alert(datas);
                    $.ajax({
                        url: "Load/LoadStockTakeReport.php",
                        method: "POST",
                        data: datas,
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Stock Take Report
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker form-control" data-show-subtext="true"
                                        ...
                                        name='cmbStockTakeID' style="width:450px;" onchange='LoadProductList();'>
                                        <option selected></option>

                                        <?php  
                            $sqli = " SELECT id,CONCAT(id,'(',DATE_FORMAT(a.createdon,'%d-%m-%Y'),')',' - ',productshortcode) AS dateed
                     FROM stocktakearea AS a JOIN productmaster AS b ON a.productcode=b.productid  WHERE  closedstatus ='1' ";
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Type</label>
                                    <select class="selectpicker form-control" data-show-subtext="true"
                                        data-live-search="true" data-style="btn-white" id='cmbReportType'
                                        name='cmbReportType' style="width:150px;" onchange='LoadProductList();'>
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    <label>&nbsp;</label>
                                    <a class="form-control btn btn-warning m-r-5 m-b-5"
                                        onclick='LoadStockTakeReport()'>Load</a>
                                </div>
                            </div>
                            <br><br><br><br>
                            <hr>
                            ...
                            <div class="table-responsive" id='DivStockReport'>
                                ...
                                <div id="DivStockTakeDetails" class="email-content"></div>
