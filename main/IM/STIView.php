...
SELECT DATE_FORMAT(receiptdate ,'%d-%m-%Y') AS STODate ,  CONCAT('ST',stono,'-',stoid) AS STONo  ,b.locationname,nettamount,stoqty FROM stomaster AS a
JOIN locationmaster AS b ON a.fromlocation = b.locationcode WHERE stouniqueno ='$STOID';"); 
...
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	...
	<center><div style="font:bold 25px 'Aleo';">Stock Transer IN</div>
	 <?php 
	 if ($LocationCode=='1')
	 {
		 ?>
	...
	<table cellpadding="3" cellspacing="0" style="font-family: arial; font-size: 12px;text-align:left;width : 100%;">
		...
		<tr>
			<td style="white-space:nowrap;">STI No. :</td>
			<td style="white-space:nowrap;"><?php echo $InvoiceNo; ?></td>
		</tr>
		<tr>
			<td style="white-space:nowrap;">STI Date :</td>
			 
			<td style="white-space:nowrap;"><?php  echo $InvoiceDate; ?></td>
		</tr>
		<tr>
			<td style="white-space:nowrap;">From Location :</td>
	...
	<table border="1" cellpadding="5" cellspacing="0" style="font-family: arial; font-size: 12px;	text-align:left;" width="100%">
		...
		<tbody>
				...
				<?php
				$result = mysqli_query($connection, "  SELECT barcode,shortcode,batchcode,mrp,stoqty,nettamount FROM  newstoitems WHERE stouniqueno  ='$STOID' "); 
				...
				<td hidden style=" text-align:right;" ><?php echo $row[5]; ?></td> 
				...
				<tr>
					...
					?>
					<td hidden style=" text-align:right;" ><strong style="font-size: 12px;">
					<?php
					{
	...
	<br>
	 <label> Thank you !!! </label>
		...
		<center> <button type="button" onclick="printDiv();" class="btn btn-sm btn-info"><i class="icon-print"></i> Print</button> 
		</center>
