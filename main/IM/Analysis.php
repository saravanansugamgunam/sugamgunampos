  ...
  <body  onload="LoadCardData();">
    ...
    $('#dtToDate').datepicker({
	     ...
	     function LoadCardData()
	  {
	   ...
	   <iframe width="1160" height="700" src="https://app.powerbi.com/view?r=eyJrIjoiNTc4NDM0YjgtYjY5MC00OThiLTgwZjItMmZlZjBiOWQzNjRlIiwidCI6IjEzMzFjZmQzLTc2ZDgtNGFhYS05NjdhLThiMjhmYTJhYjVlNCIsImMiOjEwfQ%3D%3D" frameborder="0" allowFullScreen="true"></iframe>
