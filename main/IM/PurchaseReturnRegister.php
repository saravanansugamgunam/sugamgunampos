...
<html lang="en" class="ie8">
 ...
 <div id="content" class="content">
  ...
  function LoadSalesReport()
	 ...
	 // alert(datas);
		 $.ajax({
		   url:"Load/LoadPurchaseReturnReport.php",
		   method:"POST",
		   data:datas,
	...
	var FromDate = document.getElementById("dtFromDate").value;   
		...
		var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&Type="+Type;  
	  	    // alert(datas);
		 $.ajax({
		   url:"Load/LoadPurchaseReturnReportTotal.php",
		   method:"POST",
		   data:datas,	
		   dataType:"json",
		   success:function(data)
      ...
      format: "dd/mm/yyyy"
        ...
        $('.datepicker').hide();
						 ...
						 <div class="panel-heading">
						    <h5 class="panel-title">Purchase Return Report
                        ...
                        <div class="panel-body">
							  ...
							  <div class="form-group">
                                    ...
                                    <div class="col-md-8">
											...
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<select style='border-radius: 4px; padding: 5px;display:none;' id='cmbType' name ='cmbType' >
			   ...
			   <div class="col-md-12">
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
							...
							<td><b>Total Purchase Return</b>&nbsp;&nbsp;&nbsp;&nbsp;</td>
							...
							<td>&nbsp;&nbsp;&nbsp;&nbsp;<input style='border-radius: 4px; padding: 5px; text-align: left;'  id='txtItemSearch'  name ='txtItemSearch' onkeyup='SearchTable()' placeholder= 'Search...'  /></b></td>
							</tr>
