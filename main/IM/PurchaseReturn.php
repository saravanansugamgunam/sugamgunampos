        ...
        <div id="content" class="content">
            <div class="row">
                ...
                function LoadProductList() {
                    ...
                    // alert(datas);
                    $.ajax({
                        url: "Load/Purchasereturn_LoadReturnItemlist.php",
                        method: "POST",
                        data: datas,
                ...
                function LoadInvoiceTotal() {
                    ...
                    // alert(datas);
                    $.ajax({
                        url: "Load/Purchasereturn_LoadReturntotal.php",
                        method: "POST",
                        data: datas,
                        dataType: "json",
                        success: function(data) {
                ...
                function LoadBarcodeDetails() {
                    ...
                    $.ajax({
                        url: "Load/Purchasereturn_LoadBarcodeDetails.php",
                        method: "POST",
                        data: datas,
                        dataType: "json",
                        success: function(data) {
                ...
                function SaveSTOItems() {
                    ...
                    if (Number(BillQty) > Number(Currentstock)) {
                        ...
                        if (STOUniqueNo == "" || TotalAmount == "" || LocationCode == "" || TotalAmount == "0") {
                            ...
                            var datas = "&STOUniqueNo=" + STOUniqueNo + "&Barcode=" + Barcode + "&Qty=" + Qty +
                                ...
                                BatchCode +
                                "&Currentstock=" + Currentstock + "&SupplierCode=" + SupplierCode +
                                "&ExpiryDate=" + ExpiryDate + "&Rate=" + Rate;

                            $.ajax({
                                url: "Save/Purchasereturn_Savepurchaseitems.php",
                                method: "POST",
                                data: datas,
                                success: function(data) {
                ...
                function SavePurchaseReturnMaster() {
                    ...
                    var SupplierCode = document.getElementById("cmbLocation").value;
                    var Remarks = document.getElementById("txtRemarks").value;


                    if (Invoice == "" || TotalSaleAmount == "" || SupplierCode == "" || TotalSaleAmount == "0") {

                        swal("Alert!", "Kindly provide valid details!", "warning");

                    } else {
                        ;
                        var datas = "&Invoice=" + Invoice + "&TotalSaleQty=" + TotalSaleQty +
                            ...
                            SupplierCode;
                        $.ajax({
                            url: "Save/Purchasereturn_SavePurchasereturnMaster.php",
                            method: "POST",
                            data: datas,
                            success: function(data) {
                                alert(data);
                                if (data == 1) {
                                    swal("Purchase Return!", "Product Returned Sucessfully", "success");
                                    ...
                                    swal("Alert!", "Error Saving Purchase Return", "warning");
                                    Reset();
                                }
                ...
                <input style="background-color:white;" type="hidden" name="txtShortcode" id="txtShortcode"
                    placeholder="" class="form-control" disabled />
                <input style="background-color:white;" type="hidden" name="txtCategory" id="txtCategory" placeholder=""
                    class="form-control" disabled />
                <input style="background-color:white;" type="hidden" name="txtProductName" id="txtProductName"
                    placeholder="" class="form-control" disabled />
                <input style="background-color:white;" type="hidden" name="txtBatchcode" id="txtBatchcode"
                    placeholder="" class="form-control" disabled />
                <input style="background-color:white;" type="hidden" name="txtProfitAmount" id="txtProfitAmount"
                    placeholder="" class="form-control" disabled />

                <input style="background-color:white;" type="hidden" name="txtRate" id="txtRate" placeholder=""
                    class="form-control" disabled />
                <input style="background-color:white;" type="hidden" name="txtLocationCode" id="txtLocationCode"
                    placeholder="" class="form-control" disabled />
                <input style="background-color:white;" type="hidden" name="txtExpiry" id="txtExpiry" placeholder=""
                    class="form-control" disabled />
                <input style="background-color:white;" type="hidden" name="cmbProductCode" id="cmbProductCode"
                    placeholder="" class="form-control" disabled />
                <input style="background-color:white;" type="hidden" name="txtTotalAmount" id="txtTotalAmount"
                    placeholder="" class="form-control" disabled />
                ...
                <input type="hidden" name="txtDiscPercent" id="txtDiscPercent" placeholder="" class="form-control"
                    value=0 onkeyup="CalculateTotal();" />
                <input type="hidden" name="txtDiscAmount" id="txtDiscAmount" placeholder="" class="form-control" value=0
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Purchase Return
                        ...
                        <div class="panel-body">
                            <div class="table-responsive" id='DivStockReport'>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id='cmbLocation' name='cmbLocation' disabled>

                                            <?php
                                            $sqli = "SELECT locationcode, locationname FROM locationmaster 
                                             WHERE  locationcode ='4'";
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id='cmbSupplier' name='cmbSupplier'>
                                ...
                                <div class="col-md-2" style="margin-left:-0%;">
                                    <div class="form-group">
                                        ...
                                        <input style="background-color:white;" type="text" name="txtBarcode"
                                            id="txtBarcode" class="form-control" onfocus="DisableTransferLocation()"
                            ...
                            <div class="table-responsive" id='DivStockReport'>
                                ...
                                <br>
                                <textarea id='txtRemarks' class='form-controle' cols="60"
                                ...
                                <table style="position: relative; float:right;">
                                    <tr>
                                        ...
                                        <td> <input type="button" class="btn btn-sm btn-success"
                                                onclick='this.disabled=true; SavePurchaseReturnMaster();' value='Save'>
                                        </td>
