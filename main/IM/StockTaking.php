    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function SaveSTOItems() {
            ...
            if (StockTakeID == "") {
                ...
                // alert(3);
                var datas = "&StockTakeID=" + StockTakeID + "&Barcode=" + Barcode + "&Qty=" + Qty + "&Shortcode=" +
                    Shortcode + "&Shortcode=" + Shortcode +
                    "&Category=" + Category + "&ProductName=" + ProductName + "&MRP=" + MRP + "&DiscountAmount=" +
                    DiscountAmount + "&TotalAmount=" + TotalAmount + "&ProfitAmount=" + ProfitAmount + "&BatchCode=" +
                    BatchCode +
                    "&Currentstock=" + Currentstock + "&Rate=" + Rate;
                // alert(datas);
                $.ajax({
                    url: "Save/SaveStockTakeItems.php",
                    method: "POST",
                    data: datas,
        ...
        function SaveSTOMaster() {
            ...
            var StockTakeID = document.getElementById("txtInvoiceNo").value;
            ...
            var ToLocation = document.getElementById("cmbStockTakeID").value;


            if (Number(BalanceAmount) != 0) {
                swal("Alert!", "Balance should be  Zero", "warning");

            } else {

                if (StockTakeID == "" || TotalSaleAmount == "" || ToLocation == "" || TotalSaleAmount == "0") {

                    swal("Alert!", "Kindly provide valid details!", "warning");

                } else {
                    // alert(3);
                    var datas = "&StockTakeID=" + StockTakeID + "&TotalSaleQty=" + TotalSaleQty +
                        "&TotalDiscountAmount=" + TotalDiscountAmount + "&TotalProfitAmount=" + TotalProfitAmount +
                        "&TotalSaleAmount=" + TotalSaleAmount + "&BalanceAmount=" + BalanceAmount + "&ToLocation=" +
                        ToLocation;
                    // alert(datas);
                    $.ajax({
        ...
        function LoadBarcodeDetails() {
            ...
            var datas = "&Barcode=" + Barcode + "&StockTakeID=" + StockTakeID + "&ProductCode=" + ProductCode;

            $.ajax({
                url: "Load/LoadBarcodeDetailsStocktake.php",
                method: "POST",
                data: datas,
                dataType: "json",
                success: function(data) {
                    ...
                    $("#txtAlreadyScanned").val(data[8]);
                    $("#txtOtherArea").val(data[8]);



                    var CurrentStockQty = document.getElementById("txtCurrentStock").value;
                    var AlreadyScannedQty = document.getElementById("txtAlreadyScanned").value;
                    // document.getElementById("txtQty").value = 1;

                    if (Barcode != "") {

                        SaveSTOItems();
                        // if (AlreadyScannedQty > 0) {
                        //     swal("Alert!",
                        //         "Barcode Already Scanned, PRESS ESC Key",
                        //         "warning");
                        //     document.getElementById("txtBarcode").focus();
        ...
        function LoadInvoiceTotal() {
            ...
            // alert(datas);
            $.ajax({
                url: "Load/LoadStockTakeTotal.php",
                method: "POST",
                data: datas,
                dataType: "json",
                success: function(data) {
        ...
        function LoadProductList() {
            ...
            // alert(datas);
            $.ajax({
                url: "Load/LoadStockTakeItemList.php",
                method: "POST",
                data: datas,
                success: function(data) {
        ...
        function AddStockTake() {
            var StockTakeBy = document.getElementById("cmbStockTakeUser").value;
            var Remarks = document.getElementById("txtStokTakeRemarks").value;
            var Product = document.getElementById("cmbProduct").value;
            var Group = document.getElementById("cmbStockTakeBatch").value;

            var datas = "&StockTakeBy=" + StockTakeBy +
                "&Remarks=" + Remarks +
                "&Group=" + Group +
                "&Product=" + Product;
            //  alert(datas);
            $.ajax({
                url: "Save/SaveStockTakeInitialize.php",
                method: "POST",
                data: datas,
                success: function(data) {
                    setTimeout(function() {
        ...
        function DisableTransferLocation() {
            document.getElementById("cmbStockTakeID").disabled = true;
        }
        </script>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Initialize Stock Take</h4>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="selectpicker form-control" data-show-subtext="true"
                                            data-live-search="true" data-style="btn-white" id='cmbStockTakeBatch'
                                            name='cmbStockTakeBatch' style="width:150px;">
                                            <option selected>-</option>


                                            <?php  
                            $sqli = "select id,batchname from stocktakebatch where status <> 'Completed'";
                            ...
                            ?>
                                    ...
                                    <div class="form-group col-md-4">
                                        <label> Stock Taken by</label>
                                        <select class="selectpicker form-control" data-show-subtext="true"
                                            data-live-search="true" data-style="btn-white" id='cmbStockTakeUser'
                                            name='cmbStockTakeUser' style="width:150px;">
                                            <option selected>-</option>

                                            <?php  
                            $sqli = "SELECT userid,username FROM usermaster WHERE activestatus ='Active'";
                            $result = mysqli_query($connection, $sqli); 
                             while ($row = mysqli_fetch_array($result)) {
                            	# code...
                            ...
                            ?>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="selectpicker form-control" data-show-subtext="true"
                                            ...
                                            name='cmbProduct' style="width:150px;">
                                            <option selected></option>

                                            <?php  
                            $sqli = " SELECT productid,CONCAT(productname,' - ', productshortcode)  AS productname  FROM productmaster ";
                            $result = mysqli_query($connection, $sqli); 
                             while ($row = mysqli_fetch_array($result)) {
                            	# code...
                            ...
                            ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-12">
                                        <label> Remarks</label>
                                        <textarea class="form-control" id='txtStokTakeRemarks'
                                            name='txtStokTakeRemarks'></textarea>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker form-control" data-show-subtext="true"
                                                ...
                                                name='cmbStockTakeID' style="width:150px;"
                                                onchange='LoadProductList();LoadProductCode();'>
                                                <option selected></option>

                                                <?php  
                            $sqli = "SELECT id,CONCAT(id,' - ',b.productshortcode) AS Shortcode
                            FROM stocktakearea AS a JOIN productmaster AS b ON a.productcode=b.productid WHERE 
                            stocktakelocation='$LocationCode' AND closedstatus ='0' ";
                            $result = mysqli_query($connection, $sqli); 
                             while ($row = mysqli_fetch_array($result)) {
                            	# code...
                          
                             echo ' <option value='.$row['id'].'>'.$row['Shortcode'].'</option>';
                              }	
                            ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-1" style="margin-left:-0%;">
                                        <div class="form-group">
                                            ...
                                            <a href="#modal-dialog" class="btn btn-warning m-r-5 m-b-5"
                                                data-toggle="modal">+</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3" style="margin-left:-0%;">
                                    <div class="form-group">
                                        ...
                                        <input style="background-color:white;" type="text" name="txtBarcode"
                                            id="txtBarcode" class="form-control"
                                ...
                                <div class="col-md-1" style="margin-left:-0%;">
                                    <div class="form-group">
                                        ...
                                        <input style="background-color:white;" type="text" name="txtMRP" id="txtMRP"
                                            placeholder="" class="form-control" onchange="CalculateTotal();" disabled />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        <label>Qty</label>
                                        <input type="text" name="txtQty" id="txtQty" placeholder="" class="form-control"
                                            value='1'" onblur=" LoadBarcodeDetails()" />
                                    </div>
                                </div>


                                <input style="background-color:white;" type="hidden" name="txtAlreadyScanned"
                                    id="txtAlreadyScanned" placeholder="" class="form-control" disabled />


                                <input style="background-color:white;" type="hidden" name="txtOtherArea"
                                    id="txtOtherArea" placeholder="" class="form-control" disabled />

                                <input style="background-color:white;" type="hidden" name="txtProductCode"
                                    id="txtProductCode" placeholder="" class="form-control" disabled />
                                ...
                                <div class="row" style="display:none;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="button" class="btn btn-sm btn-success"
                                                    onclick="SaveSTOItems();" value='Add'>
                                    ...
                                    <select class="selectpicker form-control" data-show-subtext="true"
                                        ...
                                        name='cmbProductCode' onchange="LoadProductDetails();ClearTotalAmount();"
                                        style="width: 650px;">
                                        <option selected></option>

                                        <?php  
                            $sqli = "SELECT stockitemid,CONCAT(shortcode,'-',productname,'(B.No-',batchno,')') AS Product
							FROM newstockdetails_".$LocationCode."  WHERE currentstock > 0  and locationcode ='$LocationCode'";
                            $result = mysqli_query($connection, $sqli); 
                             while ($row = mysqli_fetch_array($result)) {
                            	# code...
                                    ...
                                    <table style="position: relative; float:right;">
                                        <tr>
                                            ...
                                            <td> <input type="button" class="btn btn-sm btn-success"
                                                    onclick='this.disabled=true; SaveSTOMaster();' value='Save'> </td>
