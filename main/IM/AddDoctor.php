    ...
    <div class="modal-content">
      ...
      <div class="modal-body"> 
							...
							<input hidden='text' id='txtDoctorStatus' name='txtDoctorStatus' />
							  ...
							  <td>Mobile</td><td><input type='text' id='txtDoctorUpdatedMobile' name='txtDoctorUpdatedMobile' /></td>
							  </tr>
							  <tr>
							  <td>Email</td><td><input type='text' id='txtUpdateEmail' name='txtUpdateEmail' /></td>
							  </tr>
							  <tr>
							  <td><br></td>
							  </tr>
...
function UpdateDoctor()
{
		...
		var datas = "&DoctorID=" + encodeURIComponent(DoctorID) +
				...
				"&UpdateEmail=" + encodeURIComponent(txtUpdateEmail)+
  ...
  function SaveDoctor()
	  ...
	  {
var datas = "&Doctor="+Doctor+"&mobileno="+mobileno+"&DoctorEmail="+DoctorEmail;	
...
var datas = "&Dumy="+Dumy;	
	  ...
	  function GetRowID(x)
	  {
		...
		document.getElementById("txtDoctorUpdatedMobile").value = document.getElementById("indextable").rows[row].cells.namedItem("mobileno").innerHTML;
		document.getElementById("txtDoctorStatus").value = document.getElementById("indextable").rows[row].cells.namedItem("DoctorStatus").innerHTML;
		document.getElementById("txtUpdateEmail").value = document.getElementById("indextable").rows[row].cells.namedItem("DoctorEmail").innerHTML;
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" class="form-control" placeholder="Doctor Name" id='txtDoctor' name='txtDoctor' />
                                    </div>
									  <label class="col-md-1 control-label">Mobile</label>
                                    <div class="col-md-2">
                                        <input type="text" class="form-control" placeholder="Mobile" id='txtmobileno' name='txtmobileno' />
                                    </div> 
									
									<label class="col-md-1 control-label">Email</label>
                                    <div class="col-md-3">
                                        <input type="text" class="form-control" placeholder="E Mail" id='txtDoctorEmail' name='txtDoctorEmail' />
                                    </div>
                                </div>
