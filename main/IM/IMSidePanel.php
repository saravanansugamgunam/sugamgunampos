...
<ul class="nav">
    ...
    <?php
        ...
        if ($GroupID == 1) {
        ?>
    <li class="has-sub <?php if ($MenuID == 2 || $MenuID == 3 || $MenuID == 4 || $MenuID == 17  || $MenuID == 18  || $MenuID == 28  || $MenuID == 29  || $MenuID == 30   || $MenuID == 38   || $MenuID == 39   || $MenuID == 45 || $MenuID == 67) {
                                    echo "active";
                                } ?>">
        <a href="javascript:;">
        ...
        <ul class="sub-menu">
            ...
            <li class="<?php if ($MenuID == 67) {
                                    echo "active";
                                } ?>"><a href="AddCourierCharge.php?MID=67">Update Courier Charge </a>
            </li>
    ...
    <?php }
        ...
        if ($GroupID == '1') {
        ?>
             <li class="has-sub <?php if ($MenuID == 5 || $MenuID == 6 || $MenuID == 19
             || $MenuID == 16 || $MenuID == 66 || $MenuID == 71) {
                                    echo "active";
                                } ?>">
        <a href="javascript:;">
            <i class="fa fa-inr"></i>
        ...
        <ul class="sub-menu">
                    ...
                    <li class="<?php if ($MenuID == 66) {
                                    echo "active";
                                } ?>"><a href="PurchaseOrder.php?MID=66">Purchase Order</a>
            </li>
            <li class="<?php if ($MenuID == 71) {
                                    echo "active";
                                } ?>"><a href="PurchaseorderRegister.php?MID=71">Purchase Order
                    Register</a></li>
...
<li class="has-sub <?php if ($MenuID == 7 || $MenuID == 46 || $MenuID == 50 || $MenuID == 52 || $MenuID == 53 || $MenuID == 54  || $MenuID == 65   || $MenuID == 70  || $MenuID == 80) {
                        echo "active";
                    } ?>">
    <a href="javascript:;">
        <i class="fa fa-dropbox"></i>
    ...
    <ul class="sub-menu">
        ...
        <li class="<?php if ($MenuID == 7) {
         ...
         <li class="<?php if ($MenuID == 80) {
                            echo "active";
                        } ?>"><a href="StockBinManagement.php?MID=7">Stock Rack Management</a></li>                
                        
                        
        <li class="<?php if ($MenuID == 70) {
                            echo "active";
                        } ?>"><a href="StockReportExpiry.php?MID=70">Expiry Stock</a>
        </li>
        ...
        <li style='display:non' class="<?php if ($MenuID == 50) {
                                                echo "active";
        ...
        <li class="<?php if ($MenuID == 7) {
                            echo "active";
                        } ?>"><a href="StockReportOverall.php?MID=7">Stock Report</a></li>
         <li class="<?php if ($MenuID == 80) {
                            echo "active";
                        } ?>"><a href="StockBinManagement.php?MID=7">Stock Rack Management</a></li>                
...
<li class="has-sub <?php if (
    ...
    <ul class="sub-menu">
        <li style='display:none' class="<?php if ($MenuID == 62) {
                                                echo "active";
        ...
        <li class="<?php if ($MenuID == 8) {
                        echo "active";
                    } ?>"><a href="BillingBarcode.php?MID=62">Medicine Billing</a></li>
        ...
        <li style='display: ' class="<?php if ($MenuID == 61) {
                        echo "active";
                    } ?>"><a href="BillingBarcode_autolist.php?MID=61">Delivery</a>
        <li style='display:none' class="<?php if ($MenuID == 63) {
                        echo "active";
...
<li style='display:nonee' class="<?php if ($MenuID == 51) {
                                        echo "active";
...
<li class="has-sub <?php if ($MenuID == 12 || $MenuID == 13 || $MenuID == 14 || 
$MenuID == 15 || $MenuID == 68 ||$MenuID == 69 ) {
                        echo "active";
                    } ?>">
    <a href="javascript:;">
    ...
    <ul class="sub-menu">
         ...
         <li class="<?php if ($MenuID == 68) {
                        echo "active";
                    } ?>"><a href="StockIndent.php?MID=68">Stock Indent</a></li>

        <li class="<?php if ($MenuID == 69) {
                        echo "active";
                    } ?>"><a href="StockIndentRegister.php?MID=69">Stock Indent Register</a></li>
