    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        <script>
            ...
            function LoadEstimateReport() {
                ...
                // alert(datas);
                $.ajax({
                    url: "Load/LoadEstimateReport.php",
                    method: "POST",
                    data: datas,
                    success: function(data) {
                        // alert(data);
            ...
            function UpdatePayment() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == 1) {
                            swal("Payment Updated Sucessfully", "success")
                            LoadEstimateReport();
                        } else {
                            swal("Payment Updated Sucessfully", "error")
                        }
                    }
                });
            ...
            function CancelEstimate(x) {
                var InvoiceNo = x;
                var datas = "&InvoiceNo=" + InvoiceNo;
                $.ajax({
                    url: "Save/CancelEstimate.php",
                    method: "POST",
                    data: datas,

                    success: function(data) {
                        if (data == 1) {
                            swal("Estimate Cancelled", "success")
                            LoadEstimateReport();
                        } else {
                            swal("Unable to cancell", "error")
                        }
                    }
                });
            ...
            <div class="modal-dialog ">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type='number' id='txtInvoiceNo' name='txtInvoiceNo' class="form-control" style='width:150px;' />
                        <input type='number' id='txtPaitentID' name='txtPaitentID' class="form-control" style='width:150px;' />


                        <label>
                            Payment Amount
                        </label>
                        <input type='number' id='txtPaymentAmount' name='txtPaymentAmount' class="form-control" style='width:150px;' />
                        <br>
                        ...
                        <select class="form-control" id='cmbPaymentMode' name='cmbPaymentMode' onchange='focusamount();' style='width:150px;'>
                            <option></option>
                            <?php
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-success" data-dismiss="modal" onclick='UpdatePayment()'>Update</button>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Estimate Register</h4>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="radio-inline"> Period
                                ...
                                <select class="js-states form-control" tabindex="-1" id='cmbPeriod' name='cmbPeriod' onchange='ShowHideDiv();'>
                            ...
                            <label class="radio-inline">
                                Paitent
                                <select class='form-control' id='cmbSupplierCodeReport' name='cmbSupplierCodeReport' style="width: 150px;">
                            ...
                            <label class="radio-inline">
                                ...
                                <a class="btn btn-success  btn-sm" onclick='LoadEstimateReport();'>View</a>
