...
<div id="myModalCancel" class="modal fade" role="dialog" >
 ...
 <div id="content" class="content">
  ...
  function LoadSalesReport()
	 ...
	 // alert(datas);
		 $.ajax({
		   url:"Load/LoadCourierRegister.php",
		   method:"POST",
		   data:datas,
...
function SaveCourierPayment()
{
	...
	var datas = "&CourierID="+CourierID+"&PaidAmount="+PaidAmount;	
		  ...
		  if (CourierID=='' || PaidAmount=='')
		  {
			  ...
			  {
				   $.ajax({
		   url:"Save/SaveCourierPayment.php",
		   method:"POST",
		   data:datas,
		   success:function(data)
		   {	
			  ...
			  LoadSalesReport();
				...
				<input type='text' id='txtPaidAmount' name ='txtPaidAmount' class='form-control' />
										...
										<div class="modal-footer">
											...
											<a href="javascript:;" class="btn btn-sm btn-success" onclick="SaveCourierPayment()" data-dismiss="modal" >Add</a>
						 ...
						 <div class="panel-heading">
						    <h5 class="panel-title">Courier Register
