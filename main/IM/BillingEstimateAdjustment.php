...
<body onload="LoadInvoiceNo();" onmousedown="CalculateCurrentTotal()">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function LoadInvoiceNo() {
            ...
            var InvoiceNoold = new Date().getTime();
            document.getElementById("txtInvoiceNo").value = <?php echo $EstimateInvoice; ?>; // InvoiceNo;
            document.getElementById("txtMobileNo").value = <?php echo $PaitentID; ?>; // InvoiceNo;
            document.getElementById("cmbDoctor").value = <?php echo $DoctorID; ?>; // InvoiceNo;
        ...
        function LoadEstimateStatus() {
            var Invoice = document.getElementById("txtInvoiceNo").value;
            var datas = "&Invoice=" + Invoice;
            
            $.ajax({
                url: "Load/CheckEstimateStatus.php",
                method: "POST",
                data: datas,
                dataType: "json",
                success: function(data) {
                     if (data == 1) {
                        swal("Alert!", "Already Billed", "warning");
                    } else {
                        LoadPaitentDetails(); 
                        LoadProductList();
                    }
                    ...
                    ?>
                                  ...
                                  ?>
                                    ...
                                    <td><select class="form-control"
                                            ...
                                            name='cmbDoctor' style="width: 150px;">
                            ...
                            ?>
                                    ...
                                    <td>&nbsp;&nbsp;</td>
                                    <td>
                                        <input type='hidden' name='txtMobileNo' id='txtMobileNo' />

                                        <input style="background-color:white;" type="text" name="txtName" id="txtName"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker" data-show-subtext="true"
                                                ...
                                                <option selected></option>
                                                <?php  
                            $sqli = " select concat(productcode,'-',mrp) as productcode ,concat('<b>',shortcode,'  &nbsp;&nbsp;&nbsp;&nbsp; (&#8377;: ',mrp,')',' &nbsp;&nbsp;&nbsp;&nbsp;[&#9750;: ',sum(currentstock),']')  as Product from 
                                    ...
                                    <table style="position: relative; float:right;">
                                        <tr>
                                            ...
                                            <td> <a href='#ModalProject'> <input type="button"
                                                        ...
                                                        onclick='DisableBillType();LoadPaymentDetails();  CalculateCurrentTotal();'
                                                        value='Save'> </a> </td>
