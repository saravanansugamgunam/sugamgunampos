  ...
  function LoadSalesReport()
	  {
		...
		var Paitent = document.getElementById("cmbPaitient").value; 
		...
		var datas = "&Paitent="+Paitent+"&Type="+Type+"&Location="+Location; 
	 // alert(datas);
		 $.ajax({
...
var Type = document.getElementById("cmbType").value;   
		...
		else
		{
		 ...
		 var datas = "&Paitent="+Paitent+"&Type="+Type+"&Location="+Location; 
	  	    // alert(datas);
		 $.ajax({
		   url:"Load/LoadSalesSearchTotal.php",
		   method:"POST",
		   data:datas,	
		   dataType:"json",
		   success:function(data)
      ...
      format: "dd/mm/yyyy"
        ...
        $('.datepicker').hide();
						 ...
						 <div class="panel-heading">
						    <h5 class="panel-title">Bill Search
							  ...
							  <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                      <label>Mobile No</label>
									   <select class="selectpicker" data-show-subtext="true" data-live-search="true" data-style="btn-white" id='cmbPaitient' name='cmbPaitient'  style="width: 150px;">
