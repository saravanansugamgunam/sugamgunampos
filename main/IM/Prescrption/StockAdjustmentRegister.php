...
<body onload="Reset();">
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
        ...
        function Reset() {
            ...
            LoadStockAdjustmentLog();
        }


        function LoadStockAdjustmentLog() {
            ...
            // alert(datas);
            $.ajax({
                url: "Load/LoadStockAdjustmentLog.php",
                method: "POST",
                data: datas,
            ...
            <div class="modal-dialog ">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type='number' id='txtInvoiceNo' name='txtInvoiceNo' class="form-control"
                            style='width:150px;' />
                        <input type='number' id='txtPaitentID' name='txtPaitentID' class="form-control"
                            style='width:150px;' />
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Stock Adjustment Log</h4>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="radio-inline">
                                ...
                                <a class="btn btn-success  btn-sm" onclick='LoadStockAdjustmentLog();'>View</a>
