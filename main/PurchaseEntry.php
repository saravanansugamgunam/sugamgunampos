    ...
    <div class="container-fluid">
      <div class="row-fluid">
		...
		<div class="contentheader">
			<i class="icon-money"></i> Purchase Entry
			</div>
...
if($position=='cashier') {
?>
<a href="PurchaseEntry.php?id=cash&invoice=<?php echo $PurchaseEntryCode ?>">Cash</a>
...
<option></option>
	<?php
	include('../connect.php');
	$result = $db->prepare("SELECT * FROM productmaster");
