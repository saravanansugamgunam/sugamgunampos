...
if(isset($_POST["ItemID"]))
{
 ...
 $TherapyID = mysqli_real_escape_string($connection, strtoupper($_POST["TherapyID"]));    
  ...
  try {
    $AddPaymentMode = "delete from therapybookingdetails_recomended where bookingid='$ItemID' and bookinguniqueid='$Invoice';  "; 
    $AddPaymentMode.= "delete from timeslotallocation_temp where bookingitemid='$ItemID' and uniqueid='$Invoice';  ";
    $AddPaymentMode.= "update therapybookingdetails_recomended set sitingid=sitingid-1,totalsitings=totalsitings-1
