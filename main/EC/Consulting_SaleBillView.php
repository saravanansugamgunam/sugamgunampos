...
$Invoice=$_GET['invoice'];
 ...
 SELECT a.billid,DATE_FORMAT(a.billdate,'%d-%m-%Y'), b.paitentname, b.mobileno,c.username,a.totalamount-a.discountamount,a.remarks   
    ...
    <div class="content" id="content">
	 ...
	 if ($LocationCode=='1')
	 {
		 ?>
                            ...
                            <br>
                            <font size="2"> AP 393,17th Street, Thiruvalluvar Kudiyirippu, I Block, Anna Nagar, Tamil
                                Nadu 600040<br>
                                Phone: +91 9176606308 &nbsp;&nbsp;&nbsp;&nbsp; Email: sugamgunamhealthcenter@gmail.com
                                <br>
	 ...
	 ?>
                ...
                <div style="width: 100%; ">
                    ...
                    <table cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	text-align:left;"
                        width="100%">
                        <b>Description</b>
                        <hr>
                        <tbody>
...
?>
            ...
            <td><button type="button" onclick="Clickheretoprint();" class="btn btn-sm btn-info"><i
                        class="icon-print"></i> Print</button> </td>
    ...
    function redirecttoReceiptPrint() {
        ...
        var str1 = "Consulting_ReceiptPrint.php?invoice=";
        var str2 = Invoice;
        var str3 = "";
