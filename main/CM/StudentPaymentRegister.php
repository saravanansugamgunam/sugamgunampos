  ...
  function LoadSalesReport()
	  {
		...
		var Batch = document.getElementById("cmbBatch").value;   
		 
		var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&Type="+Type+"&Batch="+Batch; 
	 // alert(datas);
		 $.ajax({
		   url:"Load/LoadCollectionReport.php",
		   method:"POST",
		   data:datas,
	...
	var FromDate = document.getElementById("dtFromDate").value;   
		...
		var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&Type="+Type+"&Batch="+Batch;  
	  	    // alert(datas);
		 $.ajax({
		   url:"Load/LoadCollectionReportTotal.php",
		   method:"POST",
		   data:datas,	
		   dataType:"json",
		   success:function(data)
      ...
      format: "dd/mm/yyyy"
        ...
        $('.datepicker').hide();
						 ...
						 <div class="panel-heading">
						    <h5 class="panel-title">Collection Report
                        ...
                        <div class="panel-body">
							  ...
							  <div class="form-group">
                                    ...
                                    <div class="col-md-12">
											...
											<select style='border-radius: 4px; padding: 5px;' 
                                       id='cmbBatch' name='cmbBatch'  >
			   ...
			   <div class="col-md-12">
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
							...
							<tr>
							<td>Cash&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td>  <input style='border-radius: 4px; padding: 5px; text-align: right;' size="15" type='text' id='txtCash' name ='txtCash' /> 
							&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td>Card&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td><input style='border-radius: 4px; padding: 5px; text-align: right;'   size="15" type='text' id='txtCard' name ='txtCard' />
							&nbsp;&nbsp;&nbsp;&nbsp;</td> 
							<td>Others&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td><input style='border-radius: 4px; padding: 5px; text-align: right;' size="15" type='text' id='txtOthers' name ='txtOthers' />
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
