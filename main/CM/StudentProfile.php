...
SELECT studentname, studentmobileno, studentalternatecontactno, studentemailid, 
studentgender,DATE_FORMAT(studentdob, '%d-%b-%Y') as studentdob,studentmaritalstatus,studentqualification,studentoccupation,
studentgaurdianname,studentaddress,studenttempaddress,studentimagepath,biometricstatus FROM studentmaster
									...
									<div class="modal-content">
										<div class="modal-header">
											...
											<h4 class="modal-title">Add Biometric</h4>
											 <input type ='hidden' id='UserID' name ='UserID' value="<?php echo $StudentCode; ?>" />
										</div>
										<div class="modal-bod">
											 <div class="col-md-12">
			        <!-- begin panel -->
...
<input type='hidden' id='txtStudentCode' name ='txtStudentCode'  value ='<?php echo $StudentCode; ?>' />
                            ...
                            <div class="table-responsive">
                                <table class="table table-profile">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="field">Alt. Address</td>
                                            <td><?php echo $StudentAltAddress; ?></td>
                                        </tr>
                                         <tr>
...
SELECT  CONCAT(b.batchname,' [',a.studentfees,']') AS Batch,a.studentfees - SUM(c.paymentamount)  AS Balance
 ...
 WHERE a.studentcode ='$StudentCode' ;"); 
	...
	?>
	  ...
	  $res = $connection->query(" 
	   ...
	   SELECT paymentid,DATE_FORMAT(a.paymentdate, '%d-%b-%y') as paymentdate, 
 ...
 WHERE b.`studentcode` ='$StudentCode' ;"); 
	   $Sno = 1; 
				...
				<td ><a href='ReceiptPrint.php?invoice=<?php echo $row[0]; ?>' target='_blank' ?>
