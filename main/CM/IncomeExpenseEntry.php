...
<html lang="en" class="ie8">
  ...
  <body onload="LoadIncomeExpenseList();">
    <!-- begin #page-loader -->
    ...
    <div id="page-container" class="fade page-sidebar-minified page-header-fixed">
	  ...
	  if (Ledger=="" || EntryDate=="" || Amount=="" || Amount=="0" )
	  {
	  ...
	  var datas = "&Ledger="+Ledger+"&Group="+Group+"&EntryDate="+EntryDate+"&EntryType="+EntryType+"&Amount="+Amount+"&Remarks="+Remarks+"&PaymentMode="+PaymentMode;		  	
	  	        // alert(datas);
		 $.ajax({
