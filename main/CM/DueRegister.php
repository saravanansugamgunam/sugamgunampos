  ...
  function LoadSalesReport()
	...
	var FromDate = document.getElementById("dtFromDate").value;   
		...
		var datas = "&FromDate="+FromDate+"&ToDate="+ToDate+"&Type="+Type+"&Batch="+Batch;  
	  	    // alert(datas);
		 $.ajax({
		   url:"Load/LoadDueRegisterTotal.php",
		   method:"POST",
		   data:datas,	
		   dataType:"json",
		   success:function(data)
      ...
      format: "dd/mm/yyyy"
        ...
        $('.datepicker').hide();
						 ...
						 <div class="panel-heading">
						    <h5 class="panel-title">Due Report
			   ...
			   <div class="col-md-12">
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
							...
							<tr>
							<td>To Pay&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td>  <input style='border-radius: 4px; padding: 5px;' size="8" type='text' id='txtToPay' name ='txtToPay' /> 
							&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td>Paid&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td><input style='border-radius: 4px; padding: 5px;'   size="8" type='text' id='txtPaid' name ='txtPaid' />
							&nbsp;&nbsp;&nbsp;&nbsp;</td> 
							 
							<td><b>Due</b>&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td><b><input style='border-radius: 4px; padding: 5px; text-align: right;'   size="15"  type='text' id='txtDue' 
							name ='txtDue' /></b></td>
							</tr>
