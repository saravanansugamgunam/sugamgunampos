...
$result = mysqli_query($connection, "SELECT tutorcode,tutorname,tutormobileno,tutoralternateno,
DATE_FORMAT(tutorDOB, '%d-%b-%y'),tutorgender,tutormaritalstatus,tutoraddress  FROM tutormaster 
 ");
...
echo " <thead><tr>  
		...
		<th width='%'><a href=\"javascript:SortTable(2,'T');\">Tutor Name</a></th>    
		...
		<th width='%'> <a href=\"javascript:SortTable(3,'T');\">Address</a></th>      
