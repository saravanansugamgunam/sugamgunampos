...
$result = mysqli_query($connection, "SELECT coursecode, coursename,coursedescription, 
CONCAT(courseduration,' ',coursedurationtype) AS Duration,coursefee FROM coursemaster ");
...
echo " <thead><tr>  
		...
		<th width='%'> <a href=\"javascript:SortTable(3,'T');\">Duration</a></th>   
		<th width='%'> <a href=\"javascript:SortTable(3,'T');\">Course Fee</a></th>      
