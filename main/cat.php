...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td disabled>
			<!-- <a href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click to Delete the Category"><button class="btn btn-danger"><i class="">Delete</i></button></a> -->
		 <button disabled class="btn btn-danger"><i class="">Delete</i></button> 
